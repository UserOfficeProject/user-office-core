...
export default class UOWSSoapClient {
  ...
  public async getBasicPeopleDetailsFromSurname(
    ...
    const requestId = createHash('sha1')
      .update('getBasicPeopleDetailsFromSurname' + JSON.stringify(argsObj))
      .digest('base64');
    ...
    const refinedResult = this.client['getBasicPeopleDetailsFromSurnameAsync'](
      argsObj
    )
      .then((result: any) => {
        return result[0];
  ...
  public async getAgeRangeOptions(): Promise<any> {
    ...
    const requestId = createHash('sha1')
      .update('getAgeRangeOptions' + JSON.stringify(argsObj))
      .digest('base64');
    ...
    const refinedResult = this.client['getAgeRangeOptionsAsync'](argsObj)
      .then((result: any) => {
        return result[0];
      })
      .catch((result: any) => {
  ...
  public async getBasicPersonDetailsByEncryptedId(
    ...
    const requestId = createHash('sha1')
      .update('getBasicPersonDetailsByEncryptedId' + JSON.stringify(argsObj))
      .digest('base64');
    ...
    const refinedResult = this.client[
      'getBasicPersonDetailsByEncryptedIdAsync'
    ](argsObj)
      .then((result: any) => {
        return result[0];
      })
  ...
  public async getSearchableBasicPeopleDetailsFromSurname(
    ...
    const requestId = createHash('sha1')
      .update(
        'getSearchableBasicPeopleDetailsFromSurname' + JSON.stringify(argsObj)
      )
      .digest('base64');
    ...
    const refinedResult = this.client[
      'getSearchableBasicPeopleDetailsFromSurnameAsync'
    ](argsObj)
      .then((result: any) => {
        return result[0];
      })
  ...
  public async unlinkAlternativeIdentifierToUser(
    ...
    const requestId = createHash('sha1')
      .update('unlinkAlternativeIdentifierToUser' + JSON.stringify(argsObj))
      .digest('base64');
    ...
    const refinedResult = this.client['unlinkAlternativeIdentifierToUserAsync'](
      argsObj
    )
      .then((result: any) => {
        return result[0];
  ...
  public async getPrivacyDTO(token: any, userNumber: any): Promise<any> {
    ...
    const requestId = createHash('sha1')
      .update('getPrivacyDTO' + JSON.stringify(argsObj))
      .digest('base64');
    ...
    const refinedResult = this.client['getPrivacyDTOAsync'](argsObj)
      .then((result: any) => {
        return result[0];
      })
      .catch((result: any) => {
  ...
  public async getEstablishmentDTO(establishmentId: any): Promise<any> {
    ...
    const requestId = createHash('sha1')
      .update('getEstablishmentDTO' + JSON.stringify(argsObj))
      .digest('base64');
    ...
    const refinedResult = this.client['getEstablishmentDTOAsync'](argsObj)
      .then((result: any) => {
        return result[0];
      })
      .catch((result: any) => {
  ...
  public async getPersonDetailsFromSessionId(SessionId: any): Promise<any> {
    ...
    const requestId = createHash('sha1')
      .update('getPersonDetailsFromSessionId' + JSON.stringify(argsObj))
      .digest('base64');
    ...
    const refinedResult = this.client['getPersonDetailsFromSessionIdAsync'](
      argsObj
    )
      .then((result: any) => {
        return result[0];
  ...
  public async getInductionsFacilityAwarenessForUser(
    ...
    const requestId = createHash('sha1')
      .update('getInductionsFacilityAwarenessForUser' + JSON.stringify(argsObj))
      .digest('base64');
    ...
    const refinedResult = this.client[
      'getInductionsFacilityAwarenessForUserAsync'
    ](argsObj)
      .then((result: any) => {
        return result[0];
      })
  ...
  public async getPersonsFacilities(token: any, userNumber: any): Promise<any> {
    ...
    const requestId = createHash('sha1')
      .update('getPersonsFacilities' + JSON.stringify(argsObj))
      .digest('base64');
    ...
    const refinedResult = this.client['getPersonsFacilitiesAsync'](argsObj)
      .then((result: any) => {
        return result[0];
      })
      .catch((result: any) => {
  ...
  public async getEstablishmentDTOsBySearchDetails(
    ...
    const requestId = createHash('sha1')
      .update('getEstablishmentDTOsBySearchDetails' + JSON.stringify(argsObj))
      .digest('base64');
    ...
    const refinedResult = this.client[
      'getEstablishmentDTOsBySearchDetailsAsync'
    ](argsObj)
      .then((result: any) => {
        return result[0];
      })
  ...
  public async getPeopleDetailsFromUserNumbers(
    ...
    const requestId = createHash('sha1')
      .update('getPeopleDetailsFromUserNumbers' + JSON.stringify(argsObj))
      .digest('base64');
    ...
    const refinedResult = this.client['getPeopleDetailsFromUserNumbersAsync'](
      argsObj
    )
      .then((result: any) => {
        return result[0];
  ...
  public async getSearchableBasicPersonDetailsFromUserNumber(
    ...
    const refinedResult = this.client[
      'getSearchableBasicPersonDetailsFromUserNumberAsync'
    ](argsObj)
      .then((result: any) => {
        return result[0];
      })
  ...
  public async deleteEstablishmentById(
    ...
    const requestId = createHash('sha1')
      .update('deleteEstablishmentById' + JSON.stringify(argsObj))
      .digest('base64');
    ...
    const refinedResult = this.client['deleteEstablishmentByIdAsync'](argsObj)
      .then((result: any) => {
        return result[0];
      })
      .catch((result: any) => {
  ...
  public async getAllTitles(): Promise<any> {
    ...
    const requestId = createHash('sha1')
      .update('getAllTitles' + JSON.stringify(argsObj))
      .digest('base64');
    ...
    const refinedResult = this.client['getAllTitlesAsync'](argsObj)
      .then((result: any) => {
        return result[0];
      })
      .catch((result: any) => {
  ...
  public async updatePersonByDTO(token: any, person: any): Promise<any> {
    ...
    const requestId = createHash('sha1')
      .update('updatePersonByDTO' + JSON.stringify(argsObj))
      .digest('base64');
    ...
    const refinedResult = this.client['updatePersonByDTOAsync'](argsObj)
      .then((result: any) => {
        return result[0];
      })
      .catch((result: any) => {
  ...
  public async getBasicPeopleDetailsFromEmails(
    ...
    const requestId = createHash('sha1')
      .update('getBasicPeopleDetailsFromEmails' + JSON.stringify(argsObj))
      .digest('base64');
    ...
    const refinedResult = this.client['getBasicPeopleDetailsFromEmailsAsync'](
      argsObj
    )
      .then((result: any) => {
        return result[0];
  ...
  public async loginWithAlternativeIdentifier(
    ...
    const requestId = createHash('sha1')
      .update('loginWithAlternativeIdentifier' + JSON.stringify(argsObj))
      .digest('base64');
    ...
    const refinedResult = this.client['loginWithAlternativeIdentifierAsync'](
      argsObj
    )
      .then((result: any) => {
        return result[0];
  ...
  public async getPersonDTOByMarketingEmail(
    ...
    const requestId = createHash('sha1')
      .update('getPersonDTOByMarketingEmail' + JSON.stringify(argsObj))
      .digest('base64');
    ...
    const refinedResult = this.client['getPersonDTOByMarketingEmailAsync'](
      argsObj
    )
      .then((result: any) => {
        return result[0];
  ...
  public async getSearchableBasicPeopleDetailsFromUserNumbers(
    ...
    const refinedResult = this.client[
      'getSearchableBasicPeopleDetailsFromUserNumbersAsync'
    ](argsObj)
      .then((result: any) => {
        return result[0];
      })
  ...
  public async isTokenValid(Token: any): Promise<any> {
    ...
    const requestId = createHash('sha1')
      .update('isTokenValid' + JSON.stringify(argsObj))
      .digest('base64');
    ...
    const refinedResult = this.client['isTokenValidAsync'](argsObj)
      .then((result: any) => {
        return result[0];
      })
      .catch((result: any) => {
  ...
  public async getSearchableBasicPeopleDetailsFromEmails(
    ...
    const requestId = createHash('sha1')
      .update(
        'getSearchableBasicPeopleDetailsFromEmails' + JSON.stringify(argsObj)
      )
      .digest('base64');
    ...
    const refinedResult = this.client[
      'getSearchableBasicPeopleDetailsFromEmailsAsync'
    ](argsObj)
      .then((result: any) => {
        return result[0];
      })
  ...
  public async updatePersonsFacilities(
    ...
    const requestId = createHash('sha1')
      .update('updatePersonsFacilities' + JSON.stringify(argsObj))
      .digest('base64');
    ...
    const refinedResult = this.client['updatePersonsFacilitiesAsync'](argsObj)
      .then((result: any) => {
        return result[0];
      })
      .catch((result: any) => {
  ...
  public async getMonitorDTO(token: any, userNumber: any): Promise<any> {
    ...
    const requestId = createHash('sha1')
      .update('getMonitorDTO' + JSON.stringify(argsObj))
      .digest('base64');
    ...
    const refinedResult = this.client['getMonitorDTOAsync'](argsObj)
      .then((result: any) => {
        return result[0];
      })
      .catch((result: any) => {
  ...
  public async resetPassword(
    ...
    const requestId = createHash('sha1')
      .update('resetPassword' + JSON.stringify(argsObj))
      .digest('base64');
    ...
    const refinedResult = this.client['resetPasswordAsync'](argsObj)
      .then((result: any) => {
        return result[0];
      })
      .catch((result: any) => {
  ...
  public async getDataUsages(): Promise<any> {
    ...
    const requestId = createHash('sha1')
      .update('getDataUsages' + JSON.stringify(argsObj))
      .digest('base64');
    ...
    const refinedResult = this.client['getDataUsagesAsync'](argsObj)
      .then((result: any) => {
        return result[0];
      })
      .catch((result: any) => {
  ...
  public async updateEmergencyContactDTO(
    ...
    const requestId = createHash('sha1')
      .update('updateEmergencyContactDTO' + JSON.stringify(argsObj))
      .digest('base64');
    ...
    const refinedResult = this.client['updateEmergencyContactDTOAsync'](argsObj)
      .then((result: any) => {
        return result[0];
      })
      .catch((result: any) => {
  ...
  public async sendAccountActivationEmail(
    ...
    const requestId = createHash('sha1')
      .update('sendAccountActivationEmail' + JSON.stringify(argsObj))
      .digest('base64');
    ...
    const refinedResult = this.client['sendAccountActivationEmailAsync'](
      argsObj
    )
      .then((result: any) => {
        return result[0];
  ...
  public async getDisabilities(): Promise<any> {
    ...
    const requestId = createHash('sha1')
      .update('getDisabilities' + JSON.stringify(argsObj))
      .digest('base64');
    ...
    const refinedResult = this.client['getDisabilitiesAsync'](argsObj)
      .then((result: any) => {
        return result[0];
      })
      .catch((result: any) => {
  ...
  public async getEstablishmentsBySearchDetails(
    ...
    const requestId = createHash('sha1')
      .update('getEstablishmentsBySearchDetails' + JSON.stringify(argsObj))
      .digest('base64');
    ...
    const refinedResult = this.client['getEstablishmentsBySearchDetailsAsync'](
      argsObj
    )
      .then((result: any) => {
        return result[0];
  ...
  public async getRolesForUser(token: any, userNumber: any): Promise<any> {
    ...
    const requestId = createHash('sha1')
      .update('getRolesForUser' + JSON.stringify(argsObj))
      .digest('base64');
    ...
    const refinedResult = this.client['getRolesForUserAsync'](argsObj)
      .then((result: any) => {
        return result[0];
      })
      .catch((result: any) => {
  ...
  public async resetPasswordWithOldPassword(
    ...
    const requestId = createHash('sha1')
      .update('resetPasswordWithOldPassword' + JSON.stringify(argsObj))
      .digest('base64');
    ...
    const refinedResult = this.client['resetPasswordWithOldPasswordAsync'](
      argsObj
    )
      .then((result: any) => {
        return result[0];
  ...
  public async getUsersPermissionUserGroupDTOs(
    ...
    const requestId = createHash('sha1')
      .update('getUsersPermissionUserGroupDTOs' + JSON.stringify(argsObj))
      .digest('base64');
    ...
    const refinedResult = this.client['getUsersPermissionUserGroupDTOsAsync'](
      argsObj
    )
      .then((result: any) => {
        return result[0];
  ...
  public async deactivatePerson(token: any, userNumber: any): Promise<any> {
    ...
    const requestId = createHash('sha1')
      .update('deactivatePerson' + JSON.stringify(argsObj))
      .digest('base64');
    ...
    const refinedResult = this.client['deactivatePersonAsync'](argsObj)
      .then((result: any) => {
        return result[0];
      })
      .catch((result: any) => {
  ...
  public async logout(SessionId: any): Promise<any> {
    ...
    const requestId = createHash('sha1')
      .update('logout' + JSON.stringify(argsObj))
      .digest('base64');
    ...
    const refinedResult = this.client['logoutAsync'](argsObj)
      .then((result: any) => {
        return result[0];
      })
      .catch((result: any) => {
  ...
  public async setPrivacyDTO(
    ...
    const requestId = createHash('sha1')
      .update('setPrivacyDTO' + JSON.stringify(argsObj))
      .digest('base64');
    ...
    const refinedResult = this.client['setPrivacyDTOAsync'](argsObj)
      .then((result: any) => {
        return result[0];
      })
      .catch((result: any) => {
  ...
  public async getChangesSince(Token: any, Since: any): Promise<any> {
    ...
    const requestId = createHash('sha1')
      .update('getChangesSince' + JSON.stringify(argsObj))
      .digest('base64');
    ...
    const refinedResult = this.client['getChangesSinceAsync'](argsObj)
      .then((result: any) => {
        return result[0];
      })
      .catch((result: any) => {
  ...
  public async getGenders(): Promise<any> {
    ...
    const requestId = createHash('sha1')
      .update('getGenders' + JSON.stringify(argsObj))
      .digest('base64');
    ...
    const refinedResult = this.client['getGendersAsync'](argsObj)
      .then((result: any) => {
        return result[0];
      })
      .catch((result: any) => {
  ...
  public async createPersonFromPersonDTO(
    ...
    const requestId = createHash('sha1')
      .update('createPersonFromPersonDTO' + JSON.stringify(argsObj))
      .digest('base64');
    ...
    const refinedResult = this.client['createPersonFromPersonDTOAsync'](argsObj)
      .then((result: any) => {
        return result[0];
      })
      .catch((result: any) => {
  ...
  public async loginWithAlternativeIdentifierECP(
    ...
    const requestId = createHash('sha1')
      .update('loginWithAlternativeIdentifierECP' + JSON.stringify(argsObj))
      .digest('base64');
    ...
    const refinedResult = this.client['loginWithAlternativeIdentifierECPAsync'](
      argsObj
    )
      .then((result: any) => {
        return result[0];
  ...
  public async updateExpiredPassword(
    ...
    const requestId = createHash('sha1')
      .update('updateExpiredPassword' + JSON.stringify(argsObj))
      .digest('base64');
    ...
    const refinedResult = this.client['updateExpiredPasswordAsync'](argsObj)
      .then((result: any) => {
        return result[0];
      })
      .catch((result: any) => {
  ...
  public async getDataLookup(Name: any): Promise<any> {
    ...
    const requestId = createHash('sha1')
      .update('getDataLookup' + JSON.stringify(argsObj))
      .digest('base64');
    ...
    const refinedResult = this.client['getDataLookupAsync'](argsObj)
      .then((result: any) => {
        return result[0];
      })
      .catch((result: any) => {
  ...
  public async updateAlternativeIdentifiersForUser(
    ...
    const requestId = createHash('sha1')
      .update('updateAlternativeIdentifiersForUser' + JSON.stringify(argsObj))
      .digest('base64');
    ...
    const refinedResult = this.client[
      'updateAlternativeIdentifiersForUserAsync'
    ](argsObj)
      .then((result: any) => {
        return result[0];
      })
  ...
  public async noLdapLogin(UserNumber: any, Password: any): Promise<any> {
    ...
    const requestId = createHash('sha1')
      .update('noLdapLogin' + JSON.stringify(argsObj))
      .digest('base64');
    ...
    const refinedResult = this.client['noLdapLoginAsync'](argsObj)
      .then((result: any) => {
        return result[0];
      })
      .catch((result: any) => {
  ...
  public async getFrequentGenders(): Promise<any> {
    ...
    const requestId = createHash('sha1')
      .update('getFrequentGenders' + JSON.stringify(argsObj))
      .digest('base64');
    ...
    const refinedResult = this.client['getFrequentGendersAsync'](argsObj)
      .then((result: any) => {
        return result[0];
      })
      .catch((result: any) => {
  ...
  public async getEthnicities(): Promise<any> {
    ...
    const requestId = createHash('sha1')
      .update('getEthnicities' + JSON.stringify(argsObj))
      .digest('base64');
    ...
    const refinedResult = this.client['getEthnicitiesAsync'](argsObj)
      .then((result: any) => {
        return result[0];
      })
      .catch((result: any) => {
  ...
  public async getBasicPeopleDetailsSinceDate(
    ...
    const requestId = createHash('sha1')
      .update('getBasicPeopleDetailsSinceDate' + JSON.stringify(argsObj))
      .digest('base64');
    ...
    const refinedResult = this.client['getBasicPeopleDetailsSinceDateAsync'](
      argsObj
    )
      .then((result: any) => {
        return result[0];
  ...
  public async createEstablishmentFromEstablishmentDTO(
    ...
    const requestId = createHash('sha1')
      .update(
        'createEstablishmentFromEstablishmentDTO' + JSON.stringify(argsObj)
      )
      .digest('base64');
    ...
    const refinedResult = this.client[
      'createEstablishmentFromEstablishmentDTOAsync'
    ](argsObj)
      .then((result: any) => {
        return result[0];
      })
  ...
  public async getBasicPersonDetailsByEncryptedActivationId(
    ...
    const requestId = createHash('sha1')
      .update(
        'getBasicPersonDetailsByEncryptedActivationId' + JSON.stringify(argsObj)
      )
      .digest('base64');
    ...
    const refinedResult = this.client[
      'getBasicPersonDetailsByEncryptedActivationIdAsync'
    ](argsObj)
      .then((result: any) => {
        return result[0];
      })
  ...
  public async requestLinkExistingFedId(
    ...
    const requestId = createHash('sha1')
      .update('requestLinkExistingFedId' + JSON.stringify(argsObj))
      .digest('base64');
    ...
    const refinedResult = this.client['requestLinkExistingFedIdAsync'](argsObj)
      .then((result: any) => {
        return result[0];
      })
      .catch((result: any) => {
  ...
  public async getBasicPersonDetailsFromEmail(
    ...
    const requestId = createHash('sha1')
      .update('getBasicPersonDetailsFromEmail' + JSON.stringify(argsObj))
      .digest('base64');
    ...
    const refinedResult = this.client['getBasicPersonDetailsFromEmailAsync'](
      argsObj
    )
      .then((result: any) => {
        return result[0];
  ...
  public async requestNewFedId(
    ...
    const requestId = createHash('sha1')
      .update('requestNewFedId' + JSON.stringify(argsObj))
      .digest('base64');
    ...
    const refinedResult = this.client['requestNewFedIdAsync'](argsObj)
      .then((result: any) => {
        return result[0];
      })
      .catch((result: any) => {
  ...
  public async sendPasswordResetEmail(Token: any, Email: any): Promise<any> {
    ...
    const requestId = createHash('sha1')
      .update('sendPasswordResetEmail' + JSON.stringify(argsObj))
      .digest('base64');
    ...
    const refinedResult = this.client['sendPasswordResetEmailAsync'](argsObj)
      .then((result: any) => {
        return result[0];
      })
      .catch((result: any) => {
  ...
  public async getAllEstablishmentDTOs(): Promise<any> {
    ...
    const requestId = createHash('sha1')
      .update('getAllEstablishmentDTOs' + JSON.stringify(argsObj))
      .digest('base64');
    ...
    const refinedResult = this.client['getAllEstablishmentDTOsAsync'](argsObj)
      .then((result: any) => {
        return result[0];
      })
      .catch((result: any) => {
  ...
  public async getEstablishmentDTOsByQuery(searchQuery: any): Promise<any> {
    ...
    const requestId = createHash('sha1')
      .update('getEstablishmentDTOsByQuery' + JSON.stringify(argsObj))
      .digest('base64');
    ...
    const refinedResult = this.client['getEstablishmentDTOsByQueryAsync'](
      argsObj
    )
      .then((result: any) => {
        return result[0];
  ...
  public async acceptLatestDataProtectionAgreement(
    ...
    const requestId = createHash('sha1')
      .update('acceptLatestDataProtectionAgreement' + JSON.stringify(argsObj))
      .digest('base64');
    ...
    const refinedResult = this.client[
      'acceptLatestDataProtectionAgreementAsync'
    ](argsObj)
      .then((result: any) => {
        return result[0];
      })
  ...
  public async setMonitorDTO(
    ...
    const requestId = createHash('sha1')
      .update('setMonitorDTO' + JSON.stringify(argsObj))
      .digest('base64');
    ...
    const refinedResult = this.client['setMonitorDTOAsync'](argsObj)
      .then((result: any) => {
        return result[0];
      })
      .catch((result: any) => {
  ...
  public async activateAccountWithoutPassword(
    ...
    const requestId = createHash('sha1')
      .update('activateAccountWithoutPassword' + JSON.stringify(argsObj))
      .digest('base64');
    ...
    const refinedResult = this.client['activateAccountWithoutPasswordAsync'](
      argsObj
    )
      .then((result: any) => {
        return result[0];
  ...
  public async getBasicPersonDetailsFromFedId(
    ...
    const requestId = createHash('sha1')
      .update('getBasicPersonDetailsFromFedId' + JSON.stringify(argsObj))
      .digest('base64');
    ...
    const refinedResult = this.client['getBasicPersonDetailsFromFedIdAsync'](
      argsObj
    )
      .then((result: any) => {
        return result[0];
  ...
  public async activateAccount(
    ...
    const requestId = createHash('sha1')
      .update('activateAccount' + JSON.stringify(argsObj))
      .digest('base64');
    ...
    const refinedResult = this.client['activateAccountAsync'](argsObj)
      .then((result: any) => {
        return result[0];
      })
      .catch((result: any) => {
  ...
  public async getBasicPeopleDetailsFromUserNumbers(
    ...
    const requestId = createHash('sha1')
      .update('getBasicPeopleDetailsFromUserNumbers' + JSON.stringify(argsObj))
      .digest('base64');
    ...
    const refinedResult = this.client[
      'getBasicPeopleDetailsFromUserNumbersAsync'
    ](argsObj)
      .then((result: any) => {
        return result[0];
      })
  ...
  public async getAllCountries(): Promise<any> {
    ...
    const requestId = createHash('sha1')
      .update('getAllCountries' + JSON.stringify(argsObj))
      .digest('base64');
    ...
    const refinedResult = this.client['getAllCountriesAsync'](argsObj)
      .then((result: any) => {
        return result[0];
      })
      .catch((result: any) => {
  ...
  public async getSearchableBasicPersonDetailsFromEmail(
    ...
    const requestId = createHash('sha1')
      .update(
        'getSearchableBasicPersonDetailsFromEmail' + JSON.stringify(argsObj)
      )
      .digest('base64');
    ...
    const refinedResult = this.client[
      'getSearchableBasicPersonDetailsFromEmailAsync'
    ](argsObj)
      .then((result: any) => {
        return result[0];
      })
  ...
  public async getPersonDetailsFromUserNumber(
    ...
    const requestId = createHash('sha1')
      .update('getPersonDetailsFromUserNumber' + JSON.stringify(argsObj))
      .digest('base64');
    ...
    const refinedResult = this.client['getPersonDetailsFromUserNumberAsync'](
      argsObj
    )
      .then((result: any) => {
        return result[0];
  ...
  public async getPersonDetailsFromEmail(Token: any, Email: any): Promise<any> {
    ...
    const requestId = createHash('sha1')
      .update('getPersonDetailsFromEmail' + JSON.stringify(argsObj))
      .digest('base64');
    ...
    const refinedResult = this.client['getPersonDetailsFromEmailAsync'](argsObj)
      .then((result: any) => {
        return result[0];
      })
      .catch((result: any) => {
  ...
  public async createFedId(
    ...
    const requestId = createHash('sha1')
      .update('createFedId' + JSON.stringify(argsObj))
      .digest('base64');
    ...
    const refinedResult = this.client['createFedIdAsync'](argsObj)
      .then((result: any) => {
        return result[0];
      })
      .catch((result: any) => {
  ...
  public async getAllFacilityNames(): Promise<any> {
    ...
    const requestId = createHash('sha1')
      .update('getAllFacilityNames' + JSON.stringify(argsObj))
      .digest('base64');
    ...
    const refinedResult = this.client['getAllFacilityNamesAsync'](argsObj)
      .then((result: any) => {
        return result[0];
      })
      .catch((result: any) => {
  ...
  public async getPeopleDetailsFromEmails(
    ...
    const requestId = createHash('sha1')
      .update('getPeopleDetailsFromEmails' + JSON.stringify(argsObj))
      .digest('base64');
    ...
    const refinedResult = this.client['getPeopleDetailsFromEmailsAsync'](
      argsObj
    )
      .then((result: any) => {
        return result[0];
  ...
  public async isAlternativeIdentifierActive(
    ...
    const requestId = createHash('sha1')
      .update('isAlternativeIdentifierActive' + JSON.stringify(argsObj))
      .digest('base64');
    ...
    const refinedResult = this.client['isAlternativeIdentifierActiveAsync'](
      argsObj
    )
      .then((result: any) => {
        return result[0];
  ...
  public async isAlternativeIdentifierLinked(
    ...
    const requestId = createHash('sha1')
      .update('isAlternativeIdentifierLinked' + JSON.stringify(argsObj))
      .digest('base64');
    ...
    const refinedResult = this.client['isAlternativeIdentifierLinkedAsync'](
      argsObj
    )
      .then((result: any) => {
        return result[0];
  ...
  public async login(Account: any, Password: any): Promise<any> {
    ...
    const requestId = createHash('sha1')
      .update('login' + JSON.stringify(argsObj))
      .digest('base64');
    ...
    const refinedResult = this.client['loginAsync'](argsObj)
      .then((result: any) => {
        return result[0];
      })
      .catch((result: any) => {
  ...
  public async linkAlternativeIdentifierToUser(
    ...
    const requestId = createHash('sha1')
      .update('linkAlternativeIdentifierToUser' + JSON.stringify(argsObj))
      .digest('base64');
    ...
    const refinedResult = this.client['linkAlternativeIdentifierToUserAsync'](
      argsObj
    )
      .then((result: any) => {
        return result[0];
  ...
  public async getAlternativeIdentifiersForUser(
    ...
    const requestId = createHash('sha1')
      .update('getAlternativeIdentifiersForUser' + JSON.stringify(argsObj))
      .digest('base64');
    ...
    const refinedResult = this.client['getAlternativeIdentifiersForUserAsync'](
      argsObj
    )
      .then((result: any) => {
        return result[0];
  ...
  public async getBasicPeopleDetailsFromEstablishments(
    ...
    const requestId = createHash('sha1')
      .update(
        'getBasicPeopleDetailsFromEstablishments' + JSON.stringify(argsObj)
      )
      .digest('base64');
    ...
    const refinedResult = this.client[
      'getBasicPeopleDetailsFromEstablishmentsAsync'
    ](argsObj)
      .then((result: any) => {
        return result[0];
      })
  ...
  public async getPersonDTOFromUserNumber(
    ...
    const requestId = createHash('sha1')
      .update('getPersonDTOFromUserNumber' + JSON.stringify(argsObj))
      .digest('base64');
    ...
    const refinedResult = this.client['getPersonDTOFromUserNumberAsync'](
      argsObj
    )
      .then((result: any) => {
        return result[0];
  ...
  public async getBasicPersonDetailsByEncryptedPasswordResetId(
    ...
    const refinedResult = this.client[
      'getBasicPersonDetailsByEncryptedPasswordResetIdAsync'
    ](argsObj)
      .then((result: any) => {
        return result[0];
      })
  ...
  public async getAllEuCountries(): Promise<any> {
    ...
    const requestId = createHash('sha1')
      .update('getAllEuCountries' + JSON.stringify(argsObj))
      .digest('base64');
    ...
    const refinedResult = this.client['getAllEuCountriesAsync'](argsObj)
      .then((result: any) => {
        return result[0];
      })
      .catch((result: any) => {
  ...
  public async isAccountActive(UserNumber: any): Promise<any> {
    ...
    const requestId = createHash('sha1')
      .update('isAccountActive' + JSON.stringify(argsObj))
      .digest('base64');
    ...
    const refinedResult = this.client['isAccountActiveAsync'](argsObj)
      .then((result: any) => {
        return result[0];
      })
      .catch((result: any) => {
  ...
  public async getAllPersonStatuses(): Promise<any> {
    ...
    const requestId = createHash('sha1')
      .update('getAllPersonStatuses' + JSON.stringify(argsObj))
      .digest('base64');
    ...
    const refinedResult = this.client['getAllPersonStatusesAsync'](argsObj)
      .then((result: any) => {
        return result[0];
      })
      .catch((result: any) => {
  ...
  public async getBasicPersonDetailsFromUserNumber(
    ...
    const requestId = createHash('sha1')
      .update('getBasicPersonDetailsFromUserNumber' + JSON.stringify(argsObj))
      .digest('base64');
    ...
    const refinedResult = this.client[
      'getBasicPersonDetailsFromUserNumberAsync'
    ](argsObj)
      .then((result: any) => {
        return result[0];
      })
  ...
  public async getPeopleDetailsFromSurname(
    ...
    const requestId = createHash('sha1')
      .update('getPeopleDetailsFromSurname' + JSON.stringify(argsObj))
      .digest('base64');
    ...
    const refinedResult = this.client['getPeopleDetailsFromSurnameAsync'](
      argsObj
    )
      .then((result: any) => {
        return result[0];
  ...
  public async getEmergencyContactDTO(
    ...
    const requestId = createHash('sha1')
      .update('getEmergencyContactDTO' + JSON.stringify(argsObj))
      .digest('base64');
    ...
    const refinedResult = this.client['getEmergencyContactDTOAsync'](argsObj)
      .then((result: any) => {
        return result[0];
      })
      .catch((result: any) => {
  ...
  public async updateFedId(
    ...
    const requestId = createHash('sha1')
      .update('updateFedId' + JSON.stringify(argsObj))
      .digest('base64');
    ...
    const refinedResult = this.client['updateFedIdAsync'](argsObj)
      .then((result: any) => {
        return result[0];
      })
      .catch((result: any) => {
  ...
  public async updatePersonByDTOFromSource(
    ...
    const requestId = createHash('sha1')
      .update('updatePersonByDTOFromSource' + JSON.stringify(argsObj))
      .digest('base64');
    ...
    const refinedResult = this.client['updatePersonByDTOFromSourceAsync'](
      argsObj
    )
      .then((result: any) => {
        return result[0];

...
export type CreateSepMutation = {
  createSEP: {
    sep: {
      ...
      active: boolean;
      sepChairProposalCount: number | null;
      sepSecretaryProposalCount: number | null;
  ...
  sepProposal: {
    ...
    proposal: {
          ...
          fields: Array<{
            ...
            question: {
              ...
              config:
                ...
                | { html: string; plain: string; omitFromPdf: boolean }
                | { small_label: string; required: boolean; tooltip: string }
                | {
                ...
                | { titlePlaceholder: string; questionLabel: string }
                | {
                    small_label: string;
                    required: boolean;
                    tooltip: string;
            ...
            dependencies: Array<{
              ...
              condition: { condition: EvaluatorOperator; params: any };
            }>;
          }>;
        }>;
      };
      ...
      reviews: Array<{
        ...
        userID: number;
        sepID: number;
        reviewer: { firstname: string; lastname: string; id: number } | null;
      }> | null;
      instrument: { id: number; name: string; shortCode: string } | null;
      call: {
        id: number;
        shortCode: string;
        allocationTimeUnit: AllocationTimeUnits;
...
export type GetSepProposalsQuery = {
  sepProposals: Array<{
    ...
    proposal: {
      ...
      primaryKey: number;
      proposalId: string;
      proposer: { id: number; organizationId: number } | null;
      status: {
        id: number;
        shortCode: string;
        name: string;
      ...
      users: Array<{ id: number; organizationId: number }>;
    };
    assignments: Array<{
      proposalPk: number;
      sepMemberUserId: number | null;
...
export type SepProposalsByInstrumentQuery = {
  sepProposalsByInstrument: Array<{
    ...
    assignments: Array<{ sepMemberUserId: number | null }> | null;
  }> | null;
};
...
export type ReorderSepMeetingDecisionProposalsMutation = {
  reorderSepMeetingDecisionProposals: {
    ...
    sepMeetingDecision: { proposalPk: number } | null;
  };
};
...
export type CreateInstitutionMutation = {
  createInstitution: {
    institution: {
      ...
      name: string;
      verified: boolean;
      country: { id: number; value: string } | null;
    } | null;
    rejection: {
      reason: string;
      context: string | null;
...
export type DeleteInstitutionMutation = {
  deleteInstitution: {
    institution: { id: number; verified: boolean } | null;
    rejection: {
      reason: string;
      context: string | null;
      exception: string | null;
...
export type GetAllApiAccessTokensAndPermissionsQueryVariables = Exact<{
  [key: string]: never;
}>;
...
export type GetAllQueriesAndMutationsQueryVariables = Exact<{
  [key: string]: never;
}>;
...
export type GetFeaturesQuery = {
  features: Array<{ id: FeatureId; isEnabled: boolean; description: string }>;
};
...
export type GetInstitutionsQuery = {
  institutions: Array<{ id: number; name: string; verified: boolean }> | null;
};
...
export type GetInstitutionsWithCountryQuery = {
  institutions: Array<{
    id: number;
    name: string;
    verified: boolean;
...
export type SetPageContentMutation = {
  setPageContent: {
    page: { id: number; content: string | null } | null;
    rejection: {
      reason: string;
      context: string | null;
      exception: string | null;
...
export type CreateCallMutation = {
  createCall: {
    ...
    call: {
      ...
      seps: Array<{ id: number; code: string }> | null;
      proposalWorkflow: {
        id: number;
        name: string;
        description: string;
      } | null;
      template: { templateId: number; name: string; isArchived: boolean };
    } | null;
  };
};
...
export type CallFragment = {
  ...
  seps: Array<{ id: number; code: string }> | null;
  proposalWorkflow: { id: number; name: string; description: string } | null;
  template: { templateId: number; name: string; isArchived: boolean };
};
  ...
  createEsi: {
    esi: {
      ...
      sampleEsis: Array<{
        ...
        questionary: { isCompleted: boolean };
      }>;
      proposal: {
        primaryKey: number;
        proposalId: string;
...
export type GetGenericTemplatesWithProposalDataQuery = {
  genericTemplates: Array<{
    ...
    proposalPk: number;
    questionId: string;
    proposal: { primaryKey: number; proposalId: string };
  }> | null;
};
...
export type GetMyInstrumentsQuery = {
  me: {
    instruments: Array<{
      id: number;
      name: string;
...
export type CreatePredefinedMessageMutation = {
...
export type DeletePredefinedMessageMutation = {
...
export type PredefinedMessageFragment = {
  id: number;
  title: string;
  message: string;
  lastModifiedBy: number;
...
export type UpdatePredefinedMessageMutation = {
...
export type AdministrationProposalMutation = {
  administrationProposal: {
    proposal: { primaryKey: number } | null;
    rejection: {
      reason: string;
      context: string | null;
      exception: string | null;
...
export type GetProposalQuery = {
  proposal: {
    ...
    instrument: {
      ...
      scientists: Array<{ id: number; firstname: string; lastname: string }>;
    } | null;
    call: {
      id: number;
      shortCode: string;
    ...
    sep: { id: number; code: string } | null;
    samples: Array<{
      id: number;
      title: string;
      creatorId: number;
...
export type GetProposalsQuery = {
  proposals: {
    ...
    proposals: Array<{
      ...
      call: { id: number; shortCode: string } | null;
      sep: { id: number; code: string } | null;
      status: {
        id: number;
        shortCode: string;
...
export type GetUserProposalBookingsWithEventsQueryVariables = Exact<{
  endsAfter?: InputMaybe<Scalars['DateTime']>;
  status?: InputMaybe<
    Array<ProposalBookingStatusCore> | ProposalBookingStatusCore
  >;
  instrumentId?: InputMaybe<Scalars['Int']>;
}>;
...
export type FileMetadataFragment = {
  fileId: string;
...
export type AddTechnicalReviewMutation = {
  addTechnicalReview: {
    ...
    technicalReview: { id: number } | null;
  };
};
...
export type SubmitTechnicalReviewsMutationVariables = Exact<{
  technicalReviews:
    | Array<SubmitTechnicalReviewInput>
    | SubmitTechnicalReviewInput;
}>;

export type SubmitTechnicalReviewsMutation = {
  ...
  me: {
    ...
    reviews: Array<{
      ...
      proposal: {
        ...
        instrument: { shortCode: string } | null;
      } | null;
    }>;
  } | null;
};
...
export type ScheduledEventCoreFragment = {
  id: number;
...
export type GetScheduledEventCoreQuery = {
  scheduledEventCore: {
    id: number;
    proposalPk: number | null;
    bookingType: ScheduledEventBookingType;
...
export type GetScheduledEventsCoreQuery = {
...
export type AddProposalWorkflowStatusMutation = {
  addProposalWorkflowStatus: {
    proposalWorkflowConnection: { id: number } | null;
    rejection: {
      reason: string;
      context: string | null;
      exception: string | null;
...
export type GetProposalEventsQuery = {
  proposalEvents: Array<{ name: Event; description: string | null }> | null;
};
...
export type GetProposalWorkflowsQueryVariables = Exact<{
  [key: string]: never;
}>;
    ...
    proposalWorkflow: {
      ...
      proposalWorkflowConnectionGroups: Array<{
        ...
        connections: Array<{
          ...
          prevProposalStatusId: number | null;
          droppableGroupId: string;
          proposalStatus: { id: number; name: string; description: string };
          statusChangingEvents: Array<{
            statusChangingEventId: number;
            proposalWorkflowConnectionId: number;
            statusChangingEvent: string;
...
export type ImportTemplateMutationVariables = Exact<{
  ...
  subTemplatesConflictResolutions:
    | Array<Array<ConflictResolution> | ConflictResolution>
...
export type ImportTemplateMutation = {
  importTemplate: {
    template: {
      ...
      pdfTemplate: { pdfTemplateId: number; templateData: string } | null;
    } | null;
    rejection: {
      reason: string;
      context: string | null;
...
export type DeleteTemplateMutation = {
  deleteTemplate: {
    template: { templateId: number; name: string } | null;
    rejection: {
      reason: string;
      context: string | null;
      exception: string | null;
...
type FieldConfig_BooleanConfig_Fragment = {
  small_label: string;
  required: boolean;
  tooltip: string;
};

type FieldConfig_DateConfig_Fragment = {
  small_label: string;
  required: boolean;
  tooltip: string;
  minDate: string | null;
...
type FieldConfig_EmbellishmentConfig_Fragment = {
  html: string;
  plain: string;
  omitFromPdf: boolean;
};

type FieldConfig_FeedbackBasisConfig_Fragment = {
  small_label: string;
  required: boolean;
  tooltip: string;
};

type FieldConfig_FileUploadConfig_Fragment = {
  file_type: Array<string>;
  max_files: number;
  pdf_page_limit: number;
  small_label: string;
...
type FieldConfig_GenericTemplateBasisConfig_Fragment = {
  titlePlaceholder: string;
  questionLabel: string;
};

type FieldConfig_IntervalConfig_Fragment = {
  small_label: string;
  required: boolean;
  tooltip: string;
  units: Array<{
...
type FieldConfig_NumberInputConfig_Fragment = {
  numberValueConstraint: NumberValueConstraint | null;
  small_label: string;
  required: boolean;
  tooltip: string;
...
type FieldConfig_RichTextInputConfig_Fragment = {
  small_label: string;
  required: boolean;
  tooltip: string;
  max: number | null;
...
type FieldConfig_SampleDeclarationConfig_Fragment = {
  addEntryButtonLabel: string;
  minEntries: number | null;
  maxEntries: number | null;
  templateId: number | null;
...
type FieldConfig_SelectionFromOptionsConfig_Fragment = {
  variant: string;
  options: Array<string>;
  isMultipleSelect: boolean;
  small_label: string;
...
type FieldConfig_ShipmentBasisConfig_Fragment = {
  small_label: string;
  required: boolean;
  tooltip: string;
};

type FieldConfig_SubTemplateConfig_Fragment = {
  addEntryButtonLabel: string;
  minEntries: number | null;
  maxEntries: number | null;
  templateId: number | null;
...
type FieldConfig_TextInputConfig_Fragment = {
  min: number | null;
  max: number | null;
  multiline: boolean;
  placeholder: string;
...
type FieldConfig_VisitBasisConfig_Fragment = {
  small_label: string;
  required: boolean;
  tooltip: string;
};
...
export type FieldConfigFragment =
  | FieldConfig_BooleanConfig_Fragment
  | FieldConfig_DateConfig_Fragment
  | FieldConfig_EmbellishmentConfig_Fragment
  | FieldConfig_FeedbackBasisConfig_Fragment
  | FieldConfig_FileUploadConfig_Fragment
  | FieldConfig_GenericTemplateBasisConfig_Fragment
  | FieldConfig_IntervalConfig_Fragment
  | FieldConfig_NumberInputConfig_Fragment
  | FieldConfig_ProposalBasisConfig_Fragment
  | FieldConfig_ProposalEsiBasisConfig_Fragment
  | FieldConfig_RichTextInputConfig_Fragment
  | FieldConfig_SampleBasisConfig_Fragment
  | FieldConfig_SampleDeclarationConfig_Fragment
  | FieldConfig_SampleEsiBasisConfig_Fragment
  | FieldConfig_SelectionFromOptionsConfig_Fragment
  | FieldConfig_ShipmentBasisConfig_Fragment
  | FieldConfig_SubTemplateConfig_Fragment
  | FieldConfig_TextInputConfig_Fragment
  | FieldConfig_VisitBasisConfig_Fragment;
...
export type QuestionComparisonFragment = {
  status: QuestionComparisonStatus;
  conflictResolutionStrategy: ConflictResolutionStrategy;
  existingQuestion: {
    id: string;
...
export type TemplateStepFragment = {
  topic: { title: string; id: number; sortOrder: number; isEnabled: boolean };
  fields: Array<{
    sortOrder: number;
    topicId: number;
    dependenciesOperator: DependenciesLogicOperator | null;
...
export type TemplateValidationDataFragment = {
  isValid: boolean;
  errors: Array<string>;
  ...
  subTemplateValidationData: Array<{
    isValid: boolean;
    errors: Array<string>;
    questionComparisons: Array<{
      status: QuestionComparisonStatus;
...
export type GetPdfTemplateQuery = {
  pdfTemplate: {
...
export type GetQuestionsQuery = {
  questions: Array<{
    ...
    config:
      ...
      | { small_label: string; required: boolean; tooltip: string };
    answers: Array<{ questionaryId: number }>;
    templates: Array<{ templateId: number }>;
  }>;
};
...
export type ValidateUnitsImportMutation = {
  validateUnitsImport: {
    validationResult: {
      json: string;
      version: string;
...
export type GetCountriesQuery = {
  countries: Array<{ id: number; value: string }> | null;
};
...
export type GetMyRolesQuery = {
  me: {
    firstname: string;
    lastname: string;
    roles: Array<{ id: number; shortCode: string; title: string }>;
  } | null;
};
...
export type GetNationalitiesQuery = {
  nationalities: Array<{ id: number; value: string }> | null;
};
...
export type GetRolesQuery = {
  roles: Array<{ id: number; shortCode: string; title: string }> | null;
};
...
export const ReorderSepMeetingDecisionProposalsDocument = gql`
  mutation reorderSepMeetingDecisionProposals(
    $reorderSepMeetingDecisionProposalsInput: ReorderSepMeetingDecisionProposalsInput!
  ) {
    reorderSepMeetingDecisionProposals(
      reorderSepMeetingDecisionProposalsInput: $reorderSepMeetingDecisionProposalsInput
...
export const SaveSepMeetingDecisionDocument = gql`
  mutation saveSepMeetingDecision(
    $saveSepMeetingDecisionInput: SaveSEPMeetingDecisionInput!
  ) {
    saveSepMeetingDecision(
      saveSepMeetingDecisionInput: $saveSepMeetingDecisionInput
...
export const DeleteApiAccessTokenDocument = gql`
  mutation deleteApiAccessToken($accessTokenId: String!) {
    deleteApiAccessToken(
      deleteApiAccessTokenInput: { accessTokenId: $accessTokenId }
    ) {
      rejection {
        ...rejection
      }
...
export const RemoveAssignedInstrumentFromCallDocument = gql`
  mutation removeAssignedInstrumentFromCall(
    $instrumentId: Int!
    $callId: Int!
  ) {
    removeAssignedInstrumentFromCall(
...
export const GetGenericTemplatesWithQuestionaryStatusDocument = gql`
  query getGenericTemplatesWithQuestionaryStatus(
...
export const AssignScientistsToInstrumentDocument = gql`
  mutation assignScientistsToInstrument(
    $scientistIds: [Int!]!
    $instrumentId: Int!
  ) {
    assignScientistsToInstrument(
...
export const RemoveScientistFromInstrumentDocument = gql`
  mutation removeScientistFromInstrument(
    $scientistId: Int!
    $instrumentId: Int!
  ) {
    removeScientistFromInstrument(
...
export const SetInstrumentAvailabilityTimeDocument = gql`
  mutation setInstrumentAvailabilityTime(
    $callId: Int!
    $instrumentId: Int!
...
export const SubmitProposalsReviewDocument = gql`
  mutation submitProposalsReview($proposals: [ProposalPkWithReviewId!]!) {
    submitProposalsReview(
      submitProposalsReviewInput: { proposals: $proposals }
    ) {
      rejection {
        ...rejection
      }
...
export const DeleteProposalWorkflowStatusDocument = gql`
  mutation deleteProposalWorkflowStatus(
    $proposalStatusId: Int!
    $proposalWorkflowId: Int!
    $sortOrder: Int!
  ) {
...
export const MoveProposalWorkflowStatusDocument = gql`
  mutation moveProposalWorkflowStatus(
    $from: IndexWithGroupId!
    $to: IndexWithGroupId!
    $proposalWorkflowId: Int!
  ) {
...
export const CreateQuestionTemplateRelationDocument = gql`
  mutation createQuestionTemplateRelation(
    $templateId: Int!
    $questionId: String!
    $topicId: Int!
    $sortOrder: Int!
...
export const DeleteQuestionTemplateRelationDocument = gql`
  mutation deleteQuestionTemplateRelation(
    $questionId: String!
    $templateId: Int!
  ) {
    deleteQuestionTemplateRelation(
...
export const UpdateQuestionTemplateRelationDocument = gql`
  mutation updateQuestionTemplateRelation(
    $questionId: String!
    $templateId: Int!
    $topicId: Int
    $sortOrder: Int!
...
export const UpdateQuestionTemplateRelationSettingsDocument = gql`
  mutation updateQuestionTemplateRelationSettings(
    $questionId: String!
    $templateId: Int!
    $config: String
...
export const CreateUserByEmailInviteDocument = gql`
  mutation createUserByEmailInvite(
    $firstname: String!
    $lastname: String!
    $email: String!
    $userRole: UserRole!
...
export function getSdk(
  ...
  return {
    assignProposalsToSep(
      variables: AssignProposalsToSepMutationVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<AssignProposalsToSepMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<AssignProposalsToSepMutation>(
            AssignProposalsToSepDocument,
            variables,
    ...
    assignReviewersToSEP(
      variables: AssignReviewersToSepMutationVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<AssignReviewersToSepMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<AssignReviewersToSepMutation>(
            AssignReviewersToSepDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        'assignReviewersToSEP',
    ...
    assignChairOrSecretary(
      variables: AssignChairOrSecretaryMutationVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<AssignChairOrSecretaryMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<AssignChairOrSecretaryMutation>(
    ...
    assignSepReviewersToProposal(
      variables: AssignSepReviewersToProposalMutationVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<AssignSepReviewersToProposalMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<AssignSepReviewersToProposalMutation>(
            AssignSepReviewersToProposalDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        'assignSepReviewersToProposal',
    ...
    createSEP(
      variables: CreateSepMutationVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<CreateSepMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<CreateSepMutation>(CreateSepDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        'createSEP',
    ...
    deleteSEP(
      variables: DeleteSepMutationVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<DeleteSepMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<DeleteSepMutation>(DeleteSepDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        'deleteSEP',
    ...
    getInstrumentsBySEP(
      variables: GetInstrumentsBySepQueryVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<GetInstrumentsBySepQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetInstrumentsBySepQuery>(
            GetInstrumentsBySepDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        'getInstrumentsBySEP',
    ...
    getUserSeps(
      variables?: GetUserSepsQueryVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<GetUserSepsQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetUserSepsQuery>(GetUserSepsDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        'getUserSeps',
    ...
    getSEP(
      variables: GetSepQueryVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<GetSepQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetSepQuery>(GetSepDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        'getSEP',
    ...
    getSEPMembers(
      variables: GetSepMembersQueryVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<GetSepMembersQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetSepMembersQuery>(GetSepMembersDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        'getSEPMembers',
    ...
    getSEPProposal(
      variables: GetSepProposalQueryVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<GetSepProposalQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetSepProposalQuery>(
            GetSepProposalDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        'getSEPProposal',
    ...
    getSEPProposals(
      variables: GetSepProposalsQueryVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<GetSepProposalsQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetSepProposalsQuery>(
            GetSepProposalsDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        'getSEPProposals',
    ...
    sepProposalsByInstrument(
      variables: SepProposalsByInstrumentQueryVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<SepProposalsByInstrumentQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<SepProposalsByInstrumentQuery>(
            SepProposalsByInstrumentDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        'sepProposalsByInstrument',
    ...
    getSEPReviewers(
      variables: GetSepReviewersQueryVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<GetSepReviewersQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetSepReviewersQuery>(
            GetSepReviewersDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        'getSEPReviewers',
    ...
    getSEPs(
      variables?: GetSePsQueryVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<GetSePsQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetSePsQuery>(GetSePsDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        'getSEPs',
    ...
    removeProposalsFromSep(
      variables: RemoveProposalsFromSepMutationVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<RemoveProposalsFromSepMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<RemoveProposalsFromSepMutation>(
            RemoveProposalsFromSepDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        'removeProposalsFromSep',
    ...
    removeMemberFromSep(
      variables: RemoveMemberFromSepMutationVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<RemoveMemberFromSepMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<RemoveMemberFromSepMutation>(
            RemoveMemberFromSepDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        'removeMemberFromSep',
    ...
    removeMemberFromSEPProposal(
      variables: RemoveMemberFromSepProposalMutationVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<RemoveMemberFromSepProposalMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<RemoveMemberFromSepProposalMutation>(
            RemoveMemberFromSepProposalDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        'removeMemberFromSEPProposal',
    ...
    reorderSepMeetingDecisionProposals(
      variables: ReorderSepMeetingDecisionProposalsMutationVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<ReorderSepMeetingDecisionProposalsMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<ReorderSepMeetingDecisionProposalsMutation>(
            ReorderSepMeetingDecisionProposalsDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        'reorderSepMeetingDecisionProposals',
    ...
    saveSepMeetingDecision(
      variables: SaveSepMeetingDecisionMutationVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<SaveSepMeetingDecisionMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<SaveSepMeetingDecisionMutation>(
            SaveSepMeetingDecisionDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        'saveSepMeetingDecision',
    ...
    updateSEP(
      variables: UpdateSepMutationVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<UpdateSepMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<UpdateSepMutation>(UpdateSepDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        'updateSEP',
    ...
    updateSEPTimeAllocation(
      variables: UpdateSepTimeAllocationMutationVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<UpdateSepTimeAllocationMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<UpdateSepTimeAllocationMutation>(
            UpdateSepTimeAllocationDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        'updateSEPTimeAllocation',
    ...
    addClientLog(
      variables: AddClientLogMutationVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<AddClientLogMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<AddClientLogMutation>(
            AddClientLogDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        'addClientLog',
    ...
    createApiAccessToken(
      variables: CreateApiAccessTokenMutationVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<CreateApiAccessTokenMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<CreateApiAccessTokenMutation>(
            CreateApiAccessTokenDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        'createApiAccessToken',
    ...
    createInstitution(
      variables: CreateInstitutionMutationVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<CreateInstitutionMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<CreateInstitutionMutation>(
    ...
    deleteApiAccessToken(
      variables: DeleteApiAccessTokenMutationVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<DeleteApiAccessTokenMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<DeleteApiAccessTokenMutation>(
            DeleteApiAccessTokenDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        'deleteApiAccessToken',
    ...
    deleteInstitution(
      variables: DeleteInstitutionMutationVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<DeleteInstitutionMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<DeleteInstitutionMutation>(
    ...
    getAllApiAccessTokensAndPermissions(
      variables?: GetAllApiAccessTokensAndPermissionsQueryVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<GetAllApiAccessTokensAndPermissionsQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetAllApiAccessTokensAndPermissionsQuery>(
            GetAllApiAccessTokensAndPermissionsDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        'getAllApiAccessTokensAndPermissions',
    ...
    getAllQueriesAndMutations(
      variables?: GetAllQueriesAndMutationsQueryVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<GetAllQueriesAndMutationsQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetAllQueriesAndMutationsQuery>(
            GetAllQueriesAndMutationsDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        'getAllQueriesAndMutations',
    ...
    getFeatures(
      ...
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<GetFeaturesQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetFeaturesQuery>(GetFeaturesDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        'getFeatures',
    ...
    getInstitutions(
      variables?: GetInstitutionsQueryVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<GetInstitutionsQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetInstitutionsQuery>(
    ...
    getInstitutionsWithCountry(
      variables?: GetInstitutionsWithCountryQueryVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<GetInstitutionsWithCountryQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetInstitutionsWithCountryQuery>(
            GetInstitutionsWithCountryDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        'getInstitutionsWithCountry',
    ...
    getPageContent(
      variables: GetPageContentQueryVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<GetPageContentQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetPageContentQuery>(
    ...
    getQuantities(
      ...
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<GetQuantitiesQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetQuantitiesQuery>(GetQuantitiesDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        'getQuantities',
    ...
    mergeInstitutions(
      variables: MergeInstitutionsMutationVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<MergeInstitutionsMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<MergeInstitutionsMutation>(
            MergeInstitutionsDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        'mergeInstitutions',
    ...
    prepareDB(
      variables: PrepareDbMutationVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<PrepareDbMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<PrepareDbMutation>(PrepareDbDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        'prepareDB',
    ...
    setPageContent(
      ...
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<SetPageContentMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<SetPageContentMutation>(
            SetPageContentDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        'setPageContent',
    ...
    updateApiAccessToken(
      variables: UpdateApiAccessTokenMutationVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<UpdateApiAccessTokenMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<UpdateApiAccessTokenMutation>(
            UpdateApiAccessTokenDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        'updateApiAccessToken',
    ...
    updateInstitution(
      variables: UpdateInstitutionMutationVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<UpdateInstitutionMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<UpdateInstitutionMutation>(
    ...
    assignInstrumentsToCall(
      variables: AssignInstrumentsToCallMutationVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<AssignInstrumentsToCallMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<AssignInstrumentsToCallMutation>(
    ...
    createCall(
      variables: CreateCallMutationVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<CreateCallMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<CreateCallMutation>(CreateCallDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        'createCall',
    ...
    deleteCall(
      variables: DeleteCallMutationVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<DeleteCallMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<DeleteCallMutation>(DeleteCallDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        'deleteCall',
    ...
    getCall(
      variables: GetCallQueryVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<GetCallQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetCallQuery>(GetCallDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        'getCall',
    ...
    getCalls(
      variables?: GetCallsQueryVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<GetCallsQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetCallsQuery>(GetCallsDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        'getCalls',
    ...
    getCallsByInstrumentScientist(
      variables: GetCallsByInstrumentScientistQueryVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<GetCallsByInstrumentScientistQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetCallsByInstrumentScientistQuery>(
            GetCallsByInstrumentScientistDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        'getCallsByInstrumentScientist',
    ...
    removeAssignedInstrumentFromCall(
      variables: RemoveAssignedInstrumentFromCallMutationVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<RemoveAssignedInstrumentFromCallMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<RemoveAssignedInstrumentFromCallMutation>(
    ...
    updateCall(
      variables: UpdateCallMutationVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<UpdateCallMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<UpdateCallMutation>(UpdateCallDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        'updateCall',
    ...
    createEsi(
      variables: CreateEsiMutationVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<CreateEsiMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<CreateEsiMutation>(CreateEsiDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        'createEsi',
    ...
    getEsi(
      variables: GetEsiQueryVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<GetEsiQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetEsiQuery>(GetEsiDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        'getEsi',
    ...
    updateEsi(
      variables: UpdateEsiMutationVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<UpdateEsiMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<UpdateEsiMutation>(UpdateEsiDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        'updateEsi',
    ...
    getEventLogs(
      variables: GetEventLogsQueryVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<GetEventLogsQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetEventLogsQuery>(GetEventLogsDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        'getEventLogs',
    ...
    createFeedback(
      ...
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<CreateFeedbackMutation>(
    ...
    updateFeedback(
      variables: UpdateFeedbackMutationVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<UpdateFeedbackMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<UpdateFeedbackMutation>(
    ...
    cloneGenericTemplate(
      variables: CloneGenericTemplateMutationVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<CloneGenericTemplateMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<CloneGenericTemplateMutation>(
            CloneGenericTemplateDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        'cloneGenericTemplate',
    ...
    createGenericTemplate(
      variables: CreateGenericTemplateMutationVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<CreateGenericTemplateMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<CreateGenericTemplateMutation>(
    ...
    deleteGenericTemplate(
      variables: DeleteGenericTemplateMutationVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<DeleteGenericTemplateMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<DeleteGenericTemplateMutation>(
            DeleteGenericTemplateDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        'deleteGenericTemplate',
    ...
    getGenericTemplate(
      variables: GetGenericTemplateQueryVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<GetGenericTemplateQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetGenericTemplateQuery>(
            GetGenericTemplateDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        'getGenericTemplate',
    ...
    getGenericTemplatesWithProposalData(
      variables?: GetGenericTemplatesWithProposalDataQueryVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<GetGenericTemplatesWithProposalDataQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetGenericTemplatesWithProposalDataQuery>(
            GetGenericTemplatesWithProposalDataDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        'getGenericTemplatesWithProposalData',
    ...
    getGenericTemplatesWithQuestionaryStatus(
      variables?: GetGenericTemplatesWithQuestionaryStatusQueryVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<GetGenericTemplatesWithQuestionaryStatusQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetGenericTemplatesWithQuestionaryStatusQuery>(
            GetGenericTemplatesWithQuestionaryStatusDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        'getGenericTemplatesWithQuestionaryStatus',
    ...
    updateGenericTemplate(
      variables: UpdateGenericTemplateMutationVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<UpdateGenericTemplateMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<UpdateGenericTemplateMutation>(
            UpdateGenericTemplateDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        'updateGenericTemplate',
    ...
    assignProposalsToInstrument(
      variables: AssignProposalsToInstrumentMutationVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<AssignProposalsToInstrumentMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<AssignProposalsToInstrumentMutation>(
            AssignProposalsToInstrumentDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        'assignProposalsToInstrument',
    ...
    assignScientistsToInstrument(
      variables: AssignScientistsToInstrumentMutationVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<AssignScientistsToInstrumentMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<AssignScientistsToInstrumentMutation>(
            AssignScientistsToInstrumentDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        'assignScientistsToInstrument',
    ...
    createInstrument(
      variables: CreateInstrumentMutationVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<CreateInstrumentMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<CreateInstrumentMutation>(
    ...
    deleteInstrument(
      variables: DeleteInstrumentMutationVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<DeleteInstrumentMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<DeleteInstrumentMutation>(
    ...
    getInstruments(
      variables?: GetInstrumentsQueryVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<GetInstrumentsQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetInstrumentsQuery>(
    ...
    getMyInstruments(
      variables?: GetMyInstrumentsQueryVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<GetMyInstrumentsQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetMyInstrumentsQuery>(
            GetMyInstrumentsDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        'getMyInstruments',
    ...
    removeProposalsFromInstrument(
      variables: RemoveProposalsFromInstrumentMutationVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<RemoveProposalsFromInstrumentMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<RemoveProposalsFromInstrumentMutation>(
    ...
    removeScientistFromInstrument(
      variables: RemoveScientistFromInstrumentMutationVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<RemoveScientistFromInstrumentMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<RemoveScientistFromInstrumentMutation>(
            RemoveScientistFromInstrumentDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        'removeScientistFromInstrument',
    ...
    setInstrumentAvailabilityTime(
      variables: SetInstrumentAvailabilityTimeMutationVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<SetInstrumentAvailabilityTimeMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<SetInstrumentAvailabilityTimeMutation>(
            SetInstrumentAvailabilityTimeDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        'setInstrumentAvailabilityTime',
    ...
    submitInstrument(
      variables: SubmitInstrumentMutationVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<SubmitInstrumentMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<SubmitInstrumentMutation>(
            SubmitInstrumentDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        'submitInstrument',
    ...
    updateInstrument(
      variables: UpdateInstrumentMutationVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<UpdateInstrumentMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<UpdateInstrumentMutation>(
    ...
    createPredefinedMessage(
      variables: CreatePredefinedMessageMutationVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<CreatePredefinedMessageMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<CreatePredefinedMessageMutation>(
            CreatePredefinedMessageDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        'createPredefinedMessage',
    ...
    deletePredefinedMessage(
      variables: DeletePredefinedMessageMutationVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<DeletePredefinedMessageMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<DeletePredefinedMessageMutation>(
            DeletePredefinedMessageDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        'deletePredefinedMessage',
    ...
    getPredefinedMessages(
      variables?: GetPredefinedMessagesQueryVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<GetPredefinedMessagesQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetPredefinedMessagesQuery>(
            GetPredefinedMessagesDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        'getPredefinedMessages',
    ...
    updatePredefinedMessage(
      variables: UpdatePredefinedMessageMutationVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<UpdatePredefinedMessageMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<UpdatePredefinedMessageMutation>(
            UpdatePredefinedMessageDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        'updatePredefinedMessage',
    ...
    administrationProposal(
      variables: AdministrationProposalMutationVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<AdministrationProposalMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<AdministrationProposalMutation>(
            AdministrationProposalDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        'administrationProposal',
    ...
    changeProposalsStatus(
      variables: ChangeProposalsStatusMutationVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<ChangeProposalsStatusMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<ChangeProposalsStatusMutation>(
    ...
    cloneProposals(
      variables: CloneProposalsMutationVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<CloneProposalsMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<CloneProposalsMutation>(
            CloneProposalsDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        'cloneProposals',
    ...
    createProposal(
      ...
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<CreateProposalMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<CreateProposalMutation>(
    ...
    deleteProposal(
      ...
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<DeleteProposalMutation>(
    ...
    getInstrumentScientistProposals(
      variables?: GetInstrumentScientistProposalsQueryVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<GetInstrumentScientistProposalsQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetInstrumentScientistProposalsQuery>(
            GetInstrumentScientistProposalsDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        'getInstrumentScientistProposals',
    ...
    getMyProposals(
      variables?: GetMyProposalsQueryVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<GetMyProposalsQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetMyProposalsQuery>(
            GetMyProposalsDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        'getMyProposals',
    ...
    getProposalsCore(
      variables?: GetProposalsCoreQueryVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<GetProposalsCoreQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetProposalsCoreQuery>(
            GetProposalsCoreDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        'getProposalsCore',
    ...
    notifyProposal(
      variables: NotifyProposalMutationVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<NotifyProposalMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<NotifyProposalMutation>(
            NotifyProposalDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        'notifyProposal',
    ...
    submitProposal(
      variables: SubmitProposalMutationVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<SubmitProposalMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<SubmitProposalMutation>(
    ...
    updateProposal(
      variables: UpdateProposalMutationVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<UpdateProposalMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<UpdateProposalMutation>(
    ...
    getUserProposalBookingsWithEvents(
      variables?: GetUserProposalBookingsWithEventsQueryVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<GetUserProposalBookingsWithEventsQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetUserProposalBookingsWithEventsQuery>(
            GetUserProposalBookingsWithEventsDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        'getUserProposalBookingsWithEvents',
    ...
    answerTopic(
      variables: AnswerTopicMutationVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<AnswerTopicMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<AnswerTopicMutation>(AnswerTopicDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        'answerTopic',
    ...
    createQuestionary(
      variables: CreateQuestionaryMutationVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<CreateQuestionaryMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<CreateQuestionaryMutation>(
            CreateQuestionaryDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        'createQuestionary',
    ...
    getBlankQuestionary(
      variables: GetBlankQuestionaryQueryVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<GetBlankQuestionaryQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetBlankQuestionaryQuery>(
            GetBlankQuestionaryDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        'getBlankQuestionary',
    ...
    getBlankQuestionarySteps(
      variables: GetBlankQuestionaryStepsQueryVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<GetBlankQuestionaryStepsQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetBlankQuestionaryStepsQuery>(
            GetBlankQuestionaryStepsDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        'getBlankQuestionarySteps',
    ...
    getFileMetadata(
      variables: GetFileMetadataQueryVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<GetFileMetadataQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetFileMetadataQuery>(
            GetFileMetadataDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        'getFileMetadata',
    ...
    getFilesMetadata(
      variables: GetFilesMetadataQueryVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<GetFilesMetadataQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetFilesMetadataQuery>(
    ...
    getQuestionary(
      variables: GetQuestionaryQueryVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<GetQuestionaryQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetQuestionaryQuery>(
            GetQuestionaryDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        'getQuestionary',
    ...
    addTechnicalReview(
      variables: AddTechnicalReviewMutationVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<AddTechnicalReviewMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<AddTechnicalReviewMutation>(
            AddTechnicalReviewDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        'addTechnicalReview',
    ...
    addUserForReview(
      variables: AddUserForReviewMutationVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<AddUserForReviewMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<AddUserForReviewMutation>(
            AddUserForReviewDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        'addUserForReview',
    ...
    updateTechnicalReviewAssignee(
      variables: UpdateTechnicalReviewAssigneeMutationVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<UpdateTechnicalReviewAssigneeMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<UpdateTechnicalReviewAssigneeMutation>(
            UpdateTechnicalReviewAssigneeDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        'updateTechnicalReviewAssignee',
    ...
    getProposalReviews(
      variables: GetProposalReviewsQueryVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<GetProposalReviewsQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetProposalReviewsQuery>(
            GetProposalReviewsDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        'getProposalReviews',
    ...
    removeUserForReview(
      variables: RemoveUserForReviewMutationVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<RemoveUserForReviewMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<RemoveUserForReviewMutation>(
            RemoveUserForReviewDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        'removeUserForReview',
    ...
    submitProposalsReview(
      variables: SubmitProposalsReviewMutationVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<SubmitProposalsReviewMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<SubmitProposalsReviewMutation>(
            SubmitProposalsReviewDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        'submitProposalsReview',
    ...
    submitTechnicalReviews(
      variables: SubmitTechnicalReviewsMutationVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<SubmitTechnicalReviewsMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<SubmitTechnicalReviewsMutation>(
            SubmitTechnicalReviewsDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        'submitTechnicalReviews',
    ...
    userWithReviews(
      variables?: UserWithReviewsQueryVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<UserWithReviewsQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<UserWithReviewsQuery>(
            UserWithReviewsDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        'userWithReviews',
    ...
    cloneSampleEsi(
      variables: CloneSampleEsiMutationVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<CloneSampleEsiMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<CloneSampleEsiMutation>(
            CloneSampleEsiDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        'cloneSampleEsi',
    ...
    createSampleEsi(
      variables: CreateSampleEsiMutationVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<CreateSampleEsiMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<CreateSampleEsiMutation>(
            CreateSampleEsiDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        'createSampleEsi',
    ...
    deleteSampleEsi(
      variables: DeleteSampleEsiMutationVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<DeleteSampleEsiMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<DeleteSampleEsiMutation>(
            DeleteSampleEsiDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        'deleteSampleEsi',
    ...
    getSampleEsi(
      variables: GetSampleEsiQueryVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<GetSampleEsiQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetSampleEsiQuery>(GetSampleEsiDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        'getSampleEsi',
    ...
    updateSampleEsi(
      variables: UpdateSampleEsiMutationVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<UpdateSampleEsiMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<UpdateSampleEsiMutation>(
            UpdateSampleEsiDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        'updateSampleEsi',
    ...
    cloneSample(
      variables: CloneSampleMutationVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<CloneSampleMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<CloneSampleMutation>(CloneSampleDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        'cloneSample',
    ...
    createSample(
      variables: CreateSampleMutationVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<CreateSampleMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<CreateSampleMutation>(
    ...
    deleteSample(
      variables: DeleteSampleMutationVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<DeleteSampleMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<DeleteSampleMutation>(
    ...
    getSample(
      variables: GetSampleQueryVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<GetSampleQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetSampleQuery>(GetSampleDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        'getSample',
    ...
    getSamplesByCallId(
      variables: GetSamplesByCallIdQueryVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<GetSamplesByCallIdQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetSamplesByCallIdQuery>(
            GetSamplesByCallIdDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        'getSamplesByCallId',
    ...
    getSamplesWithProposalData(
      variables?: GetSamplesWithProposalDataQueryVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<GetSamplesWithProposalDataQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetSamplesWithProposalDataQuery>(
            GetSamplesWithProposalDataDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        'getSamplesWithProposalData',
    ...
    getSamplesWithQuestionaryStatus(
      variables?: GetSamplesWithQuestionaryStatusQueryVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<GetSamplesWithQuestionaryStatusQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetSamplesWithQuestionaryStatusQuery>(
    ...
    updateSample(
      ...
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<UpdateSampleMutation>(
    ...
    getScheduledEventCore(
      variables: GetScheduledEventCoreQueryVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<GetScheduledEventCoreQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetScheduledEventCoreQuery>(
            GetScheduledEventCoreDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        'getScheduledEventCore',
    ...
    getScheduledEventsCore(
      variables?: GetScheduledEventsCoreQueryVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<GetScheduledEventsCoreQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetScheduledEventsCoreQuery>(
            GetScheduledEventsCoreDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        'getScheduledEventsCore',
    ...
    addProposalWorkflowStatus(
      variables: AddProposalWorkflowStatusMutationVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<AddProposalWorkflowStatusMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<AddProposalWorkflowStatusMutation>(
            AddProposalWorkflowStatusDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        'addProposalWorkflowStatus',
    ...
    addStatusChangingEventsToConnection(
      variables: AddStatusChangingEventsToConnectionMutationVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<AddStatusChangingEventsToConnectionMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<AddStatusChangingEventsToConnectionMutation>(
            AddStatusChangingEventsToConnectionDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        'addStatusChangingEventsToConnection',
    ...
    createProposalStatus(
      variables: CreateProposalStatusMutationVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<CreateProposalStatusMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<CreateProposalStatusMutation>(
            CreateProposalStatusDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        'createProposalStatus',
    ...
    createProposalWorkflow(
      variables: CreateProposalWorkflowMutationVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<CreateProposalWorkflowMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<CreateProposalWorkflowMutation>(
            CreateProposalWorkflowDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        'createProposalWorkflow',
    ...
    deleteProposalStatus(
      variables: DeleteProposalStatusMutationVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<DeleteProposalStatusMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<DeleteProposalStatusMutation>(
            DeleteProposalStatusDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        'deleteProposalStatus',
    ...
    deleteProposalWorkflow(
      variables: DeleteProposalWorkflowMutationVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<DeleteProposalWorkflowMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<DeleteProposalWorkflowMutation>(
            DeleteProposalWorkflowDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        'deleteProposalWorkflow',
    ...
    deleteProposalWorkflowStatus(
      variables: DeleteProposalWorkflowStatusMutationVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<DeleteProposalWorkflowStatusMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<DeleteProposalWorkflowStatusMutation>(
            DeleteProposalWorkflowStatusDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        'deleteProposalWorkflowStatus',
    ...
    getProposalEvents(
      variables?: GetProposalEventsQueryVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<GetProposalEventsQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetProposalEventsQuery>(
            GetProposalEventsDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        'getProposalEvents',
    ...
    getProposalStatuses(
      variables?: GetProposalStatusesQueryVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<GetProposalStatusesQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetProposalStatusesQuery>(
            GetProposalStatusesDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        'getProposalStatuses',
    ...
    getProposalWorkflow(
      variables: GetProposalWorkflowQueryVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<GetProposalWorkflowQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetProposalWorkflowQuery>(
            GetProposalWorkflowDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        'getProposalWorkflow',
    ...
    getProposalWorkflows(
      variables?: GetProposalWorkflowsQueryVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<GetProposalWorkflowsQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetProposalWorkflowsQuery>(
            GetProposalWorkflowsDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        'getProposalWorkflows',
    ...
    moveProposalWorkflowStatus(
      variables: MoveProposalWorkflowStatusMutationVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<MoveProposalWorkflowStatusMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<MoveProposalWorkflowStatusMutation>(
            MoveProposalWorkflowStatusDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        'moveProposalWorkflowStatus',
    ...
    updateFeatures(
      variables: UpdateFeaturesMutationVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<UpdateFeaturesMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<UpdateFeaturesMutation>(
    ...
    updateProposalStatus(
      variables: UpdateProposalStatusMutationVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<UpdateProposalStatusMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<UpdateProposalStatusMutation>(
    ...
    updateProposalWorkflow(
      variables: UpdateProposalWorkflowMutationVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<UpdateProposalWorkflowMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<UpdateProposalWorkflowMutation>(
            UpdateProposalWorkflowDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        'updateProposalWorkflow',
    ...
    addSamplesToShipment(
      variables: AddSamplesToShipmentMutationVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<AddSamplesToShipmentMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<AddSamplesToShipmentMutation>(
            AddSamplesToShipmentDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        'addSamplesToShipment',
    ...
    createShipment(
      ...
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<CreateShipmentMutation>(
    ...
    deleteShipment(
      variables: DeleteShipmentMutationVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<DeleteShipmentMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<DeleteShipmentMutation>(
    ...
    getMyShipments(
      variables?: GetMyShipmentsQueryVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<GetMyShipmentsQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetMyShipmentsQuery>(
            GetMyShipmentsDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        'getMyShipments',
    ...
    getShipment(
      variables: GetShipmentQueryVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<GetShipmentQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetShipmentQuery>(GetShipmentDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        'getShipment',
    ...
    getShipments(
      ...
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<GetShipmentsQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetShipmentsQuery>(GetShipmentsDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        'getShipments',
    ...
    setActiveTemplate(
      variables: SetActiveTemplateMutationVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<SetActiveTemplateMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<SetActiveTemplateMutation>(
    ...
    submitShipment(
      variables: SubmitShipmentMutationVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<SubmitShipmentMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<SubmitShipmentMutation>(
            SubmitShipmentDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        'submitShipment',
    ...
    updateShipment(
      variables: UpdateShipmentMutationVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<UpdateShipmentMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<UpdateShipmentMutation>(
    ...
    importTemplate(
      variables: ImportTemplateMutationVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<ImportTemplateMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<ImportTemplateMutation>(
    ...
    cloneTemplate(
      variables: CloneTemplateMutationVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<CloneTemplateMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<CloneTemplateMutation>(
    ...
    createQuestion(
      ...
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<CreateQuestionMutation>(
    ...
    createQuestionTemplateRelation(
      variables: CreateQuestionTemplateRelationMutationVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<CreateQuestionTemplateRelationMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<CreateQuestionTemplateRelationMutation>(
            CreateQuestionTemplateRelationDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        'createQuestionTemplateRelation',
    ...
    createTopic(
      ...
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<CreateTopicMutation>(CreateTopicDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        'createTopic',
    ...
    deleteQuestion(
      ...
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<DeleteQuestionMutation>(
    ...
    deleteQuestionTemplateRelation(
      variables: DeleteQuestionTemplateRelationMutationVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<DeleteQuestionTemplateRelationMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<DeleteQuestionTemplateRelationMutation>(
            DeleteQuestionTemplateRelationDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        'deleteQuestionTemplateRelation',
    ...
    deleteTopic(
      ...
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<DeleteTopicMutation>(DeleteTopicDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        'deleteTopic',
    ...
    getActiveTemplateId(
      variables: GetActiveTemplateIdQueryVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<GetActiveTemplateIdQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetActiveTemplateIdQuery>(
            GetActiveTemplateIdDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        'getActiveTemplateId',
    ...
    getIsNaturalKeyPresent(
      variables: GetIsNaturalKeyPresentQueryVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<GetIsNaturalKeyPresentQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetIsNaturalKeyPresentQuery>(
            GetIsNaturalKeyPresentDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        'getIsNaturalKeyPresent',
    ...
    getPdfTemplate(
      variables: GetPdfTemplateQueryVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<GetPdfTemplateQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetPdfTemplateQuery>(
            GetPdfTemplateDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        'getPdfTemplate',
    ...
    getProposalTemplates(
      variables?: GetProposalTemplatesQueryVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<GetProposalTemplatesQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetProposalTemplatesQuery>(
            GetProposalTemplatesDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        'getProposalTemplates',
    ...
    getTemplate(
      ...
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetTemplateQuery>(GetTemplateDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        'getTemplate',
    ...
    getTemplateExport(
      variables: GetTemplateExportQueryVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<GetTemplateExportQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetTemplateExportQuery>(
            GetTemplateExportDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        'getTemplateExport',
    ...
    updatePdfTemplate(
      variables: UpdatePdfTemplateMutationVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<UpdatePdfTemplateMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<UpdatePdfTemplateMutation>(
            UpdatePdfTemplateDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        'updatePdfTemplate',
    ...
    updateQuestion(
      ...
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<UpdateQuestionMutation>(
    ...
    updateQuestionTemplateRelation(
      variables: UpdateQuestionTemplateRelationMutationVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<UpdateQuestionTemplateRelationMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<UpdateQuestionTemplateRelationMutation>(
            UpdateQuestionTemplateRelationDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        'updateQuestionTemplateRelation',
    ...
    updateQuestionTemplateRelationSettings(
      variables: UpdateQuestionTemplateRelationSettingsMutationVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<UpdateQuestionTemplateRelationSettingsMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<UpdateQuestionTemplateRelationSettingsMutation>(
            UpdateQuestionTemplateRelationSettingsDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        'updateQuestionTemplateRelationSettings',
    ...
    updateTopic(
      ...
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<UpdateTopicMutation>(UpdateTopicDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        'updateTopic',
    ...
    validateTemplateImport(
      variables: ValidateTemplateImportMutationVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<ValidateTemplateImportMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<ValidateTemplateImportMutation>(
            ValidateTemplateImportDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        'validateTemplateImport',
    ...
    createUnit(
      variables: CreateUnitMutationVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<CreateUnitMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<CreateUnitMutation>(CreateUnitDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        'createUnit',
    ...
    deleteUnit(
      variables: DeleteUnitMutationVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<DeleteUnitMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<DeleteUnitMutation>(DeleteUnitDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        'deleteUnit',
    ...
    getUnitsAsJson(
      variables?: GetUnitsAsJsonQueryVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<GetUnitsAsJsonQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetUnitsAsJsonQuery>(
            GetUnitsAsJsonDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        'getUnitsAsJson',
    ...
    importUnits(
      variables: ImportUnitsMutationVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<ImportUnitsMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<ImportUnitsMutation>(ImportUnitsDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        'importUnits',
    ...
    validateUnitsImport(
      variables: ValidateUnitsImportMutationVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<ValidateUnitsImportMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<ValidateUnitsImportMutation>(
            ValidateUnitsImportDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        'validateUnitsImport',
    ...
    checkToken(
      variables: CheckTokenQueryVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<CheckTokenQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<CheckTokenQuery>(CheckTokenDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        'checkToken',
    ...
    createUserByEmailInvite(
      variables: CreateUserByEmailInviteMutationVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<CreateUserByEmailInviteMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<CreateUserByEmailInviteMutation>(
            CreateUserByEmailInviteDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        'createUserByEmailInvite',
    ...
    externalTokenLogin(
      variables: ExternalTokenLoginMutationVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<ExternalTokenLoginMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<ExternalTokenLoginMutation>(
    ...
    getBasicUserDetails(
      variables: GetBasicUserDetailsQueryVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<GetBasicUserDetailsQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetBasicUserDetailsQuery>(
            GetBasicUserDetailsDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        'getBasicUserDetails',
    ...
    getBasicUserDetailsByEmail(
      variables: GetBasicUserDetailsByEmailQueryVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<GetBasicUserDetailsByEmailQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetBasicUserDetailsByEmailQuery>(
            GetBasicUserDetailsByEmailDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        'getBasicUserDetailsByEmail',
    ...
    getMyRoles(
      variables?: GetMyRolesQueryVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<GetMyRolesQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetMyRolesQuery>(GetMyRolesDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        'getMyRoles',
    ...
    getNationalities(
      variables?: GetNationalitiesQueryVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<GetNationalitiesQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetNationalitiesQuery>(
    ...
    getPreviousCollaborators(
      variables: GetPreviousCollaboratorsQueryVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<GetPreviousCollaboratorsQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetPreviousCollaboratorsQuery>(
            GetPreviousCollaboratorsDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        'getPreviousCollaborators',
    ...
    getToken(
      ...
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetTokenMutation>(GetTokenDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        'getToken',
    ...
    getTokenForUser(
      variables: GetTokenForUserMutationVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<GetTokenForUserMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetTokenForUserMutation>(
            GetTokenForUserDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        'getTokenForUser',
    ...
    getUserMe(
      ...
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<GetUserMeQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetUserMeQuery>(GetUserMeDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        'getUserMe',
    ...
    getUserProposals(
      variables?: GetUserProposalsQueryVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<GetUserProposalsQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetUserProposalsQuery>(
            GetUserProposalsDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        'getUserProposals',
    ...
    getUserWithRoles(
      variables: GetUserWithRolesQueryVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<GetUserWithRolesQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetUserWithRolesQuery>(
    ...
    resetPasswordEmail(
      ...
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<ResetPasswordEmailMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<ResetPasswordEmailMutation>(
    ...
    selectRole(
      variables: SelectRoleMutationVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<SelectRoleMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<SelectRoleMutation>(SelectRoleDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        'selectRole',
    ...
    setUserEmailVerified(
      variables: SetUserEmailVerifiedMutationVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<SetUserEmailVerifiedMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<SetUserEmailVerifiedMutation>(
    ...
    setUserNotPlaceholder(
      variables: SetUserNotPlaceholderMutationVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<SetUserNotPlaceholderMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<SetUserNotPlaceholderMutation>(
            SetUserNotPlaceholderDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        'setUserNotPlaceholder',
    ...
    updateUserRoles(
      ...
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<UpdateUserRolesMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<UpdateUserRolesMutation>(
    ...
    createVisit(
      variables: CreateVisitMutationVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<CreateVisitMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<CreateVisitMutation>(CreateVisitDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        'createVisit',
    ...
    deleteVisit(
      variables: DeleteVisitMutationVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<DeleteVisitMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<DeleteVisitMutation>(DeleteVisitDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        'deleteVisit',
    ...
    getVisit(
      ...
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<GetVisitQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetVisitQuery>(GetVisitDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        'getVisit',
    ...
    getVisits(
      variables?: GetVisitsQueryVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<GetVisitsQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetVisitsQuery>(GetVisitsDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        'getVisits',
    ...
    updateVisit(
      variables: UpdateVisitMutationVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<UpdateVisitMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<UpdateVisitMutation>(UpdateVisitDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        'updateVisit',
    ...
    createVisitRegistration(
      variables: CreateVisitRegistrationMutationVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<CreateVisitRegistrationMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<CreateVisitRegistrationMutation>(
            CreateVisitRegistrationDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        'createVisitRegistration',
    ...
    getVisitRegistration(
      variables: GetVisitRegistrationQueryVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<GetVisitRegistrationQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetVisitRegistrationQuery>(
            GetVisitRegistrationDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        'getVisitRegistration',
    ...
    updateVisitRegistration(
      variables: UpdateVisitRegistrationMutationVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<UpdateVisitRegistrationMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<UpdateVisitRegistrationMutation>(
            UpdateVisitRegistrationDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        'updateVisitRegistration',

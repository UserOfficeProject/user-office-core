...
export type EsdResponseWrap = {
  esd: Maybe<ExperimentSafetyDocument>;
  rejection: Maybe<Rejection>;
};
...
export type ExperimentSafetyDocument = {
...
export type GetProposalEsisFilter = {
  callId?: InputMaybe<Scalars['Int']>;
  hasEvaluation?: InputMaybe<Scalars['Boolean']>;
  isSubmitted?: InputMaybe<Scalars['Boolean']>;
  questionaryId?: InputMaybe<Scalars['Int']>;
  scheduledEventId?: InputMaybe<Scalars['Int']>;
};
...
export type MutationCreateEsdArgs = {
  comment: Scalars['String'];
  esiId: Scalars['Int'];
  evaluation: EsdEvaluation;
};
...
export type MutationUpdateEsdArgs = {
  comment: Scalars['String'];
  esdId: Scalars['Int'];
  evaluation: EsdEvaluation;
};
...
export type Query = {
  ...
  esi: Maybe<ExperimentSafetyInput>;
  esis: Maybe<Array<ExperimentSafetyInput>>;
...
export type QueryEsisArgs = {
  filter?: InputMaybe<GetProposalEsisFilter>;
};
...
export type CreateEsdMutationVariables = Exact<{
  esiId: Scalars['Int'];
  evaluation: EsdEvaluation;
  comment: Scalars['String'];
}>;
...
export type CreateEsdMutation = { createEsd: { esd: { id: number, reviewerUserId: number, evaluation: EsdEvaluation, comment: string, createdAt: any, evaluatedAt: any, reviewer: { id: number, firstname: string, lastname: string, preferredname: string | null, organisation: string, organizationId: number, position: string, created: any | null, placeholder: boolean | null, email: string | null } } | null, rejection: { reason: string, context: string | null, exception: string | null } | null } };

export type EsdFragment = { id: number, reviewerUserId: number, evaluation: EsdEvaluation, comment: string, createdAt: any, evaluatedAt: any };

export type UpdateEsdMutationVariables = Exact<{
  esdId: Scalars['Int'];
  evaluation: EsdEvaluation;
  comment: Scalars['String'];
}>;
...
export type UpdateEsdMutation = { updateEsd: { esd: { id: number, reviewerUserId: number, evaluation: EsdEvaluation, comment: string, createdAt: any, evaluatedAt: any } | null, rejection: { reason: string, context: string | null, exception: string | null } | null } };
...
export type GetEsiQuery = { esi: { id: number, creatorId: number, questionaryId: number, isSubmitted: boolean, created: any, questionary: { isCompleted: boolean, questionaryId: number, templateId: number, created: any, steps: Array<{ isCompleted: boolean, topic: { title: string, id: number, templateId: number, sortOrder: number, isEnabled: boolean }, fields: Array<{ answerId: number | null, sortOrder: number, topicId: number, dependenciesOperator: DependenciesLogicOperator | null, value: any | null, question: { id: string, question: string, naturalKey: string, dataType: DataType, categoryId: TemplateCategoryId, config: { small_label: string, required: boolean, tooltip: string } | { small_label: string, required: boolean, tooltip: string, minDate: string | null, maxDate: string | null, defaultDate: string | null, includeTime: boolean } | { html: string, plain: string, omitFromPdf: boolean } | { small_label: string, required: boolean, tooltip: string } | { file_type: Array<string>, max_files: number, pdf_page_limit: number, small_label: string, required: boolean, tooltip: string } | { titlePlaceholder: string, questionLabel: string } | { small_label: string, required: boolean, tooltip: string, units: Array<{ id: string, unit: string, quantity: string, symbol: string, siConversionFormula: string }> } | { numberValueConstraint: NumberValueConstraint | null, small_label: string, required: boolean, tooltip: string, units: Array<{ id: string, unit: string, quantity: string, symbol: string, siConversionFormula: string }> } | { tooltip: string } | { tooltip: string } | { small_label: string, required: boolean, tooltip: string, max: number | null } | { titlePlaceholder: string } | { addEntryButtonLabel: string, minEntries: number | null, maxEntries: number | null, templateId: number | null, esiTemplateId: number | null, templateCategory: string, required: boolean, small_label: string } | { tooltip: string } | { variant: string, options: Array<string>, isMultipleSelect: boolean, small_label: string, required: boolean, tooltip: string } | { small_label: string, required: boolean, tooltip: string } | { addEntryButtonLabel: string, minEntries: number | null, maxEntries: number | null, templateId: number | null, templateCategory: string, required: boolean, small_label: string } | { min: number | null, max: number | null, multiline: boolean, placeholder: string, small_label: string, required: boolean, tooltip: string, htmlQuestion: string | null, isHtmlQuestion: boolean, isCounterHidden: boolean } | { small_label: string, required: boolean, tooltip: string } }, config: { small_label: string, required: boolean, tooltip: string } | { small_label: string, required: boolean, tooltip: string, minDate: string | null, maxDate: string | null, defaultDate: string | null, includeTime: boolean } | { html: string, plain: string, omitFromPdf: boolean } | { small_label: string, required: boolean, tooltip: string } | { file_type: Array<string>, max_files: number, pdf_page_limit: number, small_label: string, required: boolean, tooltip: string } | { titlePlaceholder: string, questionLabel: string } | { small_label: string, required: boolean, tooltip: string, units: Array<{ id: string, unit: string, quantity: string, symbol: string, siConversionFormula: string }> } | { numberValueConstraint: NumberValueConstraint | null, small_label: string, required: boolean, tooltip: string, units: Array<{ id: string, unit: string, quantity: string, symbol: string, siConversionFormula: string }> } | { tooltip: string } | { tooltip: string } | { small_label: string, required: boolean, tooltip: string, max: number | null } | { titlePlaceholder: string } | { addEntryButtonLabel: string, minEntries: number | null, maxEntries: number | null, templateId: number | null, esiTemplateId: number | null, templateCategory: string, required: boolean, small_label: string } | { tooltip: string } | { variant: string, options: Array<string>, isMultipleSelect: boolean, small_label: string, required: boolean, tooltip: string } | { small_label: string, required: boolean, tooltip: string } | { addEntryButtonLabel: string, minEntries: number | null, maxEntries: number | null, templateId: number | null, templateCategory: string, required: boolean, small_label: string } | { min: number | null, max: number | null, multiline: boolean, placeholder: string, small_label: string, required: boolean, tooltip: string, htmlQuestion: string | null, isHtmlQuestion: boolean, isCounterHidden: boolean } | { small_label: string, required: boolean, tooltip: string }, dependencies: Array<{ questionId: string, dependencyId: string, dependencyNaturalKey: string, condition: { condition: EvaluatorOperator, params: any } }> }> }> }, sampleEsis: Array<{ sampleId: number, esiId: number, questionaryId: number, isSubmitted: boolean, sample: { id: number, title: string, creatorId: number, questionaryId: number, safetyStatus: SampleStatus, safetyComment: string, isPostProposalSubmission: boolean, created: any, proposalPk: number, questionId: string }, questionary: { isCompleted: boolean } }>, proposal: { primaryKey: number, title: string, abstract: string, statusId: number, publicStatus: ProposalPublicStatus, proposalId: string, finalStatus: ProposalEndStatus | null, commentForUser: string | null, commentForManagement: string | null, created: any, updated: any, callId: number, questionaryId: number, notified: boolean, submitted: boolean, managementTimeAllocation: number | null, managementDecisionSubmitted: boolean, samples: Array<{ id: number, title: string, creatorId: number, questionaryId: number, safetyStatus: SampleStatus, safetyComment: string, isPostProposalSubmission: boolean, created: any, proposalPk: number, questionId: string }> | null, questionary: { isCompleted: boolean, questionaryId: number, templateId: number, created: any, steps: Array<{ isCompleted: boolean, topic: { title: string, id: number, templateId: number, sortOrder: number, isEnabled: boolean }, fields: Array<{ answerId: number | null, sortOrder: number, topicId: number, dependenciesOperator: DependenciesLogicOperator | null, value: any | null, question: { id: string, question: string, naturalKey: string, dataType: DataType, categoryId: TemplateCategoryId, config: { small_label: string, required: boolean, tooltip: string } | { small_label: string, required: boolean, tooltip: string, minDate: string | null, maxDate: string | null, defaultDate: string | null, includeTime: boolean } | { html: string, plain: string, omitFromPdf: boolean } | { small_label: string, required: boolean, tooltip: string } | { file_type: Array<string>, max_files: number, pdf_page_limit: number, small_label: string, required: boolean, tooltip: string } | { titlePlaceholder: string, questionLabel: string } | { small_label: string, required: boolean, tooltip: string, units: Array<{ id: string, unit: string, quantity: string, symbol: string, siConversionFormula: string }> } | { numberValueConstraint: NumberValueConstraint | null, small_label: string, required: boolean, tooltip: string, units: Array<{ id: string, unit: string, quantity: string, symbol: string, siConversionFormula: string }> } | { tooltip: string } | { tooltip: string } | { small_label: string, required: boolean, tooltip: string, max: number | null } | { titlePlaceholder: string } | { addEntryButtonLabel: string, minEntries: number | null, maxEntries: number | null, templateId: number | null, esiTemplateId: number | null, templateCategory: string, required: boolean, small_label: string } | { tooltip: string } | { variant: string, options: Array<string>, isMultipleSelect: boolean, small_label: string, required: boolean, tooltip: string } | { small_label: string, required: boolean, tooltip: string } | { addEntryButtonLabel: string, minEntries: number | null, maxEntries: number | null, templateId: number | null, templateCategory: string, required: boolean, small_label: string } | { min: number | null, max: number | null, multiline: boolean, placeholder: string, small_label: string, required: boolean, tooltip: string, htmlQuestion: string | null, isHtmlQuestion: boolean, isCounterHidden: boolean } | { small_label: string, required: boolean, tooltip: string } }, config: { small_label: string, required: boolean, tooltip: string } | { small_label: string, required: boolean, tooltip: string, minDate: string | null, maxDate: string | null, defaultDate: string | null, includeTime: boolean } | { html: string, plain: string, omitFromPdf: boolean } | { small_label: string, required: boolean, tooltip: string } | { file_type: Array<string>, max_files: number, pdf_page_limit: number, small_label: string, required: boolean, tooltip: string } | { titlePlaceholder: string, questionLabel: string } | { small_label: string, required: boolean, tooltip: string, units: Array<{ id: string, unit: string, quantity: string, symbol: string, siConversionFormula: string }> } | { numberValueConstraint: NumberValueConstraint | null, small_label: string, required: boolean, tooltip: string, units: Array<{ id: string, unit: string, quantity: string, symbol: string, siConversionFormula: string }> } | { tooltip: string } | { tooltip: string } | { small_label: string, required: boolean, tooltip: string, max: number | null } | { titlePlaceholder: string } | { addEntryButtonLabel: string, minEntries: number | null, maxEntries: number | null, templateId: number | null, esiTemplateId: number | null, templateCategory: string, required: boolean, small_label: string } | { tooltip: string } | { variant: string, options: Array<string>, isMultipleSelect: boolean, small_label: string, required: boolean, tooltip: string } | { small_label: string, required: boolean, tooltip: string } | { addEntryButtonLabel: string, minEntries: number | null, maxEntries: number | null, templateId: number | null, templateCategory: string, required: boolean, small_label: string } | { min: number | null, max: number | null, multiline: boolean, placeholder: string, small_label: string, required: boolean, tooltip: string, htmlQuestion: string | null, isHtmlQuestion: boolean, isCounterHidden: boolean } | { small_label: string, required: boolean, tooltip: string }, dependencies: Array<{ questionId: string, dependencyId: string, dependencyNaturalKey: string, condition: { condition: EvaluatorOperator, params: any } }> }> }> }, status: { id: number, shortCode: string, name: string, description: string, isDefault: boolean } | null, sepMeetingDecision: { proposalPk: number, recommendation: ProposalEndStatus | null, commentForUser: string | null, commentForManagement: string | null, rankOrder: number | null, submitted: boolean, submittedBy: number | null } | null }, scheduledEvent: { id: number, proposalPk: number | null, bookingType: ScheduledEventBookingType, startsAt: any, endsAt: any, status: ProposalBookingStatusCore, localContactId: number | null } | null } | null };

export type GetEsisQueryVariables = Exact<{
  filter?: InputMaybe<GetProposalEsisFilter>;
}>;


export type GetEsisQuery = { esis: Array<{ id: number, creatorId: number, questionaryId: number, isSubmitted: boolean, created: any, creator: { id: number, firstname: string, lastname: string, preferredname: string | null, organisation: string, organizationId: number, position: string, created: any | null, placeholder: boolean | null, email: string | null }, proposal: { primaryKey: number, proposalId: string, title: string }, scheduledEvent: { id: number, proposalPk: number | null, bookingType: ScheduledEventBookingType, startsAt: any, endsAt: any, status: ProposalBookingStatusCore, localContactId: number | null } | null, esd: { id: number, reviewerUserId: number, evaluation: EsdEvaluation, comment: string, createdAt: any, evaluatedAt: any, reviewer: { id: number, firstname: string, lastname: string, preferredname: string | null, organisation: string, organizationId: number, position: string, created: any | null, placeholder: boolean | null, email: string | null } } | null }> | null };
...
export type UserWithReviewsQuery = { me: { id: number, firstname: string, lastname: string, organisation: number, reviews: Array<{ id: number, grade: number | null, comment: string | null, status: ReviewStatus, sepID: number, proposal: { primaryKey: number, title: string, proposalId: string, call: { shortCode: string }, instrument: { shortCode: string } | null } | null }> } | null };
...
export const CallFragmentDoc = gql`
  ...
  isActive
    ...
    ${BasicUserDetailsFragmentDoc}`;
export const EsdFragmentDoc = gql`
    fragment esd on ExperimentSafetyDocument {
  id
  reviewerUserId
  evaluation
  comment
...
export const UpdateCallDocument = gql`
  ...
  updateCall(
    ...
    ${RejectionFragmentDoc}
${CallFragmentDoc}`;
export const CreateEsdDocument = gql`
    mutation createEsd($esiId: Int!, $evaluation: EsdEvaluation!, $comment: String!) {
  createEsd(esiId: $esiId, evaluation: $evaluation, comment: $comment) {
    esd {
      ...esd
      reviewer {
        ...basicUserDetails
...
${BasicUserDetailsFragmentDoc}
${RejectionFragmentDoc}`;
export const UpdateEsdDocument = gql`
    mutation updateEsd($esdId: Int!, $evaluation: EsdEvaluation!, $comment: String!) {
  updateEsd(esdId: $esdId, evaluation: $evaluation, comment: $comment) {
    esd {
      ...esd
    }
    rejection {
...
${ProposalFragmentDoc}
${ScheduledEventCoreFragmentDoc}`;
export const GetEsisDocument = gql`
    query getEsis($filter: GetProposalEsisFilter) {
  esis(filter: $filter) {
    ...esi
    creator {
      ...basicUserDetails
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    ...
    createEsd(variables: CreateEsdMutationVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<CreateEsdMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<CreateEsdMutation>(CreateEsdDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'createEsd', 'mutation');
    },
    updateEsd(variables: UpdateEsdMutationVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<UpdateEsdMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<UpdateEsdMutation>(UpdateEsdDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'updateEsd', 'mutation');
    },
    ...
    getEsis(variables?: GetEsisQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<GetEsisQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetEsisQuery>(GetEsisDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'getEsis', 'query');
    },

...
export type FieldConfig = BooleanConfig | DateConfig | EmbellishmentConfig | FeedbackBasisConfig | FileUploadConfig | GenericTemplateBasisConfig | IntervalConfig | MultiPartSelectionConfig | NumberInputConfig | ProposalBasisConfig | ProposalEsiBasisConfig | RichTextInputConfig | SampleBasisConfig | SampleDeclarationConfig | SampleEsiBasisConfig | SelectionFromOptionsConfig | ShipmentBasisConfig | SubTemplateConfig | TextInputConfig | VisitBasisConfig;
...
export type MultiPartSelectionConfig = {
  partOneQuestion: Scalars['String'];
  partTwoQuestion: Scalars['String'];
  required: Scalars['Boolean'];
  selectionPairs: Array<MultiPartSelectionPair>;
  small_label: Scalars['String'];
  tooltip: Scalars['String'];
};

export type MultiPartSelectionPair = {
  key: Scalars['String'];
...
type FieldConfig_MultiPartSelectionConfig_Fragment = { small_label: string, tooltip: string, partOneQuestion: string, partTwoQuestion: string, selectionPairs: Array<{ key: string, value: Array<string> }> };

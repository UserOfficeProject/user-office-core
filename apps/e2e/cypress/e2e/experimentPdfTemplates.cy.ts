...
context('Experiment Safety PDF template tests', () => {
  ...
  describe('Experiment Safety PDF template basic tests', () => {
    it('User officer can create a Experiment Safety PDF template. The template comes with default values - Body, header, Footer and Dummy Data', () => {
      cy.login('officer');
      cy.visit('/');

      cy.navigateToTemplatesSubmenu('PDF (Experiment Safety)');
  ...
  describe('Experiment Safety PDF template advanced tests', () => {
    beforeEach(() => {
      cy.createTemplate({
        name: templateName,

...
declare global {
  namespace Cypress {
    interface Chainable {
       ...
       * @memberof Chainable
       * @example
       *    cy.createCall({shortCode: 'Test call 1', startDate: '22-02-2021', endDate: '28-02-2021', cycleComment: 'This is cycle comment'})
       */
      createCall: (
       ...
       * @memberof Chainable
       * @example
       *    cy.updateCall({shortCode: 'Test call 1', startDate: '22-02-2021', endDate: '28-02-2021', cycleComment: 'This is cycle comment'})
       */
      updateCall: (

...
$$
BEGIN
	IF register_patch('0166_AddProposalScientistCommentToProposalTableView.sql', 'Farai Mutambara', 'Add proposal scientist comment to proposal table view', '2024-10-31') THEN
	BEGIN	

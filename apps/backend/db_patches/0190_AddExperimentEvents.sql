...
$$
BEGIN
	IF register_patch('AddExperimentEvents.sql', 'Yoganandan Pandiyan', 'Add experiment events table to keep track of all fired events on a experiment.', '2025-07-28') THEN
	  BEGIN

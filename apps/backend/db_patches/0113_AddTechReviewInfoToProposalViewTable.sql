...
$$
BEGIN
	IF register_patch('AddTechReviewInfoToProposalViewTable.sql', 'Thomas Cottee Meldrum', 'Add techinqual review information to proposal_view_table', '2021-11-02') THEN
		BEGIN

...
$$
BEGIN
    IF register_patch('UpdateCallTablePdfTemplates.sql', 'Yoganandan Pandiyan', 'Rename pdf_template_id to proposal_pdf_template_id and add experiment_safety_pdf_template_id column', '2025-07-28') THEN

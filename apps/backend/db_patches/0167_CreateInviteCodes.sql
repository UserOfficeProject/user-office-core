...
BEGIN
  IF register_patch('0167_CreateInviteCode', 'Jekabs Karklins', 'Adding tables for invites', '2024-12-03') THEN
    BEGIN
      ...
      CREATE TABLE coproposer_invites (
        coproposer_invite_id SERIAL PRIMARY KEY,
      ...
      CREATE INDEX coproposer_invites_invite_code_id_idx ON coproposer_invites(invite_code_id);

...
BEGIN
    ...
    BEGIN
      ...
      BEGIN
          ...
          END IF;
          --Update TABLES row with OLD USER ID with NEW USER ID
          ...
          UPDATE FAP_ASSIGNMENTS SET FAP_MEMBER_USER_ID = P_NEW_USER_ID WHERE FAP_MEMBER_USER_ID = P_OLD_USER_ID; 
          ...
          UPDATE FAPS SET FAP_SECRETARY_USER_ID = P_NEW_USER_ID WHERE FAP_SECRETARY_USER_ID = P_OLD_USER_ID; 
          ...
          UPDATE VISITS SET VISIT_ID = P_NEW_USER_ID WHERE VISIT_ID = P_OLD_USER_ID; 
          UPDATE VISITS SET TEAM_LEAD_USER_ID = P_NEW_USER_ID WHERE TEAM_LEAD_USER_ID = P_OLD_USER_ID; 
          --Update TABLES row with OLD USER ID with NEW USER ID 
          --where the row is not overlap with NEW USER ID

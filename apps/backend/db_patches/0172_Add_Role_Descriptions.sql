...
BEGIN
  IF register_patch('0172_Add_Role_Descriptions', 'TCMeldrum', 'Add role descriptions', '2025-03-18') THEN
    BEGIN
        ...
        UPDATE roles set description = 'View your FAP panel and submit and manage your FAP reviews' where short_code = 'fap_chair';
        ...
        UPDATE roles set description = 'Edit and view your technical feasibility reviews and view proposals for your instruments' where short_code = 'instrument_scientist';

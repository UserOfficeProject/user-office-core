...
VALUES 
  (
    'date_question', 1, 8, 5, '{ "tooltip": "","required": false,"small_label": "" }'
  );
INSERT INTO answers(
  questionary_id, question_id, answer
) 
...
VALUES 
  (
    'file_upload_question', 1, 8, 8, '{"tooltip": "", "required": false,"file_type": [".pdf",".doc",".docx"],"max_files": 0,"small_label": ""}'
  );
INSERT INTO answers(
  questionary_id, question_id, answer
) 
...
VALUES 
  (
    'selection_from_options_question', 
    1, 8, 6, '{"variant":"dropdown","options":["One","Two","Three"],"isMultipleSelect":true}'
  );
INSERT INTO answers(
  questionary_id, question_id, answer
) 
...
VALUES 
  (
    'dynamic_multiple_choice_question', 
    1, 8, 6, '{"variant":"dropdown", "url":"", "jsonPath":"","isMultipleSelect":true, "apiCallRequestHeaders":[]}'
  );
INSERT INTO answers(
  questionary_id, question_id, answer
) 
...
VALUES 
  (
    'text_input_question', 1, 8, 7, '{ "tooltip": "", "required": false, "small_label": "" }'
  );
INSERT INTO answers(
  questionary_id, question_id, answer
) 
...
VALUES 
  (
    'instrument_picker_question', 
    1, 8, 6, '{"variant":"dropdown","options":[1, 2]}'
  );
INSERT INTO answers(
  questionary_id, question_id, answer
) 

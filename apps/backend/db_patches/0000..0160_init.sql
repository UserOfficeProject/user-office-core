...
INSERT INTO public.db_patches VALUES ('init.sql', 'unknown', 'init', '2019-10-01 00:00:00+00', '2025-02-11 12:07:04.663875+00');
...
SELECT pg_catalog.setval('public.countries_country_id_seq', 199, true);
...
SELECT pg_catalog.setval('public.experiment_safety_inputs_esi_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.fap_proposals_fap_proposal_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.faps_fap_id_seq', 1, true);
...
SELECT pg_catalog.setval('public.feedback_requests_feedback_request_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.generic_templates_generic_template_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.institutions_institution_id_seq', 523, true);
...
SELECT pg_catalog.setval('public.instrument_has_proposals_instrument_has_proposals_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.internal_reviews_internal_review_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.nationalities_nationality_id_seq', 190, true);
...
SELECT pg_catalog.setval('public.next_status_events_next_status_event_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.pagetext_pagetext_id_seq', 5, true);
...
SELECT pg_catalog.setval('public.pdf_templates_pdf_template_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.predefined_messages_predefined_message_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.proposal_answers_answer_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.proposal_status_actions_proposal_status_action_id_seq', 2, true);
...
SELECT pg_catalog.setval('public.proposal_statuses_proposal_status_id_seq', 16, true);
...
SELECT pg_catalog.setval('public.proposal_templates_template_id_seq', 2, true);
...
SELECT pg_catalog.setval('public.proposal_topics_topic_id_seq', 2, true);
...
SELECT pg_catalog.setval('public.proposal_workflow_connections_proposal_workflow_connection__seq', 1, true);
...
SELECT pg_catalog.setval('public.proposal_workflows_proposal_workflow_id_seq', 1, true);
...
SELECT pg_catalog.setval('public.proposals_proposal_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.proposals_short_code_seq', 1, false);
...
SELECT pg_catalog.setval('public.question_dependencies_question_dependency_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.questionaries_questionary_id_seq', 1, true);
...
SELECT pg_catalog.setval('public.role_user_role_user_id_seq', 7, true);
...
SELECT pg_catalog.setval('public.technical_review_technical_review_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.techniques_technique_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.template_categories_template_category_id_seq', 6, true);
...
SELECT pg_catalog.setval('public.visitations_visitation_id_seq', 1, false);

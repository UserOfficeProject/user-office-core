...
$$
BEGIN
  IF register_patch('AddExperimentRefNumberFormat.sql', 'Yoganandan Pandiyan', 'Adding Experiment Reference Number format to facilitate dynamic generation of Experiment Number, similar to Proposal', '2025-05-02') THEN
    BEGIN

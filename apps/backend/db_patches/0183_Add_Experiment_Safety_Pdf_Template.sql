...
$$
BEGIN
    IF register_patch('0183_Add_Experiment_Safety_Pdf_Template.sql', 'Yoganandan Pandiyan', 'Add experiment_safety_pdf_templates table with same structure as proposal_pdf_templates', '2025-04-22') THEN

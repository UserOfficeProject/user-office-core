...
import { GuardFn } from '../workflowEngine/stateMachine/stateMachine';
...
export enum Event {
  ...
  DATA_ACCESS_USER_ADDED = 'DATA_ACCESS_USER_ADDED',
...
export const EventMetadataByEvent = new Map<Event, EventMetadata>([
  ...
  [
    Event.DATA_ACCESS_USER_ADDED,
    {
      label:
        'Event occurs when an existing user is added as a data access user',
    },
  ],
  [

...
export enum DataType {
  ...
  EXP_SAFETY_REVIEW_BASIS = 'EXP_SAFETY_REVIEW_BASIS',
}
...
export enum TemplateCategoryId {
  ...
  FAP_REVIEW = 10,
  TECHNICAL_REVIEW = 11,
  EXP_SAFETY_REVIEW = 12,
  EXPERIMENT_SAFETY_PDF = 13,
}
...
export enum TemplateGroupId {
  ...
  GENERIC_TEMPLATE = 'GENERIC_TEMPLATE',
  FEEDBACK = 'FEEDBACK',
  PROPOSAL_PDF_TEMPLATE = 'PROPOSAL_PDF_TEMPLATE',
  EXPERIMENT_SAFETY_PDF_TEMPLATE = 'EXPERIMENT_SAFETY_PDF_TEMPLATE',
  FAP_REVIEW = 'FAP_REVIEW_TEMPLATE',
  TECHNICAL_REVIEW = 'TECHNICAL_REVIEW_TEMPLATE',
  EXP_SAFETY_REVIEW = 'EXP_SAFETY_REVIEW_TEMPLATE',
}

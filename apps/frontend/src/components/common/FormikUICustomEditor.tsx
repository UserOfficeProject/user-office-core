...
/* NOTE: We prefer using Editor component directly into the forms (example: QuestionaryComponentTechnicalReviewBasis component) instead of FormikUICustomEditor with Formik Field component.

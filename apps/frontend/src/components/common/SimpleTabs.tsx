  ...
  const handleChange = (
    ...
    if (isVerticalOrientation) {
      setSearchParams((searchParam) => {
        searchParams.delete('verticalTab');
        if (tabValue) searchParam.set('verticalTab', String(tabValue));
      ...
      setSearchParams((searchParam) => {
        ...
        if (tabValue) searchParam.set('modalTab', String(tabValue));
      ...
      setSearchParams((searchParam) => {
        ...
        if (tabValue) searchParam.set('tab', String(tabValue));

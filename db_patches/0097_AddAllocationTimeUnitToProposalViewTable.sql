...
$$
BEGIN
	IF register_patch('AddAllocationTimeUnitToProposalViewTable.sql', 'martintrajanovski', 'Add proposal allocation time unit to proposal_view_table', '2021-05-31') THEN
		BEGIN

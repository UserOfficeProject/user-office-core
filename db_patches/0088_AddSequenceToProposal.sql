...
$$
BEGIN
	IF register_patch('AddProposalSequence.sql', 'simonfernandes', 'stfc-user-office-project#5 - Add proposal reference numbers.', '2021-02-26') THEN
		BEGIN
			ALTER TABLE proposals ADD COLUMN reference_number_sequence integer;
			DROP VIEW IF EXISTS proposal_table_view;
			ALTER TABLE proposals ALTER COLUMN short_code TYPE character varying(16);

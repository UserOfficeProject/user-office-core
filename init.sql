...
INSERT INTO proposal_questions VALUES('proposal_title','TEXT_INPUT','Proposal title','{"topic":"general-information","required":true, "min":2, "max":500}');
INSERT INTO proposal_questions VALUES('brief_summary','TEXT_INPUT','Brief summary','{"topic":"general-information","required":true, "min":10, "max":500, "multiline":true}');
INSERT INTO proposal_questions VALUES('has_links_with_industry','SELECTION_FROM_OPTIONS','Links with industry?','{"topic":"general-information","required":true, "options":["yes", "no"], "variant":"radio"}');
INSERT INTO proposal_questions VALUES('links_with_industry','TEXT_INPUT','If yes, please describe:','{"topic":"general-information","placeholder":"Please specify links with industry"}');
INSERT INTO proposal_questions VALUES('is_student_proposal','SELECTION_FROM_OPTIONS','Are any of the co-proposers students?','{"topic":"general-information","required":true, "options":["yes", "no"], "variant":"radio"}');
INSERT INTO proposal_questions VALUES('is_towards_degree','SELECTION_FROM_OPTIONS','Does the proposal work towards a students degree?','{"topic":"general-information","required":true, "options":["yes", "no"], "variant":"radio"}');
INSERT INTO proposal_questions VALUES('final_delivery_date','DATE','Final delivery date','{"topic":"general-information","min":"now"}');
INSERT INTO proposal_questions VALUES('final_delivery_date_motivation','TEXT_INPUT','Please motivate the chosen date','{"topic":"general-information","min":10, "multiline":true, "max":500}');
...
INSERT INTO proposal_questions VALUES('crystallization_molecule_name','TEXT_INPUT','Name of molecule to be crystallized','{"topic":"crystallization","min":2, "max":40}');
INSERT INTO proposal_questions VALUES('amino_seq','TEXT_INPUT','FASTA sequence or Uniprot number:','{"topic":"crystallization","min":2, "max":200}');
INSERT INTO proposal_questions VALUES('molecular_weight','TEXT_INPUT','Molecular weight(kDA):','{"topic":"crystallization","min":2, "max":200}');
INSERT INTO proposal_questions VALUES('oligomerization_state','TEXT_INPUT','Oligomerization state:','{"topic":"crystallization","min":2, "max":200}');
INSERT INTO proposal_questions VALUES('pdb_id','TEXT_INPUT','PDB ID of crystal structure','{"topic":"crystallization","min":2, "max":200}');
INSERT INTO proposal_questions VALUES('doi_or_alike','TEXT_INPUT','If the reference is publicly available, please provide the DOI or an accessible link:','{"topic":"crystallization","min":2, "max":200}');
INSERT INTO proposal_questions VALUES('reference_file','FILE_UPLOAD','If the reference is not publicly available, please upload a copy.','{"topic":"crystallization", "maxFiles":3}');
INSERT INTO proposal_questions VALUES('crystallization_cofactors_ligands','TEXT_INPUT','Does the protein have any co-factors or ligands required for crystallization? Specify:','{"topic":"crystallization","min":2, "max":200}');
INSERT INTO proposal_questions VALUES('prec_composition','TEXT_INPUT','Known crystallization precipitant composition:','{"topic":"crystallization","min":2, "max":200,"small_label":"(inc.buffer, salt, additives, pH)"}');
INSERT INTO proposal_questions VALUES('crystallization_experience','TEXT_INPUT','What crystallization method, volume, and temperature have you used in the past?','{"topic":"crystallization", "multiline":true,"min":2, "max":500,"small_label":"(e.g. vapour diffusion, 10 µL drops, room temperature)"}');
INSERT INTO proposal_questions VALUES('crystallization_time','TEXT_INPUT','How long do your crystals take to appear?','{"topic":"crystallization","min":2, "max":200}');
INSERT INTO proposal_questions VALUES('crystal_size','TEXT_INPUT','What is the typical size of your crystal?','{"topic":"crystallization","min":2, "max":200,"small_label":"( µm x µm x µm )"}');
INSERT INTO proposal_questions VALUES('protein_details_lbl','TEXT_INPUT','Details from protein preparation','{"topic":"crystallization","disabled":true}');
INSERT INTO proposal_questions VALUES('typical_yield','TEXT_INPUT','Typical yield:','{"topic":"crystallization","min":2, "max":200, "small_label":"(mg per liter of culture)"}');
INSERT INTO proposal_questions VALUES('storage_conditions','TEXT_INPUT','Storage conditions:','{"topic":"crystallization","min":2, "max":200,"small_label":"(e.g. stable at 4 °C or frozen at -20 °C)"}');
INSERT INTO proposal_questions VALUES('stability','TEXT_INPUT','Stability:','{"topic":"crystallization","min":2, "max":200}');
INSERT INTO proposal_questions VALUES('protein_buffer','TEXT_INPUT','What buffer is your protein in?','{"topic":"crystallization","min":2, "max":200}');
INSERT INTO proposal_questions VALUES('is_deuterated','TEXT_INPUT','Is your protein partially or fully deuterated?','{"topic":"crystallization","min":2, "max":200}');
INSERT INTO proposal_questions VALUES('protein_concentration','TEXT_INPUT','What protein concentration do you usually use for crystallization?','{"topic":"crystallization","min":2, "max":200}');
...
INSERT INTO proposal_questions VALUES('organism_name','TEXT_INPUT','What is the organism','{"topic":"biological-deuteration","min":2, "max":200}');
...
INSERT INTO proposal_questions VALUES('material_amount','TEXT_INPUT','How much material do you need','{"topic":"biological-deuteration","min":2, "max":200}');
INSERT INTO proposal_questions VALUES('material_condition','TEXT_INPUT','Indicate wet or dry mass','{"topic":"biological-deuteration","min":2, "max":5}');
INSERT INTO proposal_questions VALUES('amount_justification','TEXT_INPUT','Justify amount','{"topic":"biological-deuteration","min":10, "max":500, "multiline":true}');
INSERT INTO proposal_questions VALUES('rq_deuteration_level','SELECTION_FROM_OPTIONS','Level of deuteration required','{"topic":"biological-deuteration","variant":"dropdown","options":["Partial (65-80% with unlabeled carbon source)", "Full (~99% with labeled carbon source)"]}');
INSERT INTO proposal_questions VALUES('d_level_justification','TEXT_INPUT','Justify level of D incorporation','{"topic":"biological-deuteration","min":10, "max":500, "multiline":true}');
...
INSERT INTO proposal_questions VALUES('molecule_name_for_deuteration','TEXT_INPUT','Name of molecule to be deuterated:','{"topic":"biological-deuteration","small_label":"(e.g. superoxide dismutase)"}');
INSERT INTO proposal_questions VALUES('bio_deu_fasta','TEXT_INPUT','FASTA sequence or Uniprot number','{"topic":"biological-deuteration"}');
INSERT INTO proposal_questions VALUES('bio_deu_molecular_weight','TEXT_INPUT','Molecular weight (kDA)','{"topic":"biological-deuteration"}');
INSERT INTO proposal_questions VALUES('bio_deu_oligomerization_state','TEXT_INPUT','Oligomerization state','{"topic":"biological-deuteration", "small_label":"(e.g. homodimer, tetramer etc.)"}');
INSERT INTO proposal_questions VALUES('bio_deu_cofactors_ligands','TEXT_INPUT','Does the protein have any co-factors or ligands required for expression? Specify:','{"topic":"biological-deuteration", "multiline":true}');
INSERT INTO proposal_questions VALUES('bio_deu_origin','TEXT_INPUT','Origin of molecules:','{"topic":"biological-deuteration", "small_label":"(e.g. human, E. coli, S. cerevisiae)"}');
INSERT INTO proposal_questions VALUES('bio_deu_plasmid_provided','SELECTION_FROM_OPTIONS','Will you provide an expression plasmid?','{"topic":"biological-deuteration","variant":"radio", "options":["yes", "no"], "TEXT_INPUT":"If you choose no, we will design & order a plasmid commercially"}');
INSERT INTO proposal_questions VALUES('bio_deu_material_amount','TEXT_INPUT','How much material do you need?','{"topic":"biological-deuteration"}');
INSERT INTO proposal_questions VALUES('bio_deu_material_amount_justification','TEXT_INPUT','Justify amount:','{"topic":"biological-deuteration"}');
...
INSERT INTO proposal_questions VALUES('bio_deu_d_lvl_req_justification','TEXT_INPUT','Justify level of D incorporation:','{"topic":"biological-deuteration"}');
...
INSERT INTO proposal_questions VALUES('bio_deu_typical_yield','TEXT_INPUT','Typical yield:','{"topic":"biological-deuteration"}');
...
INSERT INTO proposal_questions VALUES('yeast_derived_material_amount','TEXT_INPUT','How much material do you need?','{"topic":"biological-deuteration","min":2, "max":200}');
INSERT INTO proposal_questions VALUES('yeast_derived_material_amount_justification','TEXT_INPUT','Justify amount','{"topic":"biological-deuteration","min":2, "max":200}');
INSERT INTO proposal_questions VALUES('yeast_derived_d_lvl_req','SELECTION_FROM_OPTIONS','Level of deuteration required:','{"topic":"biological-deuteration","  ":"radio","options":["Full (~99% with labeled carbon source)", "Partial (65-80% with unlabeled carbon source)", "Partial (25-30% H/D exchange)"]}');
INSERT INTO proposal_questions VALUES('yeast_derived_d_lvl_req_justification','TEXT_INPUT','Justify level of D incorporation:','{"topic":"biological-deuteration","min":2, "max":200}');
INSERT INTO proposal_questions VALUES('bio_deu_other','BOOLEAN','Other','{"topic":"biological-deuteration","variant":"slider"}');
INSERT INTO proposal_questions VALUES('bio_deu_other_desc','TEXT_INPUT','For requests that do not fit any of options above','{"topic":"biological-deuteration","min":10, "max":500, "multiline":true}');
...
INSERT INTO proposal_questions VALUES('biosafety_is_organism_active','TEXT_INPUT','If the sample is a a bacteria or virus, specificy whether it is inactive/active:','{"topic":"biological-deuteration","variant":"radio", "options":["yes", "no"]}');
INSERT INTO proposal_questions VALUES('biosafety_explanation','TEXT_INPUT','If you answered "yes" to any of the above, please explan:','{"topic":"biological-deuteration","variant":"radio", "options":["yes", "no"]}');
...
INSERT INTO proposal_questions VALUES('chem_deu_molecule_name','TEXT_INPUT','Molecule/s to be deuterated (name):','{"topic":"chemical-deuteration","variant":"radio", "options":["yes", "no"]}');
INSERT INTO proposal_questions VALUES('chem_deu_amount','TEXT_INPUT','Amount of material required (mass):','{"topic":"chemical-deuteration","variant":"radio", "options":["yes", "no"]}');
INSERT INTO proposal_questions VALUES('chem_deu_amount_justification','TEXT_INPUT','Justify amount','{"topic":"chemical-deuteration","variant":"radio", "options":["yes", "no"], "multiline":true}');
INSERT INTO proposal_questions VALUES('chem_deu_d_percentage','TEXT_INPUT','indicate percentage and location of deuteration','{"topic":"chemical-deuteration","variant":"radio", "options":["yes", "no"]}');
INSERT INTO proposal_questions VALUES('chem_deu_structure_justification','TEXT_INPUT','Justify level of deuteration','{"topic":"chemical-deuteration","variant":"radio", "options":["yes", "no"], "multiline":true}');

...
INSERT INTO proposal_questions VALUES('is_towards_degree','SELECTION_FROM_OPTIONS','Does the proposal work towards a students degree?',1,'{"topic":"general-information","required":true, "options":["yes", "no"], "variant":"radio"}');
INSERT INTO proposal_questions VALUES('final_delivery_date','DATE','Final delivery date',1,'{"topic":"general-information","min":"now"}');
INSERT INTO proposal_questions VALUES('final_delivery_date_motivation','TEXT_INPUT','Please motivate the chosen date',1,'{"topic":"general-information","min":10, "multiline":true, "max":500}');
INSERT INTO proposal_questions VALUES('has_crystallization','BOOLEAN','Check box to select crystallization',2,'{"topic":"crystallization","variant":"checkbox"}');
INSERT INTO proposal_questions VALUES('crystallization_molecule_name','TEXT_INPUT','Name of molecule to be crystallized',2,'{"topic":"crystallization","min":2, "max":40}');
INSERT INTO proposal_questions VALUES('amino_seq','TEXT_INPUT','FASTA sequence or Uniprot number:',2,'{"topic":"crystallization","min":2, "max":200}');
INSERT INTO proposal_questions VALUES('molecular_weight','TEXT_INPUT','Molecular weight(kDA):',2,'{"topic":"crystallization","min":2, "max":200}');
...
INSERT INTO proposal_questions VALUES('crystallization_time','TEXT_INPUT','How long do your crystals take to appear?',2,'{"topic":"crystallization","min":2, "max":200}');
INSERT INTO proposal_questions VALUES('crystal_size','TEXT_INPUT','What is the typical size of your crystal?',2,'{"topic":"crystallization","min":2, "max":200,"small_label":"( µm x µm x µm )"}');
INSERT INTO proposal_questions VALUES('protein_details_lbl','TEXT_INPUT','Details from protein preparation',2,'{"topic":"crystallization","disabled":true}');
INSERT INTO proposal_questions VALUES('typical_yield','TEXT_INPUT','Typical yield:',2,'{"topic":"crystallization","min":2, "max":200, "small_label":"(mg per liter of culture)"}');
INSERT INTO proposal_questions VALUES('storage_conditions','TEXT_INPUT','Storage conditions:',2,'{"topic":"crystallization","min":2, "max":200,"small_label":"(e.g. stable at 4 °C or frozen at -20 °C)"}');
INSERT INTO proposal_questions VALUES('stability','TEXT_INPUT','Stability:',2,'{"topic":"crystallization","min":2, "max":200}');
INSERT INTO proposal_questions VALUES('protein_buffer','TEXT_INPUT','What buffer is your protein in?',2,'{"topic":"crystallization","min":2, "max":200}');
INSERT INTO proposal_questions VALUES('is_deuterated','TEXT_INPUT','Is your protein partially or fully deuterated?',2,'{"topic":"crystallization","min":2, "max":200}');
INSERT INTO proposal_questions VALUES('protein_concentration','TEXT_INPUT','What protein concentration do you usually use for crystallization?',2,'{"topic":"crystallization","min":2, "max":200}');
INSERT INTO proposal_questions VALUES('slide_select_deuteration','BOOLEAN','slide to select deuteration type',3,'{"topic":"biological-deuteration","variant":"slider"}');
...
INSERT INTO proposal_questions VALUES('rq_deuteration_level','SELECTION_FROM_OPTIONS','Level of deuteration required',3,'{"topic":"biological-deuteration","variant":"dropdown","options":["Partial (65-80% with unlabeled carbon source)", "Full (~99% with labeled carbon source)"]}');
INSERT INTO proposal_questions VALUES('d_level_justification','TEXT_INPUT','Justify level of D incorporation',3,'{"topic":"biological-deuteration","min":10, "max":500, "multiline":true}');
INSERT INTO proposal_questions VALUES('recombinant_protein','BOOLEAN','Recombinant protein (E. coli)',3,'{"topic":"biological-deuteration","variant":"slider"}');
INSERT INTO proposal_questions VALUES('molecule_name_for_deuteration','TEXT_INPUT','Name of molecule to be deuterated:',3,'{"topic":"biological-deuteration","small_label":"(e.g. superoxide dismutase)"}');
INSERT INTO proposal_questions VALUES('bio_deu_fasta','TEXT_INPUT','FASTA sequence or Uniprot number',3,'{"topic":"biological-deuteration"}');
INSERT INTO proposal_questions VALUES('bio_deu_molecular_weight','TEXT_INPUT','Molecular weight (kDA)',3,'{"topic":"biological-deuteration"}');
INSERT INTO proposal_questions VALUES('bio_deu_oligomerization_state','TEXT_INPUT','Oligomerization state',3,'{"topic":"biological-deuteration", "small_label":"(e.g. homodimer, tetramer etc.)"}');
INSERT INTO proposal_questions VALUES('bio_deu_cofactors_ligands','TEXT_INPUT','Does the protein have any co-factors or ligands required for expression? Specify:',3,'{"topic":"biological-deuteration", "multiline":true}');
INSERT INTO proposal_questions VALUES('bio_deu_origin','TEXT_INPUT','Origin of molecules:',3,'{"topic":"biological-deuteration", "small_label":"(e.g. human, E. coli, S. cerevisiae)"}');
INSERT INTO proposal_questions VALUES('bio_deu_plasmid_provided','SELECTION_FROM_OPTIONS','Will you provide an expression plasmid?',3,'{"topic":"biological-deuteration","variant":"radio", "options":["yes", "no"], "TEXT_INPUT":"If you choose no, we will design & order a plasmid commercially"}');
INSERT INTO proposal_questions VALUES('bio_deu_material_amount','TEXT_INPUT','How much material do you need?',3,'{"topic":"biological-deuteration"}');
INSERT INTO proposal_questions VALUES('bio_deu_material_amount_justification','TEXT_INPUT','Justify amount:',3,'{"topic":"biological-deuteration"}');
INSERT INTO proposal_questions VALUES('bio_deu_d_lvl_req','SELECTION_FROM_OPTIONS','Level of deuteration required:',3,'{"topic":"biological-deuteration","variant":"radio","options":["Full (~99% with labeled carbon source)", "Partial (65-80% with unlabeled carbon source)", "Partial (25-30% H/D exchange)"]}');
INSERT INTO proposal_questions VALUES('bio_deu_d_lvl_req_justification','TEXT_INPUT','Justify level of D incorporation:',3,'{"topic":"biological-deuteration"}');
INSERT INTO proposal_questions VALUES('bio_deu_purification_need','SELECTION_FROM_OPTIONS','Will you need DEMAX to purify the protein from deuterated biomass?',3,'{"topic":"biological-deuteration","variant":"radio", "options":["yes", "no"]}');
INSERT INTO proposal_questions VALUES('bio_deu_has_expressed','SELECTION_FROM_OPTIONS','Has expression been done for the unlabeled protein?',3,'{"topic":"biological-deuteration","variant":"radio", "options":["yes", "no"]}');
INSERT INTO proposal_questions VALUES('bio_deu_typical_yield','TEXT_INPUT','Typical yield:',3,'{"topic":"biological-deuteration"}');
INSERT INTO proposal_questions VALUES('bio_deu_purification_done','SELECTION_FROM_OPTIONS','Have you been able to purify the unlabeled protein?',3,'{"topic":"biological-deuteration","variant":"radio", "options":["yes", "no"]}');
INSERT INTO proposal_questions VALUES('bio_deu_has_deuteration_experience','SELECTION_FROM_OPTIONS','Have you tried to deuterate the protein yourself, even in small scale?',3,'{"topic":"biological-deuteration","variant":"radio", "options":["yes", "no"]}');
INSERT INTO proposal_questions VALUES('yeast_derived_lipid_amnt','BOOLEAN','Yeast-derived total lipid extract (P. pastoris)',3,'{"topic":"biological-deuteration"}');
INSERT INTO proposal_questions VALUES('yeast_derived_material_amount','TEXT_INPUT','How much material do you need?',3,'{"topic":"biological-deuteration","min":2, "max":200}');
INSERT INTO proposal_questions VALUES('yeast_derived_material_amount_justification','TEXT_INPUT','Justify amount',3,'{"topic":"biological-deuteration","min":2, "max":200}');
INSERT INTO proposal_questions VALUES('yeast_derived_d_lvl_req','SELECTION_FROM_OPTIONS','Level of deuteration required:',3,'{"topic":"biological-deuteration","  ":"radio","options":["Full (~99% with labeled carbon source)", "Partial (65-80% with unlabeled carbon source)", "Partial (25-30% H/D exchange)"]}');
INSERT INTO proposal_questions VALUES('yeast_derived_d_lvl_req_justification','TEXT_INPUT','Justify level of D incorporation:',3,'{"topic":"biological-deuteration","min":2, "max":200}');
INSERT INTO proposal_questions VALUES('bio_deu_other','BOOLEAN','Other',3,'{"topic":"biological-deuteration","variant":"slider"}');
INSERT INTO proposal_questions VALUES('bio_deu_other_desc','TEXT_INPUT','For requests that do not fit any of options above',3,'{"topic":"biological-deuteration","min":10, "max":500, "multiline":true}');
INSERT INTO proposal_questions VALUES('biosafety_containment_level','SELECTION_FROM_OPTIONS','Which biosafety containment level is required to work with your sample?',3,'{"topic":"biological-deuteration","variant":"radio", "options":["L1", "L2"]}');
INSERT INTO proposal_questions VALUES('biosafety_has_risks','SELECTION_FROM_OPTIONS','Is your organism a live virus,3, toxin-producing, or pose ay risk to human health and/or the environment?',3,'{"topic":"biological-deuteration","variant":"radio", "options":["yes", "no"]}');
INSERT INTO proposal_questions VALUES('biosafety_is_recombinant','SELECTION_FROM_OPTIONS','Is the protein recombinant?',3,'{"topic":"biological-deuteration","variant":"radio", "options":["yes", "no"]}');
INSERT INTO proposal_questions VALUES('biosafety_is_toxin','SELECTION_FROM_OPTIONS','Is the sample a toxin?',3,'{"topic":"biological-deuteration","variant":"radio", "options":["yes", "no"]}');
INSERT INTO proposal_questions VALUES('biosafety_is_virulence','SELECTION_FROM_OPTIONS','Is the sample a virulence factor?',3,'{"topic":"biological-deuteration","variant":"radio", "options":["yes", "no"]}');
INSERT INTO proposal_questions VALUES('biosafety_is_prion','SELECTION_FROM_OPTIONS','Is the sample a prion protein?',3,'{"topic":"biological-deuteration","variant":"radio", "options":["yes", "no"]}');
INSERT INTO proposal_questions VALUES('biosafety_has_hazard_ligand','SELECTION_FROM_OPTIONS','Does the sample have a hazardous ligand (e.g. heavy metal, toxic molecule etc.)?', 3,'{"topic":"biological-deuteration","variant":"radio", "options":["yes", "no"]}');
INSERT INTO proposal_questions VALUES('biosafety_is_organism_active','TEXT_INPUT','If the sample is a a bacteria or virus, specificy whether it is inactive/active:',3,'{"topic":"biological-deuteration","variant":"radio", "options":["yes", "no"]}');
INSERT INTO proposal_questions VALUES('biosafety_explanation','TEXT_INPUT','If you answered "yes" to any of the above, please explan:',3,'{"topic":"biological-deuteration","variant":"radio", "options":["yes", "no"]}');
INSERT INTO proposal_questions VALUES('chem_deu_enabled','BOOLEAN','Check box to select chemical deuteration',4,'{"topic":"chemical-deuteration"}');
INSERT INTO proposal_questions VALUES('chem_deu_molecule_name','TEXT_INPUT','Molecule/s to be deuterated (name):',4,'{"topic":"chemical-deuteration","variant":"radio", "options":["yes", "no"]}');
INSERT INTO proposal_questions VALUES('chem_deu_amount','TEXT_INPUT','Amount of material required (mass):',4,'{"topic":"chemical-deuteration","variant":"radio", "options":["yes", "no"]}');
INSERT INTO proposal_questions VALUES('chem_deu_amount_justification','TEXT_INPUT','Justify amount',4,'{"topic":"chemical-deuteration","variant":"radio", "options":["yes", "no"], "multiline":true}');
INSERT INTO proposal_questions VALUES('chem_deu_d_percentage','TEXT_INPUT','indicate percentage and location of deuteration',4,'{"topic":"chemical-deuteration","variant":"radio", "options":["yes", "no"]}');

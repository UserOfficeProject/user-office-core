...
export function ProposalComponentCheckBox(props: IBasicComponentProps) {
  ...
  <FormControl error={isError}>
    ...
    <FormControlLabel control={<Checkbox id={proposal_question_id} name={proposal_question_id} onChange={(evt: ChangeEvent<HTMLInputElement>) => {
      templateField.value = evt.target.checked;
      handleChange(evt); // letting Formik know that there was a change
      onComplete();
    }} value={templateField.value} inputProps={{

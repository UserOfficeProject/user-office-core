...
export type AssignProposalsToSepMutation = { assignProposalsToSep: { rejection: { reason: string, context: string | null | undefined, exception: string | null | undefined } | null | undefined, nextProposalStatus: { id: number | null | undefined, shortCode: string | null | undefined, name: string | null | undefined } | null | undefined } };
...
export type AssignReviewersToSepMutation = { assignReviewersToSEP: { rejection: { reason: string, context: string | null | undefined, exception: string | null | undefined } | null | undefined, sep: { id: number } | null | undefined } };
...
export type AssignChairOrSecretaryMutation = { assignChairOrSecretary: { rejection: { reason: string, context: string | null | undefined, exception: string | null | undefined } | null | undefined, sep: { id: number } | null | undefined } };
...
export type AssignSepReviewersToProposalMutation = { assignSepReviewersToProposal: { rejection: { reason: string, context: string | null | undefined, exception: string | null | undefined } | null | undefined, sep: { id: number } | null | undefined } };
...
export type CreateSepMutation = { createSEP: { sep: { id: number, code: string, description: string, numberRatingsRequired: number, active: boolean, sepChair: { id: number, firstname: string, lastname: string, preferredname: string | null | undefined, organisation: string, position: string, created: any | null | undefined, placeholder: boolean | null | undefined } | null | undefined, sepSecretary: { id: number, firstname: string, lastname: string, preferredname: string | null | undefined, organisation: string, position: string, created: any | null | undefined, placeholder: boolean | null | undefined } | null | undefined } | null | undefined, rejection: { reason: string, context: string | null | undefined, exception: string | null | undefined } | null | undefined } };
...
export type DeleteSepMutation = { deleteSEP: { rejection: { reason: string, context: string | null | undefined, exception: string | null | undefined } | null | undefined, sep: { id: number } | null | undefined } };

export type SepMeetingDecisionFragment = { proposalPk: number, recommendation: ProposalEndStatus | null | undefined, commentForUser: string | null | undefined, commentForManagement: string | null | undefined, rankOrder: number | null | undefined, submitted: boolean, submittedBy: number | null | undefined };
...
export type GetInstrumentsBySepQuery = { instrumentsBySep: Array<{ id: number, name: string, shortCode: string, description: string, availabilityTime: number | null | undefined, submitted: boolean | null | undefined, scientists: Array<{ id: number, firstname: string, lastname: string, preferredname: string | null | undefined, organisation: string, position: string, created: any | null | undefined, placeholder: boolean | null | undefined }> }> | null | undefined };
...
export type GetSepMembersQuery = { sepMembers: Array<{ userId: number, sepId: number, role: { id: number, shortCode: string, title: string } | null | undefined, user: { id: number, firstname: string, lastname: string, preferredname: string | null | undefined, organisation: string, position: string, created: any | null | undefined, placeholder: boolean | null | undefined } }> | null | undefined };
...
export type GetSepProposalQuery = { sepProposal: { proposalPk: number, sepId: number, sepTimeAllocation: number | null | undefined, instrumentSubmitted: boolean, proposal: { primaryKey: number, title: string, abstract: string, statusId: number, publicStatus: ProposalPublicStatus, proposalId: string, finalStatus: ProposalEndStatus | null | undefined, commentForUser: string | null | undefined, commentForManagement: string | null | undefined, created: any, updated: any, callId: number, questionaryId: number, notified: boolean, submitted: boolean, managementTimeAllocation: number | null | undefined, managementDecisionSubmitted: boolean, technicalReviewAssignee: number | null | undefined, proposer: { id: number, firstname: string, lastname: string, preferredname: string | null | undefined, organisation: string, position: string, created: any | null | undefined, placeholder: boolean | null | undefined } | null | undefined, users: Array<{ id: number, firstname: string, lastname: string, preferredname: string | null | undefined, organisation: string, position: string, created: any | null | undefined, placeholder: boolean | null | undefined }>, questionary: { questionaryId: number, templateId: number, created: any, steps: Array<{ isCompleted: boolean, topic: { title: string, id: number, templateId: number, sortOrder: number, isEnabled: boolean }, fields: Array<{ answerId: number | null | undefined, sortOrder: number, topicId: number, dependenciesOperator: DependenciesLogicOperator | null | undefined, value: any | null | undefined, question: { id: string, question: string, naturalKey: string, dataType: DataType, categoryId: TemplateCategoryId, config: { small_label: string, required: boolean, tooltip: string } | { small_label: string, required: boolean, tooltip: string, minDate: string | null | undefined, maxDate: string | null | undefined, defaultDate: string | null | undefined, includeTime: boolean } | { html: string, plain: string, omitFromPdf: boolean } | { small_label: string, required: boolean, tooltip: string } | { file_type: Array<string>, max_files: number, small_label: string, required: boolean, tooltip: string } | { titlePlaceholder: string, questionLabel: string } | { units: Array<string> | null | undefined, small_label: string, required: boolean, tooltip: string } | { units: Array<string> | null | undefined, numberValueConstraint: NumberValueConstraint | null | undefined, small_label: string, required: boolean, tooltip: string } | { tooltip: string } | { tooltip: string } | { small_label: string, required: boolean, tooltip: string, max: number | null | undefined } | { titlePlaceholder: string } | { addEntryButtonLabel: string, minEntries: number | null | undefined, maxEntries: number | null | undefined, templateId: number | null | undefined, esiTemplateId: number | null | undefined, templateCategory: string, required: boolean, small_label: string } | { tooltip: string } | { variant: string, options: Array<string>, isMultipleSelect: boolean, small_label: string, required: boolean, tooltip: string } | { small_label: string, required: boolean, tooltip: string } | { addEntryButtonLabel: string, minEntries: number | null | undefined, maxEntries: number | null | undefined, templateId: number | null | undefined, templateCategory: string, required: boolean, small_label: string } | { min: number | null | undefined, max: number | null | undefined, multiline: boolean, placeholder: string, small_label: string, required: boolean, tooltip: string, htmlQuestion: string | null | undefined, isHtmlQuestion: boolean, isCounterHidden: boolean } | { small_label: string, required: boolean, tooltip: string } }, config: { small_label: string, required: boolean, tooltip: string } | { small_label: string, required: boolean, tooltip: string, minDate: string | null | undefined, maxDate: string | null | undefined, defaultDate: string | null | undefined, includeTime: boolean } | { html: string, plain: string, omitFromPdf: boolean } | { small_label: string, required: boolean, tooltip: string } | { file_type: Array<string>, max_files: number, small_label: string, required: boolean, tooltip: string } | { titlePlaceholder: string, questionLabel: string } | { units: Array<string> | null | undefined, small_label: string, required: boolean, tooltip: string } | { units: Array<string> | null | undefined, numberValueConstraint: NumberValueConstraint | null | undefined, small_label: string, required: boolean, tooltip: string } | { tooltip: string } | { tooltip: string } | { small_label: string, required: boolean, tooltip: string, max: number | null | undefined } | { titlePlaceholder: string } | { addEntryButtonLabel: string, minEntries: number | null | undefined, maxEntries: number | null | undefined, templateId: number | null | undefined, esiTemplateId: number | null | undefined, templateCategory: string, required: boolean, small_label: string } | { tooltip: string } | { variant: string, options: Array<string>, isMultipleSelect: boolean, small_label: string, required: boolean, tooltip: string } | { small_label: string, required: boolean, tooltip: string } | { addEntryButtonLabel: string, minEntries: number | null | undefined, maxEntries: number | null | undefined, templateId: number | null | undefined, templateCategory: string, required: boolean, small_label: string } | { min: number | null | undefined, max: number | null | undefined, multiline: boolean, placeholder: string, small_label: string, required: boolean, tooltip: string, htmlQuestion: string | null | undefined, isHtmlQuestion: boolean, isCounterHidden: boolean } | { small_label: string, required: boolean, tooltip: string }, dependencies: Array<{ questionId: string, dependencyId: string, dependencyNaturalKey: string, condition: { condition: EvaluatorOperator, params: any } }> }> }> }, technicalReview: { id: number, comment: string | null | undefined, publicComment: string | null | undefined, timeAllocation: number | null | undefined, status: TechnicalReviewStatus | null | undefined, proposalPk: number, submitted: boolean, reviewer: { id: number, firstname: string, lastname: string, preferredname: string | null | undefined, organisation: string, position: string, created: any | null | undefined, placeholder: boolean | null | undefined } | null | undefined } | null | undefined, reviews: Array<{ id: number, grade: number | null | undefined, comment: string | null | undefined, status: ReviewStatus, userID: number, sepID: number, reviewer: { firstname: string, lastname: string, id: number } | null | undefined }> | null | undefined, instrument: { id: number, name: string, shortCode: string } | null | undefined, call: { id: number, shortCode: string, allocationTimeUnit: AllocationTimeUnits } | null | undefined, status: { id: number, shortCode: string, name: string, description: string, isDefault: boolean } | null | undefined, sepMeetingDecision: { proposalPk: number, recommendation: ProposalEndStatus | null | undefined, commentForUser: string | null | undefined, commentForManagement: string | null | undefined, rankOrder: number | null | undefined, submitted: boolean, submittedBy: number | null | undefined } | null | undefined } } | null | undefined };
...
export type GetSepProposalsQuery = { sepProposals: Array<{ proposalPk: number, dateAssigned: any, sepId: number, sepTimeAllocation: number | null | undefined, proposal: { title: string, primaryKey: number, proposalId: string, status: { id: number, shortCode: string, name: string, description: string, isDefault: boolean } | null | undefined }, assignments: Array<{ sepMemberUserId: number | null | undefined, dateAssigned: any, user: { id: number, firstname: string, lastname: string, preferredname: string | null | undefined, organisation: string, position: string, created: any | null | undefined, placeholder: boolean | null | undefined } | null | undefined, role: { id: number, shortCode: string, title: string } | null | undefined, review: { id: number, status: ReviewStatus, comment: string | null | undefined, grade: number | null | undefined, sepID: number } | null | undefined }> | null | undefined }> | null | undefined };
...
export type SepProposalsByInstrumentQuery = { sepProposalsByInstrument: Array<{ sepTimeAllocation: number | null | undefined, proposal: { primaryKey: number, title: string, proposalId: string, status: { id: number, shortCode: string, name: string, description: string, isDefault: boolean } | null | undefined, sepMeetingDecision: { proposalPk: number, recommendation: ProposalEndStatus | null | undefined, commentForUser: string | null | undefined, commentForManagement: string | null | undefined, rankOrder: number | null | undefined, submitted: boolean, submittedBy: number | null | undefined } | null | undefined, reviews: Array<{ id: number, comment: string | null | undefined, grade: number | null | undefined, status: ReviewStatus }> | null | undefined, technicalReview: { publicComment: string | null | undefined, status: TechnicalReviewStatus | null | undefined, timeAllocation: number | null | undefined } | null | undefined }, assignments: Array<{ sepMemberUserId: number | null | undefined }> | null | undefined }> | null | undefined };
...
export type RemoveProposalsFromSepMutation = { removeProposalsFromSep: { rejection: { reason: string, context: string | null | undefined, exception: string | null | undefined } | null | undefined, sep: { id: number } | null | undefined } };
...
export type RemoveMemberFromSepMutation = { removeMemberFromSep: { rejection: { reason: string, context: string | null | undefined, exception: string | null | undefined } | null | undefined, sep: { id: number } | null | undefined } };
...
export type RemoveMemberFromSepProposalMutation = { removeMemberFromSEPProposal: { rejection: { reason: string, context: string | null | undefined, exception: string | null | undefined } | null | undefined, sep: { id: number } | null | undefined } };
...
export type ReorderSepMeetingDecisionProposalsMutation = { reorderSepMeetingDecisionProposals: { rejection: { reason: string, context: string | null | undefined, exception: string | null | undefined } | null | undefined, sepMeetingDecision: { proposalPk: number } | null | undefined } };
...
export type SaveSepMeetingDecisionMutation = { saveSepMeetingDecision: { rejection: { reason: string, context: string | null | undefined, exception: string | null | undefined } | null | undefined, sepMeetingDecision: { proposalPk: number } | null | undefined } };
...
export type UpdateSepMutation = { updateSEP: { sep: { id: number } | null | undefined, rejection: { reason: string, context: string | null | undefined, exception: string | null | undefined } | null | undefined } };
...
export type UpdateSepTimeAllocationMutation = { updateSEPTimeAllocation: { rejection: { reason: string, context: string | null | undefined, exception: string | null | undefined } | null | undefined } };
...
export type AddClientLogMutation = { addClientLog: { isSuccess: boolean | null | undefined, rejection: { reason: string, context: string | null | undefined, exception: string | null | undefined } | null | undefined } };
...
export type CreateApiAccessTokenMutation = { createApiAccessToken: { rejection: { reason: string, context: string | null | undefined, exception: string | null | undefined } | null | undefined, apiAccessToken: { id: string, name: string, accessToken: string, accessPermissions: string } | null | undefined } };
...
export type CreateInstitutionMutation = { createInstitution: { institution: { id: number, name: string, verified: boolean } | null | undefined, rejection: { reason: string, context: string | null | undefined, exception: string | null | undefined } | null | undefined } };
...
export type CreateUnitMutation = { createUnit: { unit: { id: number, name: string } | null | undefined, rejection: { reason: string, context: string | null | undefined, exception: string | null | undefined } | null | undefined } };
...
export type DeleteApiAccessTokenMutation = { deleteApiAccessToken: { isSuccess: boolean | null | undefined, rejection: { reason: string, context: string | null | undefined, exception: string | null | undefined } | null | undefined } };
...
export type DeleteInstitutionMutation = { deleteInstitution: { institution: { id: number, verified: boolean } | null | undefined, rejection: { reason: string, context: string | null | undefined, exception: string | null | undefined } | null | undefined } };
...
export type DeleteUnitMutation = { deleteUnit: { unit: { id: number } | null | undefined, rejection: { reason: string, context: string | null | undefined, exception: string | null | undefined } | null | undefined } };

export type GetAllApiAccessTokensAndPermissionsQueryVariables = Exact<{ [key: string]: never; }>;


export type GetAllApiAccessTokensAndPermissionsQuery = { allAccessTokensAndPermissions: Array<{ id: string, name: string, accessToken: string, accessPermissions: string }> | null | undefined };

export type GetAllQueriesAndMutationsQueryVariables = Exact<{ [key: string]: never; }>;


export type GetAllQueriesAndMutationsQuery = { queriesAndMutations: { queries: Array<string>, mutations: Array<string> } | null | undefined };
...
export type GetInstitutionsQuery = { institutions: Array<{ id: number, name: string, verified: boolean }> | null | undefined };
...
export type GetPageContentQuery = { getPageContent: string | null | undefined };

export type GetSettingsQueryVariables = Exact<{ [key: string]: never; }>;


export type GetSettingsQuery = { settings: Array<{ id: SettingsId, settingsValue: string | null | undefined, description: string | null | undefined }> };

export type GetUnitsQueryVariables = Exact<{ [key: string]: never; }>;


export type GetUnitsQuery = { units: Array<{ id: number, name: string }> | null | undefined };
...
export type MergeInstitutionsMutation = { mergeInstitutions: { institution: { id: number, verified: boolean, name: string } | null | undefined, rejection: { reason: string, context: string | null | undefined, exception: string | null | undefined } | null | undefined } };
...
export type PrepareDbMutation = { prepareDB: { log: string | null | undefined, rejection: { reason: string, context: string | null | undefined, exception: string | null | undefined } | null | undefined } };

export type RejectionFragment = { reason: string, context: string | null | undefined, exception: string | null | undefined };
...
export type SetPageContentMutation = { setPageContent: { page: { id: number, content: string | null | undefined } | null | undefined, rejection: { reason: string, context: string | null | undefined, exception: string | null | undefined } | null | undefined } };
...
export type UpdateApiAccessTokenMutation = { updateApiAccessToken: { rejection: { reason: string, context: string | null | undefined, exception: string | null | undefined } | null | undefined, apiAccessToken: { id: string, name: string, accessToken: string, accessPermissions: string } | null | undefined } };
...
export type UpdateInstitutionMutation = { updateInstitution: { institution: { id: number, verified: boolean, name: string } | null | undefined, rejection: { reason: string, context: string | null | undefined, exception: string | null | undefined } | null | undefined } };
...
export type AssignInstrumentsToCallMutation = { assignInstrumentsToCall: { rejection: { reason: string, context: string | null | undefined, exception: string | null | undefined } | null | undefined, call: { id: number } | null | undefined } };
...
export type CreateCallMutation = { createCall: { rejection: { reason: string, context: string | null | undefined, exception: string | null | undefined } | null | undefined, call: { id: number, shortCode: string, startCall: any, endCall: any, startReview: any, endReview: any, startSEPReview: any | null | undefined, endSEPReview: any | null | undefined, startNotify: any, endNotify: any, startCycle: any, endCycle: any, cycleComment: string, surveyComment: string, referenceNumberFormat: string | null | undefined, proposalWorkflowId: number | null | undefined, templateId: number, esiTemplateId: number | null | undefined, allocationTimeUnit: AllocationTimeUnits, proposalCount: number, title: string | null | undefined, description: string | null | undefined, submissionMessage: string | null | undefined, instruments: Array<{ id: number, name: string, shortCode: string, description: string, availabilityTime: number | null | undefined, submitted: boolean | null | undefined, scientists: Array<{ id: number, firstname: string, lastname: string, preferredname: string | null | undefined, organisation: string, position: string, created: any | null | undefined, placeholder: boolean | null | undefined }> }>, proposalWorkflow: { id: number, name: string, description: string } | null | undefined, template: { templateId: number, name: string, isArchived: boolean } } | null | undefined } };
...
export type DeleteCallMutation = { deleteCall: { rejection: { reason: string, context: string | null | undefined, exception: string | null | undefined } | null | undefined, call: { id: number } | null | undefined } };

export type CallFragment = { id: number, shortCode: string, startCall: any, endCall: any, startReview: any, endReview: any, startSEPReview: any | null | undefined, endSEPReview: any | null | undefined, startNotify: any, endNotify: any, startCycle: any, endCycle: any, cycleComment: string, surveyComment: string, referenceNumberFormat: string | null | undefined, proposalWorkflowId: number | null | undefined, templateId: number, esiTemplateId: number | null | undefined, allocationTimeUnit: AllocationTimeUnits, proposalCount: number, title: string | null | undefined, description: string | null | undefined, submissionMessage: string | null | undefined, instruments: Array<{ id: number, name: string, shortCode: string, description: string, availabilityTime: number | null | undefined, submitted: boolean | null | undefined, scientists: Array<{ id: number, firstname: string, lastname: string, preferredname: string | null | undefined, organisation: string, position: string, created: any | null | undefined, placeholder: boolean | null | undefined }> }>, proposalWorkflow: { id: number, name: string, description: string } | null | undefined, template: { templateId: number, name: string, isArchived: boolean } };
...
export type RemoveAssignedInstrumentFromCallMutation = { removeAssignedInstrumentFromCall: { rejection: { reason: string, context: string | null | undefined, exception: string | null | undefined } | null | undefined, call: { id: number } | null | undefined } };
...
export type GetEventLogsQuery = { eventLogs: Array<{ id: number, eventType: string, eventTStamp: any, rowData: string, changedObjectId: string, changedBy: { id: number, firstname: string, lastname: string, email: string } }> | null | undefined };
...
export type DeleteGenericTemplateMutation = { deleteGenericTemplate: { genericTemplate: { id: number, title: string, creatorId: number, questionaryId: number, created: any, proposalPk: number, questionId: string } | null | undefined, rejection: { reason: string, context: string | null | undefined, exception: string | null | undefined } | null | undefined } };
...
export type GetGenericTemplatesWithProposalDataQuery = { genericTemplates: Array<{ id: number, title: string, creatorId: number, questionaryId: number, created: any, proposalPk: number, questionId: string, proposal: { primaryKey: number, proposalId: string } }> | null | undefined };
...
export type GetGenericTemplatesWithQuestionaryStatusQuery = { genericTemplates: Array<{ id: number, title: string, creatorId: number, questionaryId: number, created: any, proposalPk: number, questionId: string, questionary: { isCompleted: boolean } }> | null | undefined };
...
export type UpdateGenericTemplateMutation = { updateGenericTemplate: { genericTemplate: { id: number, title: string, creatorId: number, questionaryId: number, created: any, proposalPk: number, questionId: string } | null | undefined, rejection: { reason: string, context: string | null | undefined, exception: string | null | undefined } | null | undefined } };
...
export type AssignProposalsToInstrumentMutation = { assignProposalsToInstrument: { isSuccess: boolean | null | undefined, rejection: { reason: string, context: string | null | undefined, exception: string | null | undefined } | null | undefined } };
...
export type AssignScientistsToInstrumentMutation = { assignScientistsToInstrument: { isSuccess: boolean | null | undefined, rejection: { reason: string, context: string | null | undefined, exception: string | null | undefined } | null | undefined } };
...
export type DeleteInstrumentMutation = { deleteInstrument: { rejection: { reason: string, context: string | null | undefined, exception: string | null | undefined } | null | undefined } };
...
export type RemoveProposalsFromInstrumentMutation = { removeProposalsFromInstrument: { isSuccess: boolean | null | undefined, rejection: { reason: string, context: string | null | undefined, exception: string | null | undefined } | null | undefined } };
...
export type RemoveScientistFromInstrumentMutation = { removeScientistFromInstrument: { isSuccess: boolean | null | undefined, rejection: { reason: string, context: string | null | undefined, exception: string | null | undefined } | null | undefined } };
...
export type SetInstrumentAvailabilityTimeMutation = { setInstrumentAvailabilityTime: { isSuccess: boolean | null | undefined, rejection: { reason: string, context: string | null | undefined, exception: string | null | undefined } | null | undefined } };
...
export type SubmitInstrumentMutation = { submitInstrument: { isSuccess: boolean | null | undefined, rejection: { reason: string, context: string | null | undefined, exception: string | null | undefined } | null | undefined } };
...
export type AdministrationProposalMutation = { administrationProposal: { proposal: { primaryKey: number } | null | undefined, rejection: { reason: string, context: string | null | undefined, exception: string | null | undefined } | null | undefined } };
...
export type ChangeProposalsStatusMutation = { changeProposalsStatus: { isSuccess: boolean | null | undefined, rejection: { reason: string, context: string | null | undefined, exception: string | null | undefined } | null | undefined } };
...
export type CloneProposalsMutation = { cloneProposals: { proposals: Array<{ primaryKey: number, title: string, abstract: string, statusId: number, publicStatus: ProposalPublicStatus, proposalId: string, finalStatus: ProposalEndStatus | null | undefined, commentForUser: string | null | undefined, commentForManagement: string | null | undefined, created: any, updated: any, callId: number, questionaryId: number, notified: boolean, submitted: boolean, managementTimeAllocation: number | null | undefined, managementDecisionSubmitted: boolean, technicalReviewAssignee: number | null | undefined, proposer: { id: number, firstname: string, lastname: string, preferredname: string | null | undefined, organisation: string, position: string, created: any | null | undefined, placeholder: boolean | null | undefined } | null | undefined, users: Array<{ id: number, firstname: string, lastname: string, preferredname: string | null | undefined, organisation: string, position: string, created: any | null | undefined, placeholder: boolean | null | undefined }>, questionary: { isCompleted: boolean, questionaryId: number, templateId: number, created: any, steps: Array<{ isCompleted: boolean, topic: { title: string, id: number, templateId: number, sortOrder: number, isEnabled: boolean }, fields: Array<{ answerId: number | null | undefined, sortOrder: number, topicId: number, dependenciesOperator: DependenciesLogicOperator | null | undefined, value: any | null | undefined, question: { id: string, question: string, naturalKey: string, dataType: DataType, categoryId: TemplateCategoryId, config: { small_label: string, required: boolean, tooltip: string } | { small_label: string, required: boolean, tooltip: string, minDate: string | null | undefined, maxDate: string | null | undefined, defaultDate: string | null | undefined, includeTime: boolean } | { html: string, plain: string, omitFromPdf: boolean } | { small_label: string, required: boolean, tooltip: string } | { file_type: Array<string>, max_files: number, small_label: string, required: boolean, tooltip: string } | { titlePlaceholder: string, questionLabel: string } | { units: Array<string> | null | undefined, small_label: string, required: boolean, tooltip: string } | { units: Array<string> | null | undefined, numberValueConstraint: NumberValueConstraint | null | undefined, small_label: string, required: boolean, tooltip: string } | { tooltip: string } | { tooltip: string } | { small_label: string, required: boolean, tooltip: string, max: number | null | undefined } | { titlePlaceholder: string } | { addEntryButtonLabel: string, minEntries: number | null | undefined, maxEntries: number | null | undefined, templateId: number | null | undefined, esiTemplateId: number | null | undefined, templateCategory: string, required: boolean, small_label: string } | { tooltip: string } | { variant: string, options: Array<string>, isMultipleSelect: boolean, small_label: string, required: boolean, tooltip: string } | { small_label: string, required: boolean, tooltip: string } | { addEntryButtonLabel: string, minEntries: number | null | undefined, maxEntries: number | null | undefined, templateId: number | null | undefined, templateCategory: string, required: boolean, small_label: string } | { min: number | null | undefined, max: number | null | undefined, multiline: boolean, placeholder: string, small_label: string, required: boolean, tooltip: string, htmlQuestion: string | null | undefined, isHtmlQuestion: boolean, isCounterHidden: boolean } | { small_label: string, required: boolean, tooltip: string } }, config: { small_label: string, required: boolean, tooltip: string } | { small_label: string, required: boolean, tooltip: string, minDate: string | null | undefined, maxDate: string | null | undefined, defaultDate: string | null | undefined, includeTime: boolean } | { html: string, plain: string, omitFromPdf: boolean } | { small_label: string, required: boolean, tooltip: string } | { file_type: Array<string>, max_files: number, small_label: string, required: boolean, tooltip: string } | { titlePlaceholder: string, questionLabel: string } | { units: Array<string> | null | undefined, small_label: string, required: boolean, tooltip: string } | { units: Array<string> | null | undefined, numberValueConstraint: NumberValueConstraint | null | undefined, small_label: string, required: boolean, tooltip: string } | { tooltip: string } | { tooltip: string } | { small_label: string, required: boolean, tooltip: string, max: number | null | undefined } | { titlePlaceholder: string } | { addEntryButtonLabel: string, minEntries: number | null | undefined, maxEntries: number | null | undefined, templateId: number | null | undefined, esiTemplateId: number | null | undefined, templateCategory: string, required: boolean, small_label: string } | { tooltip: string } | { variant: string, options: Array<string>, isMultipleSelect: boolean, small_label: string, required: boolean, tooltip: string } | { small_label: string, required: boolean, tooltip: string } | { addEntryButtonLabel: string, minEntries: number | null | undefined, maxEntries: number | null | undefined, templateId: number | null | undefined, templateCategory: string, required: boolean, small_label: string } | { min: number | null | undefined, max: number | null | undefined, multiline: boolean, placeholder: string, small_label: string, required: boolean, tooltip: string, htmlQuestion: string | null | undefined, isHtmlQuestion: boolean, isCounterHidden: boolean } | { small_label: string, required: boolean, tooltip: string }, dependencies: Array<{ questionId: string, dependencyId: string, dependencyNaturalKey: string, condition: { condition: EvaluatorOperator, params: any } }> }> }> }, technicalReview: { id: number, comment: string | null | undefined, publicComment: string | null | undefined, timeAllocation: number | null | undefined, status: TechnicalReviewStatus | null | undefined, proposalPk: number, submitted: boolean } | null | undefined, reviews: Array<{ id: number, grade: number | null | undefined, comment: string | null | undefined, status: ReviewStatus, userID: number, sepID: number, reviewer: { firstname: string, lastname: string, id: number } | null | undefined }> | null | undefined, instrument: { id: number, name: string, shortCode: string } | null | undefined, call: { id: number, shortCode: string, isActive: boolean, referenceNumberFormat: string | null | undefined } | null | undefined, status: { id: number, shortCode: string, name: string, description: string, isDefault: boolean } | null | undefined, sepMeetingDecision: { proposalPk: number, recommendation: ProposalEndStatus | null | undefined, commentForUser: string | null | undefined, commentForManagement: string | null | undefined, rankOrder: number | null | undefined, submitted: boolean, submittedBy: number | null | undefined } | null | undefined }>, rejection: { reason: string, context: string | null | undefined, exception: string | null | undefined } | null | undefined } };
...
export type CreateProposalMutation = { createProposal: { proposal: { primaryKey: number, proposalId: string, questionaryId: number, status: { id: number, shortCode: string, name: string, description: string, isDefault: boolean } | null | undefined, questionary: { isCompleted: boolean, questionaryId: number, templateId: number, created: any, steps: Array<{ isCompleted: boolean, topic: { title: string, id: number, templateId: number, sortOrder: number, isEnabled: boolean }, fields: Array<{ answerId: number | null | undefined, sortOrder: number, topicId: number, dependenciesOperator: DependenciesLogicOperator | null | undefined, value: any | null | undefined, question: { id: string, question: string, naturalKey: string, dataType: DataType, categoryId: TemplateCategoryId, config: { small_label: string, required: boolean, tooltip: string } | { small_label: string, required: boolean, tooltip: string, minDate: string | null | undefined, maxDate: string | null | undefined, defaultDate: string | null | undefined, includeTime: boolean } | { html: string, plain: string, omitFromPdf: boolean } | { small_label: string, required: boolean, tooltip: string } | { file_type: Array<string>, max_files: number, small_label: string, required: boolean, tooltip: string } | { titlePlaceholder: string, questionLabel: string } | { units: Array<string> | null | undefined, small_label: string, required: boolean, tooltip: string } | { units: Array<string> | null | undefined, numberValueConstraint: NumberValueConstraint | null | undefined, small_label: string, required: boolean, tooltip: string } | { tooltip: string } | { tooltip: string } | { small_label: string, required: boolean, tooltip: string, max: number | null | undefined } | { titlePlaceholder: string } | { addEntryButtonLabel: string, minEntries: number | null | undefined, maxEntries: number | null | undefined, templateId: number | null | undefined, esiTemplateId: number | null | undefined, templateCategory: string, required: boolean, small_label: string } | { tooltip: string } | { variant: string, options: Array<string>, isMultipleSelect: boolean, small_label: string, required: boolean, tooltip: string } | { small_label: string, required: boolean, tooltip: string } | { addEntryButtonLabel: string, minEntries: number | null | undefined, maxEntries: number | null | undefined, templateId: number | null | undefined, templateCategory: string, required: boolean, small_label: string } | { min: number | null | undefined, max: number | null | undefined, multiline: boolean, placeholder: string, small_label: string, required: boolean, tooltip: string, htmlQuestion: string | null | undefined, isHtmlQuestion: boolean, isCounterHidden: boolean } | { small_label: string, required: boolean, tooltip: string } }, config: { small_label: string, required: boolean, tooltip: string } | { small_label: string, required: boolean, tooltip: string, minDate: string | null | undefined, maxDate: string | null | undefined, defaultDate: string | null | undefined, includeTime: boolean } | { html: string, plain: string, omitFromPdf: boolean } | { small_label: string, required: boolean, tooltip: string } | { file_type: Array<string>, max_files: number, small_label: string, required: boolean, tooltip: string } | { titlePlaceholder: string, questionLabel: string } | { units: Array<string> | null | undefined, small_label: string, required: boolean, tooltip: string } | { units: Array<string> | null | undefined, numberValueConstraint: NumberValueConstraint | null | undefined, small_label: string, required: boolean, tooltip: string } | { tooltip: string } | { tooltip: string } | { small_label: string, required: boolean, tooltip: string, max: number | null | undefined } | { titlePlaceholder: string } | { addEntryButtonLabel: string, minEntries: number | null | undefined, maxEntries: number | null | undefined, templateId: number | null | undefined, esiTemplateId: number | null | undefined, templateCategory: string, required: boolean, small_label: string } | { tooltip: string } | { variant: string, options: Array<string>, isMultipleSelect: boolean, small_label: string, required: boolean, tooltip: string } | { small_label: string, required: boolean, tooltip: string } | { addEntryButtonLabel: string, minEntries: number | null | undefined, maxEntries: number | null | undefined, templateId: number | null | undefined, templateCategory: string, required: boolean, small_label: string } | { min: number | null | undefined, max: number | null | undefined, multiline: boolean, placeholder: string, small_label: string, required: boolean, tooltip: string, htmlQuestion: string | null | undefined, isHtmlQuestion: boolean, isCounterHidden: boolean } | { small_label: string, required: boolean, tooltip: string }, dependencies: Array<{ questionId: string, dependencyId: string, dependencyNaturalKey: string, condition: { condition: EvaluatorOperator, params: any } }> }> }> }, proposer: { id: number, firstname: string, lastname: string, preferredname: string | null | undefined, organisation: string, position: string, created: any | null | undefined, placeholder: boolean | null | undefined } | null | undefined, users: Array<{ id: number, firstname: string, lastname: string, preferredname: string | null | undefined, organisation: string, position: string, created: any | null | undefined, placeholder: boolean | null | undefined }>, samples: Array<{ id: number, title: string, creatorId: number, questionaryId: number, safetyStatus: SampleStatus, safetyComment: string, isPostProposalSubmission: boolean, created: any, proposalPk: number, questionId: string, questionary: { isCompleted: boolean } }> | null | undefined, genericTemplates: Array<{ id: number, title: string, creatorId: number, questionaryId: number, created: any, proposalPk: number, questionId: string, questionary: { isCompleted: boolean } }> | null | undefined } | null | undefined, rejection: { reason: string, context: string | null | undefined, exception: string | null | undefined } | null | undefined } };
...
export type DeleteProposalMutation = { deleteProposal: { rejection: { reason: string, context: string | null | undefined, exception: string | null | undefined } | null | undefined, proposal: { primaryKey: number } | null | undefined } };

export type CoreTechnicalReviewFragment = { id: number, comment: string | null | undefined, publicComment: string | null | undefined, timeAllocation: number | null | undefined, status: TechnicalReviewStatus | null | undefined, proposalPk: number, submitted: boolean };

export type ProposalFragment = { primaryKey: number, title: string, abstract: string, statusId: number, publicStatus: ProposalPublicStatus, proposalId: string, finalStatus: ProposalEndStatus | null | undefined, commentForUser: string | null | undefined, commentForManagement: string | null | undefined, created: any, updated: any, callId: number, questionaryId: number, notified: boolean, submitted: boolean, managementTimeAllocation: number | null | undefined, managementDecisionSubmitted: boolean, technicalReviewAssignee: number | null | undefined, status: { id: number, shortCode: string, name: string, description: string, isDefault: boolean } | null | undefined, sepMeetingDecision: { proposalPk: number, recommendation: ProposalEndStatus | null | undefined, commentForUser: string | null | undefined, commentForManagement: string | null | undefined, rankOrder: number | null | undefined, submitted: boolean, submittedBy: number | null | undefined } | null | undefined };
...
export type GetInstrumentScientistProposalsQuery = { instrumentScientistProposals: { totalCount: number, proposals: Array<{ primaryKey: number, proposalId: string, title: string, submitted: boolean, finalStatus: ProposalEndStatus | null | undefined, technicalReviewAssignee: number | null | undefined, technicalStatus: TechnicalReviewStatus | null | undefined, statusName: string, technicalReviewSubmitted: number | null | undefined, instrumentId: number | null | undefined, instrumentName: string | null | undefined, allocationTimeUnit: AllocationTimeUnits, callShortCode: string | null | undefined, sepCode: string | null | undefined }> } | null | undefined };
...
export type GetProposalQuery = { proposal: { primaryKey: number, title: string, abstract: string, statusId: number, publicStatus: ProposalPublicStatus, proposalId: string, finalStatus: ProposalEndStatus | null | undefined, commentForUser: string | null | undefined, commentForManagement: string | null | undefined, created: any, updated: any, callId: number, questionaryId: number, notified: boolean, submitted: boolean, managementTimeAllocation: number | null | undefined, managementDecisionSubmitted: boolean, technicalReviewAssignee: number | null | undefined, proposer: { id: number, firstname: string, lastname: string, preferredname: string | null | undefined, organisation: string, position: string, created: any | null | undefined, placeholder: boolean | null | undefined } | null | undefined, users: Array<{ id: number, firstname: string, lastname: string, preferredname: string | null | undefined, organisation: string, position: string, created: any | null | undefined, placeholder: boolean | null | undefined }>, questionary: { isCompleted: boolean, questionaryId: number, templateId: number, created: any, steps: Array<{ isCompleted: boolean, topic: { title: string, id: number, templateId: number, sortOrder: number, isEnabled: boolean }, fields: Array<{ answerId: number | null | undefined, sortOrder: number, topicId: number, dependenciesOperator: DependenciesLogicOperator | null | undefined, value: any | null | undefined, question: { id: string, question: string, naturalKey: string, dataType: DataType, categoryId: TemplateCategoryId, config: { small_label: string, required: boolean, tooltip: string } | { small_label: string, required: boolean, tooltip: string, minDate: string | null | undefined, maxDate: string | null | undefined, defaultDate: string | null | undefined, includeTime: boolean } | { html: string, plain: string, omitFromPdf: boolean } | { small_label: string, required: boolean, tooltip: string } | { file_type: Array<string>, max_files: number, small_label: string, required: boolean, tooltip: string } | { titlePlaceholder: string, questionLabel: string } | { units: Array<string> | null | undefined, small_label: string, required: boolean, tooltip: string } | { units: Array<string> | null | undefined, numberValueConstraint: NumberValueConstraint | null | undefined, small_label: string, required: boolean, tooltip: string } | { tooltip: string } | { tooltip: string } | { small_label: string, required: boolean, tooltip: string, max: number | null | undefined } | { titlePlaceholder: string } | { addEntryButtonLabel: string, minEntries: number | null | undefined, maxEntries: number | null | undefined, templateId: number | null | undefined, esiTemplateId: number | null | undefined, templateCategory: string, required: boolean, small_label: string } | { tooltip: string } | { variant: string, options: Array<string>, isMultipleSelect: boolean, small_label: string, required: boolean, tooltip: string } | { small_label: string, required: boolean, tooltip: string } | { addEntryButtonLabel: string, minEntries: number | null | undefined, maxEntries: number | null | undefined, templateId: number | null | undefined, templateCategory: string, required: boolean, small_label: string } | { min: number | null | undefined, max: number | null | undefined, multiline: boolean, placeholder: string, small_label: string, required: boolean, tooltip: string, htmlQuestion: string | null | undefined, isHtmlQuestion: boolean, isCounterHidden: boolean } | { small_label: string, required: boolean, tooltip: string } }, config: { small_label: string, required: boolean, tooltip: string } | { small_label: string, required: boolean, tooltip: string, minDate: string | null | undefined, maxDate: string | null | undefined, defaultDate: string | null | undefined, includeTime: boolean } | { html: string, plain: string, omitFromPdf: boolean } | { small_label: string, required: boolean, tooltip: string } | { file_type: Array<string>, max_files: number, small_label: string, required: boolean, tooltip: string } | { titlePlaceholder: string, questionLabel: string } | { units: Array<string> | null | undefined, small_label: string, required: boolean, tooltip: string } | { units: Array<string> | null | undefined, numberValueConstraint: NumberValueConstraint | null | undefined, small_label: string, required: boolean, tooltip: string } | { tooltip: string } | { tooltip: string } | { small_label: string, required: boolean, tooltip: string, max: number | null | undefined } | { titlePlaceholder: string } | { addEntryButtonLabel: string, minEntries: number | null | undefined, maxEntries: number | null | undefined, templateId: number | null | undefined, esiTemplateId: number | null | undefined, templateCategory: string, required: boolean, small_label: string } | { tooltip: string } | { variant: string, options: Array<string>, isMultipleSelect: boolean, small_label: string, required: boolean, tooltip: string } | { small_label: string, required: boolean, tooltip: string } | { addEntryButtonLabel: string, minEntries: number | null | undefined, maxEntries: number | null | undefined, templateId: number | null | undefined, templateCategory: string, required: boolean, small_label: string } | { min: number | null | undefined, max: number | null | undefined, multiline: boolean, placeholder: string, small_label: string, required: boolean, tooltip: string, htmlQuestion: string | null | undefined, isHtmlQuestion: boolean, isCounterHidden: boolean } | { small_label: string, required: boolean, tooltip: string }, dependencies: Array<{ questionId: string, dependencyId: string, dependencyNaturalKey: string, condition: { condition: EvaluatorOperator, params: any } }> }> }> }, technicalReview: { id: number, comment: string | null | undefined, publicComment: string | null | undefined, timeAllocation: number | null | undefined, status: TechnicalReviewStatus | null | undefined, proposalPk: number, submitted: boolean, reviewer: { id: number, firstname: string, lastname: string, preferredname: string | null | undefined, organisation: string, position: string, created: any | null | undefined, placeholder: boolean | null | undefined } | null | undefined } | null | undefined, reviews: Array<{ id: number, grade: number | null | undefined, comment: string | null | undefined, status: ReviewStatus, userID: number, sepID: number, reviewer: { firstname: string, lastname: string, id: number } | null | undefined }> | null | undefined, instrument: { id: number, name: string, shortCode: string } | null | undefined, call: { id: number, shortCode: string, isActive: boolean, allocationTimeUnit: AllocationTimeUnits, referenceNumberFormat: string | null | undefined } | null | undefined, sep: { id: number, code: string } | null | undefined, samples: Array<{ id: number, title: string, creatorId: number, questionaryId: number, safetyStatus: SampleStatus, safetyComment: string, isPostProposalSubmission: boolean, created: any, proposalPk: number, questionId: string, questionary: { isCompleted: boolean } }> | null | undefined, genericTemplates: Array<{ id: number, title: string, creatorId: number, questionaryId: number, created: any, proposalPk: number, questionId: string, questionary: { isCompleted: boolean } }> | null | undefined, status: { id: number, shortCode: string, name: string, description: string, isDefault: boolean } | null | undefined, sepMeetingDecision: { proposalPk: number, recommendation: ProposalEndStatus | null | undefined, commentForUser: string | null | undefined, commentForManagement: string | null | undefined, rankOrder: number | null | undefined, submitted: boolean, submittedBy: number | null | undefined } | null | undefined } | null | undefined };
...
export type GetProposalsQuery = { proposals: { totalCount: number, proposals: Array<{ primaryKey: number, title: string, abstract: string, statusId: number, publicStatus: ProposalPublicStatus, proposalId: string, finalStatus: ProposalEndStatus | null | undefined, commentForUser: string | null | undefined, commentForManagement: string | null | undefined, created: any, updated: any, callId: number, questionaryId: number, notified: boolean, submitted: boolean, managementTimeAllocation: number | null | undefined, managementDecisionSubmitted: boolean, technicalReviewAssignee: number | null | undefined, proposer: { id: number, firstname: string, lastname: string, preferredname: string | null | undefined, organisation: string, position: string, created: any | null | undefined, placeholder: boolean | null | undefined } | null | undefined, reviews: Array<{ id: number, grade: number | null | undefined, comment: string | null | undefined, status: ReviewStatus, userID: number, sepID: number, reviewer: { firstname: string, lastname: string, id: number } | null | undefined }> | null | undefined, users: Array<{ id: number, firstname: string, lastname: string, preferredname: string | null | undefined, organisation: string, position: string, created: any | null | undefined, placeholder: boolean | null | undefined }>, technicalReview: { id: number, comment: string | null | undefined, publicComment: string | null | undefined, timeAllocation: number | null | undefined, status: TechnicalReviewStatus | null | undefined, proposalPk: number, submitted: boolean, reviewer: { id: number, firstname: string, lastname: string, preferredname: string | null | undefined, organisation: string, position: string, created: any | null | undefined, placeholder: boolean | null | undefined } | null | undefined } | null | undefined, instrument: { id: number, name: string } | null | undefined, call: { id: number, shortCode: string } | null | undefined, sep: { id: number, code: string } | null | undefined, status: { id: number, shortCode: string, name: string, description: string, isDefault: boolean } | null | undefined, sepMeetingDecision: { proposalPk: number, recommendation: ProposalEndStatus | null | undefined, commentForUser: string | null | undefined, commentForManagement: string | null | undefined, rankOrder: number | null | undefined, submitted: boolean, submittedBy: number | null | undefined } | null | undefined }> } | null | undefined };
...
export type GetProposalsCoreQuery = { proposalsView: Array<{ primaryKey: number, title: string, statusId: number, statusName: string, statusDescription: string, proposalId: string, rankOrder: number | null | undefined, finalStatus: ProposalEndStatus | null | undefined, notified: boolean, managementTimeAllocation: number | null | undefined, technicalTimeAllocation: number | null | undefined, technicalStatus: TechnicalReviewStatus | null | undefined, instrumentName: string | null | undefined, callShortCode: string | null | undefined, sepCode: string | null | undefined, sepId: number | null | undefined, reviewAverage: number | null | undefined, reviewDeviation: number | null | undefined, instrumentId: number | null | undefined, callId: number, submitted: boolean, allocationTimeUnit: AllocationTimeUnits }> | null | undefined };
...
export type NotifyProposalMutation = { notifyProposal: { proposal: { primaryKey: number } | null | undefined, rejection: { reason: string, context: string | null | undefined, exception: string | null | undefined } | null | undefined } };
...
export type UpdateProposalMutation = { updateProposal: { proposal: { primaryKey: number, title: string, abstract: string, proposer: { id: number, firstname: string, lastname: string, preferredname: string | null | undefined, organisation: string, position: string, created: any | null | undefined, placeholder: boolean | null | undefined } | null | undefined, users: Array<{ id: number, firstname: string, lastname: string, preferredname: string | null | undefined, organisation: string, position: string, created: any | null | undefined, placeholder: boolean | null | undefined }> } | null | undefined, rejection: { reason: string, context: string | null | undefined, exception: string | null | undefined } | null | undefined } };
...
export type GetUserProposalBookingsWithEventsQuery = { me: { proposals: Array<{ primaryKey: number, title: string, proposalId: string, finalStatus: ProposalEndStatus | null | undefined, managementDecisionSubmitted: boolean, proposer: { id: number, firstname: string, lastname: string, preferredname: string | null | undefined, organisation: string, position: string, created: any | null | undefined, placeholder: boolean | null | undefined } | null | undefined, users: Array<{ id: number, firstname: string, lastname: string, preferredname: string | null | undefined, organisation: string, position: string, created: any | null | undefined, placeholder: boolean | null | undefined }>, proposalBookingCore: { scheduledEvents: Array<{ id: number, startsAt: string, endsAt: string, bookingType: ScheduledEventBookingType, status: ProposalBookingStatusCore, visit: { id: number, proposalPk: number, status: VisitStatus, creatorId: number, teamLead: { id: number, firstname: string, lastname: string, preferredname: string | null | undefined, organisation: string, position: string, created: any | null | undefined, placeholder: boolean | null | undefined }, shipments: Array<{ id: number, title: string, proposalPk: number, status: ShipmentStatus, externalRef: string | null | undefined, questionaryId: number, visitId: number, creatorId: number, created: any, proposal: { proposalId: string } }>, registrations: Array<{ userId: number, visitId: number, registrationQuestionaryId: number | null | undefined, isRegistrationSubmitted: boolean, trainingExpiryDate: any | null | undefined, user: { id: number, firstname: string, lastname: string, preferredname: string | null | undefined, organisation: string, position: string, created: any | null | undefined, placeholder: boolean | null | undefined } }> } | null | undefined, esi: { id: number, creatorId: number, questionaryId: number, isSubmitted: boolean, created: any } | null | undefined, feedback: { id: number, scheduledEventId: number, status: FeedbackStatus, questionaryId: number, creatorId: number } | null | undefined, localContact: { id: number, firstname: string, lastname: string, preferredname: string | null | undefined, organisation: string, position: string, created: any | null | undefined, placeholder: boolean | null | undefined } | null | undefined }> } | null | undefined, visits: Array<{ id: number, proposalPk: number, status: VisitStatus, creatorId: number }> | null | undefined, instrument: { id: number, name: string } | null | undefined }> } | null | undefined };
...
export type GetFileMetadataQuery = { fileMetadata: Array<{ fileId: string, originalFileName: string, mimeType: string, sizeInBytes: number, createdDate: any }> | null | undefined };
...
export type AddTechnicalReviewMutation = { addTechnicalReview: { rejection: { reason: string, context: string | null | undefined, exception: string | null | undefined } | null | undefined, technicalReview: { id: number } | null | undefined } };
...
export type AddUserForReviewMutation = { addUserForReview: { rejection: { reason: string, context: string | null | undefined, exception: string | null | undefined } | null | undefined, review: { id: number } | null | undefined } };
...
export type CoreReviewFragment = { id: number, userID: number, status: ReviewStatus, comment: string | null | undefined, grade: number | null | undefined, sepID: number };
...
export type GetProposalReviewsQuery = { proposalReviews: Array<{ id: number, userID: number, comment: string | null | undefined, grade: number | null | undefined, status: ReviewStatus, sepID: number }> | null | undefined };
...
export type GetReviewQuery = { review: { id: number, userID: number, status: ReviewStatus, comment: string | null | undefined, grade: number | null | undefined, sepID: number, proposal: { primaryKey: number, title: string, abstract: string, proposer: { id: number } | null | undefined } | null | undefined, reviewer: { id: number, firstname: string, lastname: string, preferredname: string | null | undefined, organisation: string, position: string, created: any | null | undefined, placeholder: boolean | null | undefined } | null | undefined } | null | undefined };
...
export type RemoveUserForReviewMutation = { removeUserForReview: { rejection: { reason: string, context: string | null | undefined, exception: string | null | undefined } | null | undefined } };
...
export type SubmitProposalsReviewMutation = { submitProposalsReview: { isSuccess: boolean | null | undefined, rejection: { reason: string, context: string | null | undefined, exception: string | null | undefined } | null | undefined } };
...
export type SubmitTechnicalReviewMutation = { submitTechnicalReview: { rejection: { reason: string, context: string | null | undefined, exception: string | null | undefined } | null | undefined, technicalReview: { id: number } | null | undefined } };
...
export type AddReviewMutation = { addReview: { rejection: { reason: string, context: string | null | undefined, exception: string | null | undefined } | null | undefined, review: { id: number, userID: number, status: ReviewStatus, comment: string | null | undefined, grade: number | null | undefined, sepID: number, nextProposalStatus: { id: number | null | undefined, shortCode: string | null | undefined, name: string | null | undefined } | null | undefined } | null | undefined } };
...
export type UserWithReviewsQuery = { me: { id: number, firstname: string, lastname: string, organisation: number, reviews: Array<{ id: number, grade: number | null | undefined, comment: string | null | undefined, status: ReviewStatus, sepID: number, proposal: { primaryKey: number, title: string, proposalId: string, call: { shortCode: string } | null | undefined, instrument: { shortCode: string } | null | undefined } | null | undefined }> } | null | undefined };
...
export type DeleteSampleEsiMutation = { deleteSampleEsi: { esi: { sampleId: number, esiId: number, questionaryId: number, isSubmitted: boolean } | null | undefined, rejection: { reason: string, context: string | null | undefined, exception: string | null | undefined } | null | undefined } };
...
export type GetSamplesByCallIdQuery = { samplesByCallId: Array<{ id: number, title: string, creatorId: number, questionaryId: number, safetyStatus: SampleStatus, safetyComment: string, isPostProposalSubmission: boolean, created: any, proposalPk: number, questionId: string, proposal: { primaryKey: number, proposalId: string } }> | null | undefined };
...
export type GetSamplesWithQuestionaryStatusQuery = { samples: Array<{ id: number, title: string, creatorId: number, questionaryId: number, safetyStatus: SampleStatus, safetyComment: string, isPostProposalSubmission: boolean, created: any, proposalPk: number, questionId: string, questionary: { isCompleted: boolean } }> | null | undefined };
...
export type AddProposalWorkflowStatusMutation = { addProposalWorkflowStatus: { proposalWorkflowConnection: { id: number } | null | undefined, rejection: { reason: string, context: string | null | undefined, exception: string | null | undefined } | null | undefined } };
...
export type AddStatusChangingEventsToConnectionMutation = { addStatusChangingEventsToConnection: { statusChangingEvents: Array<{ statusChangingEventId: number, proposalWorkflowConnectionId: number, statusChangingEvent: string }> | null | undefined, rejection: { reason: string, context: string | null | undefined, exception: string | null | undefined } | null | undefined } };
...
export type CreateProposalStatusMutation = { createProposalStatus: { proposalStatus: { id: number, shortCode: string, name: string, description: string, isDefault: boolean } | null | undefined, rejection: { reason: string, context: string | null | undefined, exception: string | null | undefined } | null | undefined } };
...
export type CreateProposalWorkflowMutation = { createProposalWorkflow: { proposalWorkflow: { id: number, name: string, description: string, proposalWorkflowConnectionGroups: Array<{ groupId: string, parentGroupId: string | null | undefined, connections: Array<{ id: number, sortOrder: number, proposalWorkflowId: number, proposalStatusId: number, nextProposalStatusId: number | null | undefined, prevProposalStatusId: number | null | undefined, droppableGroupId: string, proposalStatus: { id: number, shortCode: string, name: string, description: string, isDefault: boolean }, statusChangingEvents: Array<{ statusChangingEventId: number, proposalWorkflowConnectionId: number, statusChangingEvent: string }> | null | undefined }> }> } | null | undefined, rejection: { reason: string, context: string | null | undefined, exception: string | null | undefined } | null | undefined } };
...
export type DeleteProposalStatusMutation = { deleteProposalStatus: { proposalStatus: { id: number, shortCode: string, name: string, description: string, isDefault: boolean } | null | undefined, rejection: { reason: string, context: string | null | undefined, exception: string | null | undefined } | null | undefined } };
...
export type DeleteProposalWorkflowMutation = { deleteProposalWorkflow: { proposalWorkflow: { id: number, name: string, description: string } | null | undefined, rejection: { reason: string, context: string | null | undefined, exception: string | null | undefined } | null | undefined } };
...
export type DeleteProposalWorkflowStatusMutation = { deleteProposalWorkflowStatus: { isSuccess: boolean | null | undefined, rejection: { reason: string, context: string | null | undefined, exception: string | null | undefined } | null | undefined } };
...
export type GetProposalEventsQuery = { proposalEvents: Array<{ name: Event, description: string | null | undefined }> | null | undefined };

export type GetProposalStatusesQueryVariables = Exact<{ [key: string]: never; }>;


export type GetProposalStatusesQuery = { proposalStatuses: Array<{ id: number, shortCode: string, name: string, description: string, isDefault: boolean }> | null | undefined };
...
export type GetProposalWorkflowsQuery = { proposalWorkflows: Array<{ id: number, name: string, description: string }> | null | undefined };
...
export type MoveProposalWorkflowStatusMutation = { moveProposalWorkflowStatus: { rejection: { reason: string, context: string | null | undefined, exception: string | null | undefined } | null | undefined } };
...
export type UpdateProposalStatusMutation = { updateProposalStatus: { proposalStatus: { id: number, shortCode: string, name: string, description: string, isDefault: boolean } | null | undefined, rejection: { reason: string, context: string | null | undefined, exception: string | null | undefined } | null | undefined } };
...
export type UpdateProposalWorkflowMutation = { updateProposalWorkflow: { proposalWorkflow: { id: number, name: string, description: string, proposalWorkflowConnectionGroups: Array<{ groupId: string, parentGroupId: string | null | undefined, connections: Array<{ id: number, sortOrder: number, proposalWorkflowId: number, proposalStatusId: number, nextProposalStatusId: number | null | undefined, prevProposalStatusId: number | null | undefined, droppableGroupId: string, proposalStatus: { id: number, name: string, description: string }, statusChangingEvents: Array<{ statusChangingEventId: number, proposalWorkflowConnectionId: number, statusChangingEvent: string }> | null | undefined }> }> } | null | undefined, rejection: { reason: string, context: string | null | undefined, exception: string | null | undefined } | null | undefined } };
...
export type AddSamplesToShipmentMutation = { addSamplesToShipment: { rejection: { reason: string, context: string | null | undefined, exception: string | null | undefined } | null | undefined, shipment: { id: number, title: string, proposalPk: number, status: ShipmentStatus, externalRef: string | null | undefined, questionaryId: number, visitId: number, creatorId: number, created: any, samples: Array<{ id: number, title: string, creatorId: number, questionaryId: number, safetyStatus: SampleStatus, safetyComment: string, isPostProposalSubmission: boolean, created: any, proposalPk: number, questionId: string }>, proposal: { proposalId: string } } | null | undefined } };
...
export type DeleteShipmentMutation = { deleteShipment: { rejection: { reason: string, context: string | null | undefined, exception: string | null | undefined } | null | undefined } };

export type ShipmentFragment = { id: number, title: string, proposalPk: number, status: ShipmentStatus, externalRef: string | null | undefined, questionaryId: number, visitId: number, creatorId: number, created: any, proposal: { proposalId: string } };

export type GetMyShipmentsQueryVariables = Exact<{ [key: string]: never; }>;


export type GetMyShipmentsQuery = { myShipments: Array<{ id: number, title: string, proposalPk: number, status: ShipmentStatus, externalRef: string | null | undefined, questionaryId: number, visitId: number, creatorId: number, created: any, proposal: { proposalId: string } }> | null | undefined };
...
export type GetShipmentsQuery = { shipments: Array<{ id: number, title: string, proposalPk: number, status: ShipmentStatus, externalRef: string | null | undefined, questionaryId: number, visitId: number, creatorId: number, created: any, proposal: { proposalId: string } }> | null | undefined };
...
export type SetActiveTemplateMutation = { setActiveTemplate: { isSuccess: boolean | null | undefined, rejection: { reason: string, context: string | null | undefined, exception: string | null | undefined } | null | undefined } };
...
export type SubmitShipmentMutation = { submitShipment: { rejection: { reason: string, context: string | null | undefined, exception: string | null | undefined } | null | undefined, shipment: { id: number, title: string, proposalPk: number, status: ShipmentStatus, externalRef: string | null | undefined, questionaryId: number, visitId: number, creatorId: number, created: any, proposal: { proposalId: string } } | null | undefined } };
...
export type UpdateShipmentMutation = { updateShipment: { rejection: { reason: string, context: string | null | undefined, exception: string | null | undefined } | null | undefined, shipment: { id: number, title: string, proposalPk: number, status: ShipmentStatus, externalRef: string | null | undefined, questionaryId: number, visitId: number, creatorId: number, created: any, questionary: { isCompleted: boolean, questionaryId: number, templateId: number, created: any, steps: Array<{ isCompleted: boolean, topic: { title: string, id: number, templateId: number, sortOrder: number, isEnabled: boolean }, fields: Array<{ answerId: number | null | undefined, sortOrder: number, topicId: number, dependenciesOperator: DependenciesLogicOperator | null | undefined, value: any | null | undefined, question: { id: string, question: string, naturalKey: string, dataType: DataType, categoryId: TemplateCategoryId, config: { small_label: string, required: boolean, tooltip: string } | { small_label: string, required: boolean, tooltip: string, minDate: string | null | undefined, maxDate: string | null | undefined, defaultDate: string | null | undefined, includeTime: boolean } | { html: string, plain: string, omitFromPdf: boolean } | { small_label: string, required: boolean, tooltip: string } | { file_type: Array<string>, max_files: number, small_label: string, required: boolean, tooltip: string } | { titlePlaceholder: string, questionLabel: string } | { units: Array<string> | null | undefined, small_label: string, required: boolean, tooltip: string } | { units: Array<string> | null | undefined, numberValueConstraint: NumberValueConstraint | null | undefined, small_label: string, required: boolean, tooltip: string } | { tooltip: string } | { tooltip: string } | { small_label: string, required: boolean, tooltip: string, max: number | null | undefined } | { titlePlaceholder: string } | { addEntryButtonLabel: string, minEntries: number | null | undefined, maxEntries: number | null | undefined, templateId: number | null | undefined, esiTemplateId: number | null | undefined, templateCategory: string, required: boolean, small_label: string } | { tooltip: string } | { variant: string, options: Array<string>, isMultipleSelect: boolean, small_label: string, required: boolean, tooltip: string } | { small_label: string, required: boolean, tooltip: string } | { addEntryButtonLabel: string, minEntries: number | null | undefined, maxEntries: number | null | undefined, templateId: number | null | undefined, templateCategory: string, required: boolean, small_label: string } | { min: number | null | undefined, max: number | null | undefined, multiline: boolean, placeholder: string, small_label: string, required: boolean, tooltip: string, htmlQuestion: string | null | undefined, isHtmlQuestion: boolean, isCounterHidden: boolean } | { small_label: string, required: boolean, tooltip: string } }, config: { small_label: string, required: boolean, tooltip: string } | { small_label: string, required: boolean, tooltip: string, minDate: string | null | undefined, maxDate: string | null | undefined, defaultDate: string | null | undefined, includeTime: boolean } | { html: string, plain: string, omitFromPdf: boolean } | { small_label: string, required: boolean, tooltip: string } | { file_type: Array<string>, max_files: number, small_label: string, required: boolean, tooltip: string } | { titlePlaceholder: string, questionLabel: string } | { units: Array<string> | null | undefined, small_label: string, required: boolean, tooltip: string } | { units: Array<string> | null | undefined, numberValueConstraint: NumberValueConstraint | null | undefined, small_label: string, required: boolean, tooltip: string } | { tooltip: string } | { tooltip: string } | { small_label: string, required: boolean, tooltip: string, max: number | null | undefined } | { titlePlaceholder: string } | { addEntryButtonLabel: string, minEntries: number | null | undefined, maxEntries: number | null | undefined, templateId: number | null | undefined, esiTemplateId: number | null | undefined, templateCategory: string, required: boolean, small_label: string } | { tooltip: string } | { variant: string, options: Array<string>, isMultipleSelect: boolean, small_label: string, required: boolean, tooltip: string } | { small_label: string, required: boolean, tooltip: string } | { addEntryButtonLabel: string, minEntries: number | null | undefined, maxEntries: number | null | undefined, templateId: number | null | undefined, templateCategory: string, required: boolean, small_label: string } | { min: number | null | undefined, max: number | null | undefined, multiline: boolean, placeholder: string, small_label: string, required: boolean, tooltip: string, htmlQuestion: string | null | undefined, isHtmlQuestion: boolean, isCounterHidden: boolean } | { small_label: string, required: boolean, tooltip: string }, dependencies: Array<{ questionId: string, dependencyId: string, dependencyNaturalKey: string, condition: { condition: EvaluatorOperator, params: any } }> }> }> }, proposal: { proposalId: string } } | null | undefined } };
...
export type ImportTemplateMutation = { importTemplate: { template: { isArchived: boolean, questionaryCount: number, templateId: number, groupId: TemplateGroupId, name: string, description: string | null | undefined, steps: Array<{ topic: { title: string, id: number, templateId: number, sortOrder: number, isEnabled: boolean }, fields: Array<{ sortOrder: number, topicId: number, dependenciesOperator: DependenciesLogicOperator | null | undefined, question: { id: string, question: string, naturalKey: string, dataType: DataType, categoryId: TemplateCategoryId, config: { small_label: string, required: boolean, tooltip: string } | { small_label: string, required: boolean, tooltip: string, minDate: string | null | undefined, maxDate: string | null | undefined, defaultDate: string | null | undefined, includeTime: boolean } | { html: string, plain: string, omitFromPdf: boolean } | { small_label: string, required: boolean, tooltip: string } | { file_type: Array<string>, max_files: number, small_label: string, required: boolean, tooltip: string } | { titlePlaceholder: string, questionLabel: string } | { units: Array<string> | null | undefined, small_label: string, required: boolean, tooltip: string } | { units: Array<string> | null | undefined, numberValueConstraint: NumberValueConstraint | null | undefined, small_label: string, required: boolean, tooltip: string } | { tooltip: string } | { tooltip: string } | { small_label: string, required: boolean, tooltip: string, max: number | null | undefined } | { titlePlaceholder: string } | { addEntryButtonLabel: string, minEntries: number | null | undefined, maxEntries: number | null | undefined, templateId: number | null | undefined, esiTemplateId: number | null | undefined, templateCategory: string, required: boolean, small_label: string } | { tooltip: string } | { variant: string, options: Array<string>, isMultipleSelect: boolean, small_label: string, required: boolean, tooltip: string } | { small_label: string, required: boolean, tooltip: string } | { addEntryButtonLabel: string, minEntries: number | null | undefined, maxEntries: number | null | undefined, templateId: number | null | undefined, templateCategory: string, required: boolean, small_label: string } | { min: number | null | undefined, max: number | null | undefined, multiline: boolean, placeholder: string, small_label: string, required: boolean, tooltip: string, htmlQuestion: string | null | undefined, isHtmlQuestion: boolean, isCounterHidden: boolean } | { small_label: string, required: boolean, tooltip: string } }, config: { small_label: string, required: boolean, tooltip: string } | { small_label: string, required: boolean, tooltip: string, minDate: string | null | undefined, maxDate: string | null | undefined, defaultDate: string | null | undefined, includeTime: boolean } | { html: string, plain: string, omitFromPdf: boolean } | { small_label: string, required: boolean, tooltip: string } | { file_type: Array<string>, max_files: number, small_label: string, required: boolean, tooltip: string } | { titlePlaceholder: string, questionLabel: string } | { units: Array<string> | null | undefined, small_label: string, required: boolean, tooltip: string } | { units: Array<string> | null | undefined, numberValueConstraint: NumberValueConstraint | null | undefined, small_label: string, required: boolean, tooltip: string } | { tooltip: string } | { tooltip: string } | { small_label: string, required: boolean, tooltip: string, max: number | null | undefined } | { titlePlaceholder: string } | { addEntryButtonLabel: string, minEntries: number | null | undefined, maxEntries: number | null | undefined, templateId: number | null | undefined, esiTemplateId: number | null | undefined, templateCategory: string, required: boolean, small_label: string } | { tooltip: string } | { variant: string, options: Array<string>, isMultipleSelect: boolean, small_label: string, required: boolean, tooltip: string } | { small_label: string, required: boolean, tooltip: string } | { addEntryButtonLabel: string, minEntries: number | null | undefined, maxEntries: number | null | undefined, templateId: number | null | undefined, templateCategory: string, required: boolean, small_label: string } | { min: number | null | undefined, max: number | null | undefined, multiline: boolean, placeholder: string, small_label: string, required: boolean, tooltip: string, htmlQuestion: string | null | undefined, isHtmlQuestion: boolean, isCounterHidden: boolean } | { small_label: string, required: boolean, tooltip: string }, dependencies: Array<{ questionId: string, dependencyId: string, dependencyNaturalKey: string, condition: { condition: EvaluatorOperator, params: any } }> }> }>, complementaryQuestions: Array<{ id: string, question: string, naturalKey: string, dataType: DataType, categoryId: TemplateCategoryId, config: { small_label: string, required: boolean, tooltip: string } | { small_label: string, required: boolean, tooltip: string, minDate: string | null | undefined, maxDate: string | null | undefined, defaultDate: string | null | undefined, includeTime: boolean } | { html: string, plain: string, omitFromPdf: boolean } | { small_label: string, required: boolean, tooltip: string } | { file_type: Array<string>, max_files: number, small_label: string, required: boolean, tooltip: string } | { titlePlaceholder: string, questionLabel: string } | { units: Array<string> | null | undefined, small_label: string, required: boolean, tooltip: string } | { units: Array<string> | null | undefined, numberValueConstraint: NumberValueConstraint | null | undefined, small_label: string, required: boolean, tooltip: string } | { tooltip: string } | { tooltip: string } | { small_label: string, required: boolean, tooltip: string, max: number | null | undefined } | { titlePlaceholder: string } | { addEntryButtonLabel: string, minEntries: number | null | undefined, maxEntries: number | null | undefined, templateId: number | null | undefined, esiTemplateId: number | null | undefined, templateCategory: string, required: boolean, small_label: string } | { tooltip: string } | { variant: string, options: Array<string>, isMultipleSelect: boolean, small_label: string, required: boolean, tooltip: string } | { small_label: string, required: boolean, tooltip: string } | { addEntryButtonLabel: string, minEntries: number | null | undefined, maxEntries: number | null | undefined, templateId: number | null | undefined, templateCategory: string, required: boolean, small_label: string } | { min: number | null | undefined, max: number | null | undefined, multiline: boolean, placeholder: string, small_label: string, required: boolean, tooltip: string, htmlQuestion: string | null | undefined, isHtmlQuestion: boolean, isCounterHidden: boolean } | { small_label: string, required: boolean, tooltip: string } }>, group: { groupId: TemplateGroupId, categoryId: TemplateCategoryId } } | null | undefined, rejection: { reason: string, context: string | null | undefined, exception: string | null | undefined } | null | undefined } };
...
export type CloneTemplateMutation = { cloneTemplate: { template: { questionaryCount: number, templateId: number, name: string, description: string | null | undefined, isArchived: boolean, steps: Array<{ topic: { title: string, id: number, templateId: number, sortOrder: number, isEnabled: boolean } }> } | null | undefined, rejection: { reason: string, context: string | null | undefined, exception: string | null | undefined } | null | undefined } };
...
export type CreateQuestionTemplateRelationMutation = { createQuestionTemplateRelation: { template: { isArchived: boolean, questionaryCount: number, templateId: number, groupId: TemplateGroupId, name: string, description: string | null | undefined, steps: Array<{ topic: { title: string, id: number, templateId: number, sortOrder: number, isEnabled: boolean }, fields: Array<{ sortOrder: number, topicId: number, dependenciesOperator: DependenciesLogicOperator | null | undefined, question: { id: string, question: string, naturalKey: string, dataType: DataType, categoryId: TemplateCategoryId, config: { small_label: string, required: boolean, tooltip: string } | { small_label: string, required: boolean, tooltip: string, minDate: string | null | undefined, maxDate: string | null | undefined, defaultDate: string | null | undefined, includeTime: boolean } | { html: string, plain: string, omitFromPdf: boolean } | { small_label: string, required: boolean, tooltip: string } | { file_type: Array<string>, max_files: number, small_label: string, required: boolean, tooltip: string } | { titlePlaceholder: string, questionLabel: string } | { units: Array<string> | null | undefined, small_label: string, required: boolean, tooltip: string } | { units: Array<string> | null | undefined, numberValueConstraint: NumberValueConstraint | null | undefined, small_label: string, required: boolean, tooltip: string } | { tooltip: string } | { tooltip: string } | { small_label: string, required: boolean, tooltip: string, max: number | null | undefined } | { titlePlaceholder: string } | { addEntryButtonLabel: string, minEntries: number | null | undefined, maxEntries: number | null | undefined, templateId: number | null | undefined, esiTemplateId: number | null | undefined, templateCategory: string, required: boolean, small_label: string } | { tooltip: string } | { variant: string, options: Array<string>, isMultipleSelect: boolean, small_label: string, required: boolean, tooltip: string } | { small_label: string, required: boolean, tooltip: string } | { addEntryButtonLabel: string, minEntries: number | null | undefined, maxEntries: number | null | undefined, templateId: number | null | undefined, templateCategory: string, required: boolean, small_label: string } | { min: number | null | undefined, max: number | null | undefined, multiline: boolean, placeholder: string, small_label: string, required: boolean, tooltip: string, htmlQuestion: string | null | undefined, isHtmlQuestion: boolean, isCounterHidden: boolean } | { small_label: string, required: boolean, tooltip: string } }, config: { small_label: string, required: boolean, tooltip: string } | { small_label: string, required: boolean, tooltip: string, minDate: string | null | undefined, maxDate: string | null | undefined, defaultDate: string | null | undefined, includeTime: boolean } | { html: string, plain: string, omitFromPdf: boolean } | { small_label: string, required: boolean, tooltip: string } | { file_type: Array<string>, max_files: number, small_label: string, required: boolean, tooltip: string } | { titlePlaceholder: string, questionLabel: string } | { units: Array<string> | null | undefined, small_label: string, required: boolean, tooltip: string } | { units: Array<string> | null | undefined, numberValueConstraint: NumberValueConstraint | null | undefined, small_label: string, required: boolean, tooltip: string } | { tooltip: string } | { tooltip: string } | { small_label: string, required: boolean, tooltip: string, max: number | null | undefined } | { titlePlaceholder: string } | { addEntryButtonLabel: string, minEntries: number | null | undefined, maxEntries: number | null | undefined, templateId: number | null | undefined, esiTemplateId: number | null | undefined, templateCategory: string, required: boolean, small_label: string } | { tooltip: string } | { variant: string, options: Array<string>, isMultipleSelect: boolean, small_label: string, required: boolean, tooltip: string } | { small_label: string, required: boolean, tooltip: string } | { addEntryButtonLabel: string, minEntries: number | null | undefined, maxEntries: number | null | undefined, templateId: number | null | undefined, templateCategory: string, required: boolean, small_label: string } | { min: number | null | undefined, max: number | null | undefined, multiline: boolean, placeholder: string, small_label: string, required: boolean, tooltip: string, htmlQuestion: string | null | undefined, isHtmlQuestion: boolean, isCounterHidden: boolean } | { small_label: string, required: boolean, tooltip: string }, dependencies: Array<{ questionId: string, dependencyId: string, dependencyNaturalKey: string, condition: { condition: EvaluatorOperator, params: any } }> }> }>, complementaryQuestions: Array<{ id: string, question: string, naturalKey: string, dataType: DataType, categoryId: TemplateCategoryId, config: { small_label: string, required: boolean, tooltip: string } | { small_label: string, required: boolean, tooltip: string, minDate: string | null | undefined, maxDate: string | null | undefined, defaultDate: string | null | undefined, includeTime: boolean } | { html: string, plain: string, omitFromPdf: boolean } | { small_label: string, required: boolean, tooltip: string } | { file_type: Array<string>, max_files: number, small_label: string, required: boolean, tooltip: string } | { titlePlaceholder: string, questionLabel: string } | { units: Array<string> | null | undefined, small_label: string, required: boolean, tooltip: string } | { units: Array<string> | null | undefined, numberValueConstraint: NumberValueConstraint | null | undefined, small_label: string, required: boolean, tooltip: string } | { tooltip: string } | { tooltip: string } | { small_label: string, required: boolean, tooltip: string, max: number | null | undefined } | { titlePlaceholder: string } | { addEntryButtonLabel: string, minEntries: number | null | undefined, maxEntries: number | null | undefined, templateId: number | null | undefined, esiTemplateId: number | null | undefined, templateCategory: string, required: boolean, small_label: string } | { tooltip: string } | { variant: string, options: Array<string>, isMultipleSelect: boolean, small_label: string, required: boolean, tooltip: string } | { small_label: string, required: boolean, tooltip: string } | { addEntryButtonLabel: string, minEntries: number | null | undefined, maxEntries: number | null | undefined, templateId: number | null | undefined, templateCategory: string, required: boolean, small_label: string } | { min: number | null | undefined, max: number | null | undefined, multiline: boolean, placeholder: string, small_label: string, required: boolean, tooltip: string, htmlQuestion: string | null | undefined, isHtmlQuestion: boolean, isCounterHidden: boolean } | { small_label: string, required: boolean, tooltip: string } }>, group: { groupId: TemplateGroupId, categoryId: TemplateCategoryId } } | null | undefined, rejection: { reason: string, context: string | null | undefined, exception: string | null | undefined } | null | undefined } };
...
export type CreateTemplateMutation = { createTemplate: { template: { questionaryCount: number, templateId: number, name: string, description: string | null | undefined, isArchived: boolean, steps: Array<{ topic: { title: string, id: number, templateId: number, sortOrder: number, isEnabled: boolean } }> } | null | undefined, rejection: { reason: string, context: string | null | undefined, exception: string | null | undefined } | null | undefined } };
...
export type CreateTopicMutation = { createTopic: { template: { isArchived: boolean, questionaryCount: number, templateId: number, groupId: TemplateGroupId, name: string, description: string | null | undefined, steps: Array<{ topic: { title: string, id: number, templateId: number, sortOrder: number, isEnabled: boolean }, fields: Array<{ sortOrder: number, topicId: number, dependenciesOperator: DependenciesLogicOperator | null | undefined, question: { id: string, question: string, naturalKey: string, dataType: DataType, categoryId: TemplateCategoryId, config: { small_label: string, required: boolean, tooltip: string } | { small_label: string, required: boolean, tooltip: string, minDate: string | null | undefined, maxDate: string | null | undefined, defaultDate: string | null | undefined, includeTime: boolean } | { html: string, plain: string, omitFromPdf: boolean } | { small_label: string, required: boolean, tooltip: string } | { file_type: Array<string>, max_files: number, small_label: string, required: boolean, tooltip: string } | { titlePlaceholder: string, questionLabel: string } | { units: Array<string> | null | undefined, small_label: string, required: boolean, tooltip: string } | { units: Array<string> | null | undefined, numberValueConstraint: NumberValueConstraint | null | undefined, small_label: string, required: boolean, tooltip: string } | { tooltip: string } | { tooltip: string } | { small_label: string, required: boolean, tooltip: string, max: number | null | undefined } | { titlePlaceholder: string } | { addEntryButtonLabel: string, minEntries: number | null | undefined, maxEntries: number | null | undefined, templateId: number | null | undefined, esiTemplateId: number | null | undefined, templateCategory: string, required: boolean, small_label: string } | { tooltip: string } | { variant: string, options: Array<string>, isMultipleSelect: boolean, small_label: string, required: boolean, tooltip: string } | { small_label: string, required: boolean, tooltip: string } | { addEntryButtonLabel: string, minEntries: number | null | undefined, maxEntries: number | null | undefined, templateId: number | null | undefined, templateCategory: string, required: boolean, small_label: string } | { min: number | null | undefined, max: number | null | undefined, multiline: boolean, placeholder: string, small_label: string, required: boolean, tooltip: string, htmlQuestion: string | null | undefined, isHtmlQuestion: boolean, isCounterHidden: boolean } | { small_label: string, required: boolean, tooltip: string } }, config: { small_label: string, required: boolean, tooltip: string } | { small_label: string, required: boolean, tooltip: string, minDate: string | null | undefined, maxDate: string | null | undefined, defaultDate: string | null | undefined, includeTime: boolean } | { html: string, plain: string, omitFromPdf: boolean } | { small_label: string, required: boolean, tooltip: string } | { file_type: Array<string>, max_files: number, small_label: string, required: boolean, tooltip: string } | { titlePlaceholder: string, questionLabel: string } | { units: Array<string> | null | undefined, small_label: string, required: boolean, tooltip: string } | { units: Array<string> | null | undefined, numberValueConstraint: NumberValueConstraint | null | undefined, small_label: string, required: boolean, tooltip: string } | { tooltip: string } | { tooltip: string } | { small_label: string, required: boolean, tooltip: string, max: number | null | undefined } | { titlePlaceholder: string } | { addEntryButtonLabel: string, minEntries: number | null | undefined, maxEntries: number | null | undefined, templateId: number | null | undefined, esiTemplateId: number | null | undefined, templateCategory: string, required: boolean, small_label: string } | { tooltip: string } | { variant: string, options: Array<string>, isMultipleSelect: boolean, small_label: string, required: boolean, tooltip: string } | { small_label: string, required: boolean, tooltip: string } | { addEntryButtonLabel: string, minEntries: number | null | undefined, maxEntries: number | null | undefined, templateId: number | null | undefined, templateCategory: string, required: boolean, small_label: string } | { min: number | null | undefined, max: number | null | undefined, multiline: boolean, placeholder: string, small_label: string, required: boolean, tooltip: string, htmlQuestion: string | null | undefined, isHtmlQuestion: boolean, isCounterHidden: boolean } | { small_label: string, required: boolean, tooltip: string }, dependencies: Array<{ questionId: string, dependencyId: string, dependencyNaturalKey: string, condition: { condition: EvaluatorOperator, params: any } }> }> }>, complementaryQuestions: Array<{ id: string, question: string, naturalKey: string, dataType: DataType, categoryId: TemplateCategoryId, config: { small_label: string, required: boolean, tooltip: string } | { small_label: string, required: boolean, tooltip: string, minDate: string | null | undefined, maxDate: string | null | undefined, defaultDate: string | null | undefined, includeTime: boolean } | { html: string, plain: string, omitFromPdf: boolean } | { small_label: string, required: boolean, tooltip: string } | { file_type: Array<string>, max_files: number, small_label: string, required: boolean, tooltip: string } | { titlePlaceholder: string, questionLabel: string } | { units: Array<string> | null | undefined, small_label: string, required: boolean, tooltip: string } | { units: Array<string> | null | undefined, numberValueConstraint: NumberValueConstraint | null | undefined, small_label: string, required: boolean, tooltip: string } | { tooltip: string } | { tooltip: string } | { small_label: string, required: boolean, tooltip: string, max: number | null | undefined } | { titlePlaceholder: string } | { addEntryButtonLabel: string, minEntries: number | null | undefined, maxEntries: number | null | undefined, templateId: number | null | undefined, esiTemplateId: number | null | undefined, templateCategory: string, required: boolean, small_label: string } | { tooltip: string } | { variant: string, options: Array<string>, isMultipleSelect: boolean, small_label: string, required: boolean, tooltip: string } | { small_label: string, required: boolean, tooltip: string } | { addEntryButtonLabel: string, minEntries: number | null | undefined, maxEntries: number | null | undefined, templateId: number | null | undefined, templateCategory: string, required: boolean, small_label: string } | { min: number | null | undefined, max: number | null | undefined, multiline: boolean, placeholder: string, small_label: string, required: boolean, tooltip: string, htmlQuestion: string | null | undefined, isHtmlQuestion: boolean, isCounterHidden: boolean } | { small_label: string, required: boolean, tooltip: string } }>, group: { groupId: TemplateGroupId, categoryId: TemplateCategoryId } } | null | undefined, rejection: { reason: string, context: string | null | undefined, exception: string | null | undefined } | null | undefined } };
...
export type DeleteQuestionTemplateRelationMutation = { deleteQuestionTemplateRelation: { template: { isArchived: boolean, questionaryCount: number, templateId: number, groupId: TemplateGroupId, name: string, description: string | null | undefined, steps: Array<{ topic: { title: string, id: number, templateId: number, sortOrder: number, isEnabled: boolean }, fields: Array<{ sortOrder: number, topicId: number, dependenciesOperator: DependenciesLogicOperator | null | undefined, question: { id: string, question: string, naturalKey: string, dataType: DataType, categoryId: TemplateCategoryId, config: { small_label: string, required: boolean, tooltip: string } | { small_label: string, required: boolean, tooltip: string, minDate: string | null | undefined, maxDate: string | null | undefined, defaultDate: string | null | undefined, includeTime: boolean } | { html: string, plain: string, omitFromPdf: boolean } | { small_label: string, required: boolean, tooltip: string } | { file_type: Array<string>, max_files: number, small_label: string, required: boolean, tooltip: string } | { titlePlaceholder: string, questionLabel: string } | { units: Array<string> | null | undefined, small_label: string, required: boolean, tooltip: string } | { units: Array<string> | null | undefined, numberValueConstraint: NumberValueConstraint | null | undefined, small_label: string, required: boolean, tooltip: string } | { tooltip: string } | { tooltip: string } | { small_label: string, required: boolean, tooltip: string, max: number | null | undefined } | { titlePlaceholder: string } | { addEntryButtonLabel: string, minEntries: number | null | undefined, maxEntries: number | null | undefined, templateId: number | null | undefined, esiTemplateId: number | null | undefined, templateCategory: string, required: boolean, small_label: string } | { tooltip: string } | { variant: string, options: Array<string>, isMultipleSelect: boolean, small_label: string, required: boolean, tooltip: string } | { small_label: string, required: boolean, tooltip: string } | { addEntryButtonLabel: string, minEntries: number | null | undefined, maxEntries: number | null | undefined, templateId: number | null | undefined, templateCategory: string, required: boolean, small_label: string } | { min: number | null | undefined, max: number | null | undefined, multiline: boolean, placeholder: string, small_label: string, required: boolean, tooltip: string, htmlQuestion: string | null | undefined, isHtmlQuestion: boolean, isCounterHidden: boolean } | { small_label: string, required: boolean, tooltip: string } }, config: { small_label: string, required: boolean, tooltip: string } | { small_label: string, required: boolean, tooltip: string, minDate: string | null | undefined, maxDate: string | null | undefined, defaultDate: string | null | undefined, includeTime: boolean } | { html: string, plain: string, omitFromPdf: boolean } | { small_label: string, required: boolean, tooltip: string } | { file_type: Array<string>, max_files: number, small_label: string, required: boolean, tooltip: string } | { titlePlaceholder: string, questionLabel: string } | { units: Array<string> | null | undefined, small_label: string, required: boolean, tooltip: string } | { units: Array<string> | null | undefined, numberValueConstraint: NumberValueConstraint | null | undefined, small_label: string, required: boolean, tooltip: string } | { tooltip: string } | { tooltip: string } | { small_label: string, required: boolean, tooltip: string, max: number | null | undefined } | { titlePlaceholder: string } | { addEntryButtonLabel: string, minEntries: number | null | undefined, maxEntries: number | null | undefined, templateId: number | null | undefined, esiTemplateId: number | null | undefined, templateCategory: string, required: boolean, small_label: string } | { tooltip: string } | { variant: string, options: Array<string>, isMultipleSelect: boolean, small_label: string, required: boolean, tooltip: string } | { small_label: string, required: boolean, tooltip: string } | { addEntryButtonLabel: string, minEntries: number | null | undefined, maxEntries: number | null | undefined, templateId: number | null | undefined, templateCategory: string, required: boolean, small_label: string } | { min: number | null | undefined, max: number | null | undefined, multiline: boolean, placeholder: string, small_label: string, required: boolean, tooltip: string, htmlQuestion: string | null | undefined, isHtmlQuestion: boolean, isCounterHidden: boolean } | { small_label: string, required: boolean, tooltip: string }, dependencies: Array<{ questionId: string, dependencyId: string, dependencyNaturalKey: string, condition: { condition: EvaluatorOperator, params: any } }> }> }>, complementaryQuestions: Array<{ id: string, question: string, naturalKey: string, dataType: DataType, categoryId: TemplateCategoryId, config: { small_label: string, required: boolean, tooltip: string } | { small_label: string, required: boolean, tooltip: string, minDate: string | null | undefined, maxDate: string | null | undefined, defaultDate: string | null | undefined, includeTime: boolean } | { html: string, plain: string, omitFromPdf: boolean } | { small_label: string, required: boolean, tooltip: string } | { file_type: Array<string>, max_files: number, small_label: string, required: boolean, tooltip: string } | { titlePlaceholder: string, questionLabel: string } | { units: Array<string> | null | undefined, small_label: string, required: boolean, tooltip: string } | { units: Array<string> | null | undefined, numberValueConstraint: NumberValueConstraint | null | undefined, small_label: string, required: boolean, tooltip: string } | { tooltip: string } | { tooltip: string } | { small_label: string, required: boolean, tooltip: string, max: number | null | undefined } | { titlePlaceholder: string } | { addEntryButtonLabel: string, minEntries: number | null | undefined, maxEntries: number | null | undefined, templateId: number | null | undefined, esiTemplateId: number | null | undefined, templateCategory: string, required: boolean, small_label: string } | { tooltip: string } | { variant: string, options: Array<string>, isMultipleSelect: boolean, small_label: string, required: boolean, tooltip: string } | { small_label: string, required: boolean, tooltip: string } | { addEntryButtonLabel: string, minEntries: number | null | undefined, maxEntries: number | null | undefined, templateId: number | null | undefined, templateCategory: string, required: boolean, small_label: string } | { min: number | null | undefined, max: number | null | undefined, multiline: boolean, placeholder: string, small_label: string, required: boolean, tooltip: string, htmlQuestion: string | null | undefined, isHtmlQuestion: boolean, isCounterHidden: boolean } | { small_label: string, required: boolean, tooltip: string } }>, group: { groupId: TemplateGroupId, categoryId: TemplateCategoryId } } | null | undefined, rejection: { reason: string, context: string | null | undefined, exception: string | null | undefined } | null | undefined } };
...
export type DeleteTemplateMutation = { deleteTemplate: { template: { templateId: number, name: string } | null | undefined, rejection: { reason: string, context: string | null | undefined, exception: string | null | undefined } | null | undefined } };
...
export type DeleteTopicMutation = { deleteTopic: { rejection: { reason: string, context: string | null | undefined, exception: string | null | undefined } | null | undefined } };
...
type FieldConfig_DateConfig_Fragment = { small_label: string, required: boolean, tooltip: string, minDate: string | null | undefined, maxDate: string | null | undefined, defaultDate: string | null | undefined, includeTime: boolean };
...
type FieldConfig_FileUploadConfig_Fragment = { file_type: Array<string>, max_files: number, small_label: string, required: boolean, tooltip: string };

type FieldConfig_GenericTemplateBasisConfig_Fragment = { titlePlaceholder: string, questionLabel: string };

type FieldConfig_IntervalConfig_Fragment = { units: Array<string> | null | undefined, small_label: string, required: boolean, tooltip: string };

type FieldConfig_NumberInputConfig_Fragment = { units: Array<string> | null | undefined, numberValueConstraint: NumberValueConstraint | null | undefined, small_label: string, required: boolean, tooltip: string };
...
type FieldConfig_RichTextInputConfig_Fragment = { small_label: string, required: boolean, tooltip: string, max: number | null | undefined };

type FieldConfig_SampleBasisConfig_Fragment = { titlePlaceholder: string };

type FieldConfig_SampleDeclarationConfig_Fragment = { addEntryButtonLabel: string, minEntries: number | null | undefined, maxEntries: number | null | undefined, templateId: number | null | undefined, esiTemplateId: number | null | undefined, templateCategory: string, required: boolean, small_label: string };
...
type FieldConfig_SubTemplateConfig_Fragment = { addEntryButtonLabel: string, minEntries: number | null | undefined, maxEntries: number | null | undefined, templateId: number | null | undefined, templateCategory: string, required: boolean, small_label: string };

type FieldConfig_TextInputConfig_Fragment = { min: number | null | undefined, max: number | null | undefined, multiline: boolean, placeholder: string, small_label: string, required: boolean, tooltip: string, htmlQuestion: string | null | undefined, isHtmlQuestion: boolean, isCounterHidden: boolean };
...
export type TemplateMetadataFragment = { templateId: number, name: string, description: string | null | undefined, isArchived: boolean, steps: Array<{ topic: { title: string, id: number, templateId: number, sortOrder: number, isEnabled: boolean } }> };
...
export type GetActiveTemplateIdQuery = { activeTemplateId: number | null | undefined };
...
export type GetIsNaturalKeyPresentQuery = { isNaturalKeyPresent: boolean | null | undefined };
...
export type GetProposalTemplatesQuery = { proposalTemplates: Array<{ templateId: number, name: string, description: string | null | undefined, isArchived: boolean, questionaryCount: number, callCount: number }> | null | undefined };
...
export type GetTemplateQuery = { template: { isArchived: boolean, questionaryCount: number, templateId: number, groupId: TemplateGroupId, name: string, description: string | null | undefined, steps: Array<{ topic: { title: string, id: number, templateId: number, sortOrder: number, isEnabled: boolean }, fields: Array<{ sortOrder: number, topicId: number, dependenciesOperator: DependenciesLogicOperator | null | undefined, question: { id: string, question: string, naturalKey: string, dataType: DataType, categoryId: TemplateCategoryId, config: { small_label: string, required: boolean, tooltip: string } | { small_label: string, required: boolean, tooltip: string, minDate: string | null | undefined, maxDate: string | null | undefined, defaultDate: string | null | undefined, includeTime: boolean } | { html: string, plain: string, omitFromPdf: boolean } | { small_label: string, required: boolean, tooltip: string } | { file_type: Array<string>, max_files: number, small_label: string, required: boolean, tooltip: string } | { titlePlaceholder: string, questionLabel: string } | { units: Array<string> | null | undefined, small_label: string, required: boolean, tooltip: string } | { units: Array<string> | null | undefined, numberValueConstraint: NumberValueConstraint | null | undefined, small_label: string, required: boolean, tooltip: string } | { tooltip: string } | { tooltip: string } | { small_label: string, required: boolean, tooltip: string, max: number | null | undefined } | { titlePlaceholder: string } | { addEntryButtonLabel: string, minEntries: number | null | undefined, maxEntries: number | null | undefined, templateId: number | null | undefined, esiTemplateId: number | null | undefined, templateCategory: string, required: boolean, small_label: string } | { tooltip: string } | { variant: string, options: Array<string>, isMultipleSelect: boolean, small_label: string, required: boolean, tooltip: string } | { small_label: string, required: boolean, tooltip: string } | { addEntryButtonLabel: string, minEntries: number | null | undefined, maxEntries: number | null | undefined, templateId: number | null | undefined, templateCategory: string, required: boolean, small_label: string } | { min: number | null | undefined, max: number | null | undefined, multiline: boolean, placeholder: string, small_label: string, required: boolean, tooltip: string, htmlQuestion: string | null | undefined, isHtmlQuestion: boolean, isCounterHidden: boolean } | { small_label: string, required: boolean, tooltip: string } }, config: { small_label: string, required: boolean, tooltip: string } | { small_label: string, required: boolean, tooltip: string, minDate: string | null | undefined, maxDate: string | null | undefined, defaultDate: string | null | undefined, includeTime: boolean } | { html: string, plain: string, omitFromPdf: boolean } | { small_label: string, required: boolean, tooltip: string } | { file_type: Array<string>, max_files: number, small_label: string, required: boolean, tooltip: string } | { titlePlaceholder: string, questionLabel: string } | { units: Array<string> | null | undefined, small_label: string, required: boolean, tooltip: string } | { units: Array<string> | null | undefined, numberValueConstraint: NumberValueConstraint | null | undefined, small_label: string, required: boolean, tooltip: string } | { tooltip: string } | { tooltip: string } | { small_label: string, required: boolean, tooltip: string, max: number | null | undefined } | { titlePlaceholder: string } | { addEntryButtonLabel: string, minEntries: number | null | undefined, maxEntries: number | null | undefined, templateId: number | null | undefined, esiTemplateId: number | null | undefined, templateCategory: string, required: boolean, small_label: string } | { tooltip: string } | { variant: string, options: Array<string>, isMultipleSelect: boolean, small_label: string, required: boolean, tooltip: string } | { small_label: string, required: boolean, tooltip: string } | { addEntryButtonLabel: string, minEntries: number | null | undefined, maxEntries: number | null | undefined, templateId: number | null | undefined, templateCategory: string, required: boolean, small_label: string } | { min: number | null | undefined, max: number | null | undefined, multiline: boolean, placeholder: string, small_label: string, required: boolean, tooltip: string, htmlQuestion: string | null | undefined, isHtmlQuestion: boolean, isCounterHidden: boolean } | { small_label: string, required: boolean, tooltip: string }, dependencies: Array<{ questionId: string, dependencyId: string, dependencyNaturalKey: string, condition: { condition: EvaluatorOperator, params: any } }> }> }>, complementaryQuestions: Array<{ id: string, question: string, naturalKey: string, dataType: DataType, categoryId: TemplateCategoryId, config: { small_label: string, required: boolean, tooltip: string } | { small_label: string, required: boolean, tooltip: string, minDate: string | null | undefined, maxDate: string | null | undefined, defaultDate: string | null | undefined, includeTime: boolean } | { html: string, plain: string, omitFromPdf: boolean } | { small_label: string, required: boolean, tooltip: string } | { file_type: Array<string>, max_files: number, small_label: string, required: boolean, tooltip: string } | { titlePlaceholder: string, questionLabel: string } | { units: Array<string> | null | undefined, small_label: string, required: boolean, tooltip: string } | { units: Array<string> | null | undefined, numberValueConstraint: NumberValueConstraint | null | undefined, small_label: string, required: boolean, tooltip: string } | { tooltip: string } | { tooltip: string } | { small_label: string, required: boolean, tooltip: string, max: number | null | undefined } | { titlePlaceholder: string } | { addEntryButtonLabel: string, minEntries: number | null | undefined, maxEntries: number | null | undefined, templateId: number | null | undefined, esiTemplateId: number | null | undefined, templateCategory: string, required: boolean, small_label: string } | { tooltip: string } | { variant: string, options: Array<string>, isMultipleSelect: boolean, small_label: string, required: boolean, tooltip: string } | { small_label: string, required: boolean, tooltip: string } | { addEntryButtonLabel: string, minEntries: number | null | undefined, maxEntries: number | null | undefined, templateId: number | null | undefined, templateCategory: string, required: boolean, small_label: string } | { min: number | null | undefined, max: number | null | undefined, multiline: boolean, placeholder: string, small_label: string, required: boolean, tooltip: string, htmlQuestion: string | null | undefined, isHtmlQuestion: boolean, isCounterHidden: boolean } | { small_label: string, required: boolean, tooltip: string } }>, group: { groupId: TemplateGroupId, categoryId: TemplateCategoryId } } | null | undefined };

export type GetTemplateCategoriesQueryVariables = Exact<{ [key: string]: never; }>;


export type GetTemplateCategoriesQuery = { templateCategories: Array<{ categoryId: TemplateCategoryId, name: string }> | null | undefined };
...
export type GetTemplateExportQuery = { template: { json: string } | null | undefined };
...
export type GetTemplatesQuery = { templates: Array<{ templateId: number, name: string, description: string | null | undefined, isArchived: boolean, questionaryCount: number }> | null | undefined };
...
export type UpdateQuestionTemplateRelationMutation = { updateQuestionTemplateRelation: { template: { isArchived: boolean, questionaryCount: number, templateId: number, groupId: TemplateGroupId, name: string, description: string | null | undefined, steps: Array<{ topic: { title: string, id: number, templateId: number, sortOrder: number, isEnabled: boolean }, fields: Array<{ sortOrder: number, topicId: number, dependenciesOperator: DependenciesLogicOperator | null | undefined, question: { id: string, question: string, naturalKey: string, dataType: DataType, categoryId: TemplateCategoryId, config: { small_label: string, required: boolean, tooltip: string } | { small_label: string, required: boolean, tooltip: string, minDate: string | null | undefined, maxDate: string | null | undefined, defaultDate: string | null | undefined, includeTime: boolean } | { html: string, plain: string, omitFromPdf: boolean } | { small_label: string, required: boolean, tooltip: string } | { file_type: Array<string>, max_files: number, small_label: string, required: boolean, tooltip: string } | { titlePlaceholder: string, questionLabel: string } | { units: Array<string> | null | undefined, small_label: string, required: boolean, tooltip: string } | { units: Array<string> | null | undefined, numberValueConstraint: NumberValueConstraint | null | undefined, small_label: string, required: boolean, tooltip: string } | { tooltip: string } | { tooltip: string } | { small_label: string, required: boolean, tooltip: string, max: number | null | undefined } | { titlePlaceholder: string } | { addEntryButtonLabel: string, minEntries: number | null | undefined, maxEntries: number | null | undefined, templateId: number | null | undefined, esiTemplateId: number | null | undefined, templateCategory: string, required: boolean, small_label: string } | { tooltip: string } | { variant: string, options: Array<string>, isMultipleSelect: boolean, small_label: string, required: boolean, tooltip: string } | { small_label: string, required: boolean, tooltip: string } | { addEntryButtonLabel: string, minEntries: number | null | undefined, maxEntries: number | null | undefined, templateId: number | null | undefined, templateCategory: string, required: boolean, small_label: string } | { min: number | null | undefined, max: number | null | undefined, multiline: boolean, placeholder: string, small_label: string, required: boolean, tooltip: string, htmlQuestion: string | null | undefined, isHtmlQuestion: boolean, isCounterHidden: boolean } | { small_label: string, required: boolean, tooltip: string } }, config: { small_label: string, required: boolean, tooltip: string } | { small_label: string, required: boolean, tooltip: string, minDate: string | null | undefined, maxDate: string | null | undefined, defaultDate: string | null | undefined, includeTime: boolean } | { html: string, plain: string, omitFromPdf: boolean } | { small_label: string, required: boolean, tooltip: string } | { file_type: Array<string>, max_files: number, small_label: string, required: boolean, tooltip: string } | { titlePlaceholder: string, questionLabel: string } | { units: Array<string> | null | undefined, small_label: string, required: boolean, tooltip: string } | { units: Array<string> | null | undefined, numberValueConstraint: NumberValueConstraint | null | undefined, small_label: string, required: boolean, tooltip: string } | { tooltip: string } | { tooltip: string } | { small_label: string, required: boolean, tooltip: string, max: number | null | undefined } | { titlePlaceholder: string } | { addEntryButtonLabel: string, minEntries: number | null | undefined, maxEntries: number | null | undefined, templateId: number | null | undefined, esiTemplateId: number | null | undefined, templateCategory: string, required: boolean, small_label: string } | { tooltip: string } | { variant: string, options: Array<string>, isMultipleSelect: boolean, small_label: string, required: boolean, tooltip: string } | { small_label: string, required: boolean, tooltip: string } | { addEntryButtonLabel: string, minEntries: number | null | undefined, maxEntries: number | null | undefined, templateId: number | null | undefined, templateCategory: string, required: boolean, small_label: string } | { min: number | null | undefined, max: number | null | undefined, multiline: boolean, placeholder: string, small_label: string, required: boolean, tooltip: string, htmlQuestion: string | null | undefined, isHtmlQuestion: boolean, isCounterHidden: boolean } | { small_label: string, required: boolean, tooltip: string }, dependencies: Array<{ questionId: string, dependencyId: string, dependencyNaturalKey: string, condition: { condition: EvaluatorOperator, params: any } }> }> }>, complementaryQuestions: Array<{ id: string, question: string, naturalKey: string, dataType: DataType, categoryId: TemplateCategoryId, config: { small_label: string, required: boolean, tooltip: string } | { small_label: string, required: boolean, tooltip: string, minDate: string | null | undefined, maxDate: string | null | undefined, defaultDate: string | null | undefined, includeTime: boolean } | { html: string, plain: string, omitFromPdf: boolean } | { small_label: string, required: boolean, tooltip: string } | { file_type: Array<string>, max_files: number, small_label: string, required: boolean, tooltip: string } | { titlePlaceholder: string, questionLabel: string } | { units: Array<string> | null | undefined, small_label: string, required: boolean, tooltip: string } | { units: Array<string> | null | undefined, numberValueConstraint: NumberValueConstraint | null | undefined, small_label: string, required: boolean, tooltip: string } | { tooltip: string } | { tooltip: string } | { small_label: string, required: boolean, tooltip: string, max: number | null | undefined } | { titlePlaceholder: string } | { addEntryButtonLabel: string, minEntries: number | null | undefined, maxEntries: number | null | undefined, templateId: number | null | undefined, esiTemplateId: number | null | undefined, templateCategory: string, required: boolean, small_label: string } | { tooltip: string } | { variant: string, options: Array<string>, isMultipleSelect: boolean, small_label: string, required: boolean, tooltip: string } | { small_label: string, required: boolean, tooltip: string } | { addEntryButtonLabel: string, minEntries: number | null | undefined, maxEntries: number | null | undefined, templateId: number | null | undefined, templateCategory: string, required: boolean, small_label: string } | { min: number | null | undefined, max: number | null | undefined, multiline: boolean, placeholder: string, small_label: string, required: boolean, tooltip: string, htmlQuestion: string | null | undefined, isHtmlQuestion: boolean, isCounterHidden: boolean } | { small_label: string, required: boolean, tooltip: string } }>, group: { groupId: TemplateGroupId, categoryId: TemplateCategoryId } } | null | undefined, rejection: { reason: string, context: string | null | undefined, exception: string | null | undefined } | null | undefined } };
...
export type UpdateQuestionTemplateRelationSettingsMutation = { updateQuestionTemplateRelationSettings: { template: { isArchived: boolean, questionaryCount: number, templateId: number, groupId: TemplateGroupId, name: string, description: string | null | undefined, steps: Array<{ topic: { title: string, id: number, templateId: number, sortOrder: number, isEnabled: boolean }, fields: Array<{ sortOrder: number, topicId: number, dependenciesOperator: DependenciesLogicOperator | null | undefined, question: { id: string, question: string, naturalKey: string, dataType: DataType, categoryId: TemplateCategoryId, config: { small_label: string, required: boolean, tooltip: string } | { small_label: string, required: boolean, tooltip: string, minDate: string | null | undefined, maxDate: string | null | undefined, defaultDate: string | null | undefined, includeTime: boolean } | { html: string, plain: string, omitFromPdf: boolean } | { small_label: string, required: boolean, tooltip: string } | { file_type: Array<string>, max_files: number, small_label: string, required: boolean, tooltip: string } | { titlePlaceholder: string, questionLabel: string } | { units: Array<string> | null | undefined, small_label: string, required: boolean, tooltip: string } | { units: Array<string> | null | undefined, numberValueConstraint: NumberValueConstraint | null | undefined, small_label: string, required: boolean, tooltip: string } | { tooltip: string } | { tooltip: string } | { small_label: string, required: boolean, tooltip: string, max: number | null | undefined } | { titlePlaceholder: string } | { addEntryButtonLabel: string, minEntries: number | null | undefined, maxEntries: number | null | undefined, templateId: number | null | undefined, esiTemplateId: number | null | undefined, templateCategory: string, required: boolean, small_label: string } | { tooltip: string } | { variant: string, options: Array<string>, isMultipleSelect: boolean, small_label: string, required: boolean, tooltip: string } | { small_label: string, required: boolean, tooltip: string } | { addEntryButtonLabel: string, minEntries: number | null | undefined, maxEntries: number | null | undefined, templateId: number | null | undefined, templateCategory: string, required: boolean, small_label: string } | { min: number | null | undefined, max: number | null | undefined, multiline: boolean, placeholder: string, small_label: string, required: boolean, tooltip: string, htmlQuestion: string | null | undefined, isHtmlQuestion: boolean, isCounterHidden: boolean } | { small_label: string, required: boolean, tooltip: string } }, config: { small_label: string, required: boolean, tooltip: string } | { small_label: string, required: boolean, tooltip: string, minDate: string | null | undefined, maxDate: string | null | undefined, defaultDate: string | null | undefined, includeTime: boolean } | { html: string, plain: string, omitFromPdf: boolean } | { small_label: string, required: boolean, tooltip: string } | { file_type: Array<string>, max_files: number, small_label: string, required: boolean, tooltip: string } | { titlePlaceholder: string, questionLabel: string } | { units: Array<string> | null | undefined, small_label: string, required: boolean, tooltip: string } | { units: Array<string> | null | undefined, numberValueConstraint: NumberValueConstraint | null | undefined, small_label: string, required: boolean, tooltip: string } | { tooltip: string } | { tooltip: string } | { small_label: string, required: boolean, tooltip: string, max: number | null | undefined } | { titlePlaceholder: string } | { addEntryButtonLabel: string, minEntries: number | null | undefined, maxEntries: number | null | undefined, templateId: number | null | undefined, esiTemplateId: number | null | undefined, templateCategory: string, required: boolean, small_label: string } | { tooltip: string } | { variant: string, options: Array<string>, isMultipleSelect: boolean, small_label: string, required: boolean, tooltip: string } | { small_label: string, required: boolean, tooltip: string } | { addEntryButtonLabel: string, minEntries: number | null | undefined, maxEntries: number | null | undefined, templateId: number | null | undefined, templateCategory: string, required: boolean, small_label: string } | { min: number | null | undefined, max: number | null | undefined, multiline: boolean, placeholder: string, small_label: string, required: boolean, tooltip: string, htmlQuestion: string | null | undefined, isHtmlQuestion: boolean, isCounterHidden: boolean } | { small_label: string, required: boolean, tooltip: string }, dependencies: Array<{ questionId: string, dependencyId: string, dependencyNaturalKey: string, condition: { condition: EvaluatorOperator, params: any } }> }> }>, complementaryQuestions: Array<{ id: string, question: string, naturalKey: string, dataType: DataType, categoryId: TemplateCategoryId, config: { small_label: string, required: boolean, tooltip: string } | { small_label: string, required: boolean, tooltip: string, minDate: string | null | undefined, maxDate: string | null | undefined, defaultDate: string | null | undefined, includeTime: boolean } | { html: string, plain: string, omitFromPdf: boolean } | { small_label: string, required: boolean, tooltip: string } | { file_type: Array<string>, max_files: number, small_label: string, required: boolean, tooltip: string } | { titlePlaceholder: string, questionLabel: string } | { units: Array<string> | null | undefined, small_label: string, required: boolean, tooltip: string } | { units: Array<string> | null | undefined, numberValueConstraint: NumberValueConstraint | null | undefined, small_label: string, required: boolean, tooltip: string } | { tooltip: string } | { tooltip: string } | { small_label: string, required: boolean, tooltip: string, max: number | null | undefined } | { titlePlaceholder: string } | { addEntryButtonLabel: string, minEntries: number | null | undefined, maxEntries: number | null | undefined, templateId: number | null | undefined, esiTemplateId: number | null | undefined, templateCategory: string, required: boolean, small_label: string } | { tooltip: string } | { variant: string, options: Array<string>, isMultipleSelect: boolean, small_label: string, required: boolean, tooltip: string } | { small_label: string, required: boolean, tooltip: string } | { addEntryButtonLabel: string, minEntries: number | null | undefined, maxEntries: number | null | undefined, templateId: number | null | undefined, templateCategory: string, required: boolean, small_label: string } | { min: number | null | undefined, max: number | null | undefined, multiline: boolean, placeholder: string, small_label: string, required: boolean, tooltip: string, htmlQuestion: string | null | undefined, isHtmlQuestion: boolean, isCounterHidden: boolean } | { small_label: string, required: boolean, tooltip: string } }>, group: { groupId: TemplateGroupId, categoryId: TemplateCategoryId } } | null | undefined, rejection: { reason: string, context: string | null | undefined, exception: string | null | undefined } | null | undefined } };
...
export type UpdateTemplateMutation = { updateTemplate: { template: { templateId: number, name: string, description: string | null | undefined, isArchived: boolean, steps: Array<{ topic: { title: string, id: number, templateId: number, sortOrder: number, isEnabled: boolean } }> } | null | undefined, rejection: { reason: string, context: string | null | undefined, exception: string | null | undefined } | null | undefined } };
...
export type UpdateTopicMutation = { updateTopic: { template: { isArchived: boolean, questionaryCount: number, templateId: number, groupId: TemplateGroupId, name: string, description: string | null | undefined, steps: Array<{ topic: { title: string, id: number, templateId: number, sortOrder: number, isEnabled: boolean }, fields: Array<{ sortOrder: number, topicId: number, dependenciesOperator: DependenciesLogicOperator | null | undefined, question: { id: string, question: string, naturalKey: string, dataType: DataType, categoryId: TemplateCategoryId, config: { small_label: string, required: boolean, tooltip: string } | { small_label: string, required: boolean, tooltip: string, minDate: string | null | undefined, maxDate: string | null | undefined, defaultDate: string | null | undefined, includeTime: boolean } | { html: string, plain: string, omitFromPdf: boolean } | { small_label: string, required: boolean, tooltip: string } | { file_type: Array<string>, max_files: number, small_label: string, required: boolean, tooltip: string } | { titlePlaceholder: string, questionLabel: string } | { units: Array<string> | null | undefined, small_label: string, required: boolean, tooltip: string } | { units: Array<string> | null | undefined, numberValueConstraint: NumberValueConstraint | null | undefined, small_label: string, required: boolean, tooltip: string } | { tooltip: string } | { tooltip: string } | { small_label: string, required: boolean, tooltip: string, max: number | null | undefined } | { titlePlaceholder: string } | { addEntryButtonLabel: string, minEntries: number | null | undefined, maxEntries: number | null | undefined, templateId: number | null | undefined, esiTemplateId: number | null | undefined, templateCategory: string, required: boolean, small_label: string } | { tooltip: string } | { variant: string, options: Array<string>, isMultipleSelect: boolean, small_label: string, required: boolean, tooltip: string } | { small_label: string, required: boolean, tooltip: string } | { addEntryButtonLabel: string, minEntries: number | null | undefined, maxEntries: number | null | undefined, templateId: number | null | undefined, templateCategory: string, required: boolean, small_label: string } | { min: number | null | undefined, max: number | null | undefined, multiline: boolean, placeholder: string, small_label: string, required: boolean, tooltip: string, htmlQuestion: string | null | undefined, isHtmlQuestion: boolean, isCounterHidden: boolean } | { small_label: string, required: boolean, tooltip: string } }, config: { small_label: string, required: boolean, tooltip: string } | { small_label: string, required: boolean, tooltip: string, minDate: string | null | undefined, maxDate: string | null | undefined, defaultDate: string | null | undefined, includeTime: boolean } | { html: string, plain: string, omitFromPdf: boolean } | { small_label: string, required: boolean, tooltip: string } | { file_type: Array<string>, max_files: number, small_label: string, required: boolean, tooltip: string } | { titlePlaceholder: string, questionLabel: string } | { units: Array<string> | null | undefined, small_label: string, required: boolean, tooltip: string } | { units: Array<string> | null | undefined, numberValueConstraint: NumberValueConstraint | null | undefined, small_label: string, required: boolean, tooltip: string } | { tooltip: string } | { tooltip: string } | { small_label: string, required: boolean, tooltip: string, max: number | null | undefined } | { titlePlaceholder: string } | { addEntryButtonLabel: string, minEntries: number | null | undefined, maxEntries: number | null | undefined, templateId: number | null | undefined, esiTemplateId: number | null | undefined, templateCategory: string, required: boolean, small_label: string } | { tooltip: string } | { variant: string, options: Array<string>, isMultipleSelect: boolean, small_label: string, required: boolean, tooltip: string } | { small_label: string, required: boolean, tooltip: string } | { addEntryButtonLabel: string, minEntries: number | null | undefined, maxEntries: number | null | undefined, templateId: number | null | undefined, templateCategory: string, required: boolean, small_label: string } | { min: number | null | undefined, max: number | null | undefined, multiline: boolean, placeholder: string, small_label: string, required: boolean, tooltip: string, htmlQuestion: string | null | undefined, isHtmlQuestion: boolean, isCounterHidden: boolean } | { small_label: string, required: boolean, tooltip: string }, dependencies: Array<{ questionId: string, dependencyId: string, dependencyNaturalKey: string, condition: { condition: EvaluatorOperator, params: any } }> }> }>, complementaryQuestions: Array<{ id: string, question: string, naturalKey: string, dataType: DataType, categoryId: TemplateCategoryId, config: { small_label: string, required: boolean, tooltip: string } | { small_label: string, required: boolean, tooltip: string, minDate: string | null | undefined, maxDate: string | null | undefined, defaultDate: string | null | undefined, includeTime: boolean } | { html: string, plain: string, omitFromPdf: boolean } | { small_label: string, required: boolean, tooltip: string } | { file_type: Array<string>, max_files: number, small_label: string, required: boolean, tooltip: string } | { titlePlaceholder: string, questionLabel: string } | { units: Array<string> | null | undefined, small_label: string, required: boolean, tooltip: string } | { units: Array<string> | null | undefined, numberValueConstraint: NumberValueConstraint | null | undefined, small_label: string, required: boolean, tooltip: string } | { tooltip: string } | { tooltip: string } | { small_label: string, required: boolean, tooltip: string, max: number | null | undefined } | { titlePlaceholder: string } | { addEntryButtonLabel: string, minEntries: number | null | undefined, maxEntries: number | null | undefined, templateId: number | null | undefined, esiTemplateId: number | null | undefined, templateCategory: string, required: boolean, small_label: string } | { tooltip: string } | { variant: string, options: Array<string>, isMultipleSelect: boolean, small_label: string, required: boolean, tooltip: string } | { small_label: string, required: boolean, tooltip: string } | { addEntryButtonLabel: string, minEntries: number | null | undefined, maxEntries: number | null | undefined, templateId: number | null | undefined, templateCategory: string, required: boolean, small_label: string } | { min: number | null | undefined, max: number | null | undefined, multiline: boolean, placeholder: string, small_label: string, required: boolean, tooltip: string, htmlQuestion: string | null | undefined, isHtmlQuestion: boolean, isCounterHidden: boolean } | { small_label: string, required: boolean, tooltip: string } }>, group: { groupId: TemplateGroupId, categoryId: TemplateCategoryId } } | null | undefined, rejection: { reason: string, context: string | null | undefined, exception: string | null | undefined } | null | undefined } };
...
export type CreateUserMutation = { createUser: { user: { id: number } | null | undefined, rejection: { reason: string, context: string | null | undefined, exception: string | null | undefined } | null | undefined } };
...
export type CreateUserByEmailInviteMutation = { createUserByEmailInvite: { id: number | null | undefined, rejection: { reason: string, context: string | null | undefined, exception: string | null | undefined } | null | undefined } };
...
export type DeleteUserMutation = { deleteUser: { user: { id: number } | null | undefined, rejection: { reason: string, context: string | null | undefined, exception: string | null | undefined } | null | undefined } };
...
export type ExternalTokenLoginMutation = { externalTokenLogin: { token: string | null | undefined, rejection: { reason: string, context: string | null | undefined, exception: string | null | undefined } | null | undefined } };

export type BasicUserDetailsFragment = { id: number, firstname: string, lastname: string, preferredname: string | null | undefined, organisation: string, position: string, created: any | null | undefined, placeholder: boolean | null | undefined };
...
export type GetBasicUserDetailsQuery = { basicUserDetails: { id: number, firstname: string, lastname: string, preferredname: string | null | undefined, organisation: string, position: string, created: any | null | undefined, placeholder: boolean | null | undefined } | null | undefined };
...
export type GetBasicUserDetailsByEmailQuery = { basicUserDetailsByEmail: { id: number, firstname: string, lastname: string, preferredname: string | null | undefined, organisation: string, position: string, created: any | null | undefined, placeholder: boolean | null | undefined } | null | undefined };

export type GetFieldsQueryVariables = Exact<{ [key: string]: never; }>;


export type GetFieldsQuery = { getFields: { nationalities: Array<{ id: number, value: string }> } | null | undefined };

export type GetMyRolesQueryVariables = Exact<{ [key: string]: never; }>;


export type GetMyRolesQuery = { me: { firstname: string, lastname: string, roles: Array<{ id: number, shortCode: string, title: string }> } | null | undefined };
...
export type GetOrcIdInformationQuery = { getOrcIDInformation: { firstname: string | null | undefined, lastname: string | null | undefined, orcid: string | null | undefined, orcidHash: string | null | undefined, refreshToken: string | null | undefined, token: string | null | undefined } | null | undefined };
...
export type GetPreviousCollaboratorsQuery = { previousCollaborators: { totalCount: number, users: Array<{ id: number, firstname: string, lastname: string, preferredname: string | null | undefined, organisation: string, position: string, created: any | null | undefined, placeholder: boolean | null | undefined }> } | null | undefined };

export type GetRolesQueryVariables = Exact<{ [key: string]: never; }>;


export type GetRolesQuery = { roles: Array<{ id: number, shortCode: string, title: string }> | null | undefined };
...
export type GetTokenMutation = { token: { token: string | null | undefined, rejection: { reason: string, context: string | null | undefined, exception: string | null | undefined } | null | undefined } };
...
export type GetTokenForUserMutation = { getTokenForUser: { token: string | null | undefined, rejection: { reason: string, context: string | null | undefined, exception: string | null | undefined } | null | undefined } };
...
export type GetUserQuery = { user: { user_title: string, username: string, firstname: string, middlename: string | null | undefined, lastname: string, preferredname: string | null | undefined, gender: string, nationality: number | null | undefined, birthdate: string, organisation: number, department: string, position: string, email: string, telephone: string, telephone_alt: string | null | undefined, orcid: string, emailVerified: boolean, placeholder: boolean } | null | undefined };

export type GetUserMeQueryVariables = Exact<{ [key: string]: never; }>;


export type GetUserMeQuery = { me: { user_title: string, username: string, firstname: string, middlename: string | null | undefined, lastname: string, preferredname: string | null | undefined, gender: string, nationality: number | null | undefined, birthdate: string, organisation: number, department: string, position: string, email: string, telephone: string, telephone_alt: string | null | undefined, orcid: string, emailVerified: boolean, placeholder: boolean } | null | undefined };

export type GetUserProposalsQueryVariables = Exact<{ [key: string]: never; }>;


export type GetUserProposalsQuery = { me: { proposals: Array<{ primaryKey: number, proposalId: string, title: string, publicStatus: ProposalPublicStatus, statusId: number, created: any, finalStatus: ProposalEndStatus | null | undefined, notified: boolean, submitted: boolean, status: { id: number, shortCode: string, name: string, description: string, isDefault: boolean } | null | undefined, proposer: { id: number } | null | undefined, call: { id: number, shortCode: string, isActive: boolean, referenceNumberFormat: string | null | undefined } | null | undefined }> } | null | undefined };
...
export type GetUserWithRolesQuery = { user: { firstname: string, lastname: string, roles: Array<{ id: number, shortCode: string, title: string }> } | null | undefined };
...
export type GetUsersQuery = { users: { totalCount: number, users: Array<{ id: number, firstname: string, lastname: string, preferredname: string | null | undefined, organisation: string, position: string, created: any | null | undefined, placeholder: boolean | null | undefined }> } | null | undefined };
...
export type LoginMutation = { login: { token: string | null | undefined, rejection: { reason: string, context: string | null | undefined, exception: string | null | undefined } | null | undefined } };
...
export type LogoutMutation = { logout: { token: string | null | undefined, rejection: { reason: string, context: string | null | undefined, exception: string | null | undefined } | null | undefined } };
...
export type ResetPasswordMutation = { resetPassword: { rejection: { reason: string, context: string | null | undefined, exception: string | null | undefined } | null | undefined } };
...
export type ResetPasswordEmailMutation = { resetPasswordEmail: { isSuccess: boolean | null | undefined, rejection: { reason: string, context: string | null | undefined, exception: string | null | undefined } | null | undefined } };
...
export type SelectRoleMutation = { selectRole: { token: string | null | undefined, rejection: { reason: string, context: string | null | undefined, exception: string | null | undefined } | null | undefined } };
...
export type SetUserEmailVerifiedMutation = { setUserEmailVerified: { rejection: { reason: string, context: string | null | undefined, exception: string | null | undefined } | null | undefined } };
...
export type SetUserNotPlaceholderMutation = { setUserNotPlaceholder: { rejection: { reason: string, context: string | null | undefined, exception: string | null | undefined } | null | undefined } };
...
export type UpdatePasswordMutation = { updatePassword: { rejection: { reason: string, context: string | null | undefined, exception: string | null | undefined } | null | undefined } };
...
export type UpdateUserMutation = { updateUser: { user: { id: number } | null | undefined, rejection: { reason: string, context: string | null | undefined, exception: string | null | undefined } | null | undefined } };
...
export type UpdateUserRolesMutation = { updateUserRoles: { user: { id: number } | null | undefined, rejection: { reason: string, context: string | null | undefined, exception: string | null | undefined } | null | undefined } };
...
export type VerifyEmailMutation = { emailVerification: { success: boolean | null | undefined, rejection: { reason: string, context: string | null | undefined, exception: string | null | undefined } | null | undefined } };
...
export type CreateVisitMutation = { createVisit: { visit: { id: number, proposalPk: number, status: VisitStatus, creatorId: number, teamLead: { id: number, firstname: string, lastname: string, preferredname: string | null | undefined, organisation: string, position: string, created: any | null | undefined, placeholder: boolean | null | undefined }, registrations: Array<{ userId: number, visitId: number, registrationQuestionaryId: number | null | undefined, isRegistrationSubmitted: boolean, trainingExpiryDate: any | null | undefined, user: { id: number, firstname: string, lastname: string, preferredname: string | null | undefined, organisation: string, position: string, created: any | null | undefined, placeholder: boolean | null | undefined } }>, proposal: { primaryKey: number, title: string, abstract: string, statusId: number, publicStatus: ProposalPublicStatus, proposalId: string, finalStatus: ProposalEndStatus | null | undefined, commentForUser: string | null | undefined, commentForManagement: string | null | undefined, created: any, updated: any, callId: number, questionaryId: number, notified: boolean, submitted: boolean, managementTimeAllocation: number | null | undefined, managementDecisionSubmitted: boolean, technicalReviewAssignee: number | null | undefined, instrument: { name: string } | null | undefined, status: { id: number, shortCode: string, name: string, description: string, isDefault: boolean } | null | undefined, sepMeetingDecision: { proposalPk: number, recommendation: ProposalEndStatus | null | undefined, commentForUser: string | null | undefined, commentForManagement: string | null | undefined, rankOrder: number | null | undefined, submitted: boolean, submittedBy: number | null | undefined } | null | undefined }, shipments: Array<{ id: number, title: string, proposalPk: number, status: ShipmentStatus, externalRef: string | null | undefined, questionaryId: number, visitId: number, creatorId: number, created: any, proposal: { proposalId: string } }> } | null | undefined, rejection: { reason: string, context: string | null | undefined, exception: string | null | undefined } | null | undefined } };
...
export type DeleteVisitMutation = { deleteVisit: { visit: { id: number, proposalPk: number, status: VisitStatus, creatorId: number } | null | undefined, rejection: { reason: string, context: string | null | undefined, exception: string | null | undefined } | null | undefined } };
...
export type UpdateVisitMutation = { updateVisit: { visit: { id: number, proposalPk: number, status: VisitStatus, creatorId: number, teamLead: { id: number, firstname: string, lastname: string, preferredname: string | null | undefined, organisation: string, position: string, created: any | null | undefined, placeholder: boolean | null | undefined }, registrations: Array<{ userId: number, visitId: number, registrationQuestionaryId: number | null | undefined, isRegistrationSubmitted: boolean, trainingExpiryDate: any | null | undefined, user: { id: number, firstname: string, lastname: string, preferredname: string | null | undefined, organisation: string, position: string, created: any | null | undefined, placeholder: boolean | null | undefined } }>, proposal: { primaryKey: number, title: string, abstract: string, statusId: number, publicStatus: ProposalPublicStatus, proposalId: string, finalStatus: ProposalEndStatus | null | undefined, commentForUser: string | null | undefined, commentForManagement: string | null | undefined, created: any, updated: any, callId: number, questionaryId: number, notified: boolean, submitted: boolean, managementTimeAllocation: number | null | undefined, managementDecisionSubmitted: boolean, technicalReviewAssignee: number | null | undefined, instrument: { name: string } | null | undefined, status: { id: number, shortCode: string, name: string, description: string, isDefault: boolean } | null | undefined, sepMeetingDecision: { proposalPk: number, recommendation: ProposalEndStatus | null | undefined, commentForUser: string | null | undefined, commentForManagement: string | null | undefined, rankOrder: number | null | undefined, submitted: boolean, submittedBy: number | null | undefined } | null | undefined }, shipments: Array<{ id: number, title: string, proposalPk: number, status: ShipmentStatus, externalRef: string | null | undefined, questionaryId: number, visitId: number, creatorId: number, created: any, proposal: { proposalId: string } }> } | null | undefined, rejection: { reason: string, context: string | null | undefined, exception: string | null | undefined } | null | undefined } };
...
export type CreateVisitRegistrationQuestionaryMutation = { createVisitRegistrationQuestionary: { registration: { userId: number, visitId: number, registrationQuestionaryId: number | null | undefined, isRegistrationSubmitted: boolean, trainingExpiryDate: any | null | undefined, user: { id: number, firstname: string, lastname: string, preferredname: string | null | undefined, organisation: string, position: string, created: any | null | undefined, placeholder: boolean | null | undefined }, questionary: { isCompleted: boolean, questionaryId: number, templateId: number, created: any, steps: Array<{ isCompleted: boolean, topic: { title: string, id: number, templateId: number, sortOrder: number, isEnabled: boolean }, fields: Array<{ answerId: number | null | undefined, sortOrder: number, topicId: number, dependenciesOperator: DependenciesLogicOperator | null | undefined, value: any | null | undefined, question: { id: string, question: string, naturalKey: string, dataType: DataType, categoryId: TemplateCategoryId, config: { small_label: string, required: boolean, tooltip: string } | { small_label: string, required: boolean, tooltip: string, minDate: string | null | undefined, maxDate: string | null | undefined, defaultDate: string | null | undefined, includeTime: boolean } | { html: string, plain: string, omitFromPdf: boolean } | { small_label: string, required: boolean, tooltip: string } | { file_type: Array<string>, max_files: number, small_label: string, required: boolean, tooltip: string } | { titlePlaceholder: string, questionLabel: string } | { units: Array<string> | null | undefined, small_label: string, required: boolean, tooltip: string } | { units: Array<string> | null | undefined, numberValueConstraint: NumberValueConstraint | null | undefined, small_label: string, required: boolean, tooltip: string } | { tooltip: string } | { tooltip: string } | { small_label: string, required: boolean, tooltip: string, max: number | null | undefined } | { titlePlaceholder: string } | { addEntryButtonLabel: string, minEntries: number | null | undefined, maxEntries: number | null | undefined, templateId: number | null | undefined, esiTemplateId: number | null | undefined, templateCategory: string, required: boolean, small_label: string } | { tooltip: string } | { variant: string, options: Array<string>, isMultipleSelect: boolean, small_label: string, required: boolean, tooltip: string } | { small_label: string, required: boolean, tooltip: string } | { addEntryButtonLabel: string, minEntries: number | null | undefined, maxEntries: number | null | undefined, templateId: number | null | undefined, templateCategory: string, required: boolean, small_label: string } | { min: number | null | undefined, max: number | null | undefined, multiline: boolean, placeholder: string, small_label: string, required: boolean, tooltip: string, htmlQuestion: string | null | undefined, isHtmlQuestion: boolean, isCounterHidden: boolean } | { small_label: string, required: boolean, tooltip: string } }, config: { small_label: string, required: boolean, tooltip: string } | { small_label: string, required: boolean, tooltip: string, minDate: string | null | undefined, maxDate: string | null | undefined, defaultDate: string | null | undefined, includeTime: boolean } | { html: string, plain: string, omitFromPdf: boolean } | { small_label: string, required: boolean, tooltip: string } | { file_type: Array<string>, max_files: number, small_label: string, required: boolean, tooltip: string } | { titlePlaceholder: string, questionLabel: string } | { units: Array<string> | null | undefined, small_label: string, required: boolean, tooltip: string } | { units: Array<string> | null | undefined, numberValueConstraint: NumberValueConstraint | null | undefined, small_label: string, required: boolean, tooltip: string } | { tooltip: string } | { tooltip: string } | { small_label: string, required: boolean, tooltip: string, max: number | null | undefined } | { titlePlaceholder: string } | { addEntryButtonLabel: string, minEntries: number | null | undefined, maxEntries: number | null | undefined, templateId: number | null | undefined, esiTemplateId: number | null | undefined, templateCategory: string, required: boolean, small_label: string } | { tooltip: string } | { variant: string, options: Array<string>, isMultipleSelect: boolean, small_label: string, required: boolean, tooltip: string } | { small_label: string, required: boolean, tooltip: string } | { addEntryButtonLabel: string, minEntries: number | null | undefined, maxEntries: number | null | undefined, templateId: number | null | undefined, templateCategory: string, required: boolean, small_label: string } | { min: number | null | undefined, max: number | null | undefined, multiline: boolean, placeholder: string, small_label: string, required: boolean, tooltip: string, htmlQuestion: string | null | undefined, isHtmlQuestion: boolean, isCounterHidden: boolean } | { small_label: string, required: boolean, tooltip: string }, dependencies: Array<{ questionId: string, dependencyId: string, dependencyNaturalKey: string, condition: { condition: EvaluatorOperator, params: any } }> }> }> } } | null | undefined, rejection: { reason: string, context: string | null | undefined, exception: string | null | undefined } | null | undefined } };

export type VisitRegistrationFragment = { userId: number, visitId: number, registrationQuestionaryId: number | null | undefined, isRegistrationSubmitted: boolean, trainingExpiryDate: any | null | undefined };
...
export type GetVisitRegistrationQuery = { visitRegistration: { userId: number, visitId: number, registrationQuestionaryId: number | null | undefined, isRegistrationSubmitted: boolean, trainingExpiryDate: any | null | undefined, user: { id: number, firstname: string, lastname: string, preferredname: string | null | undefined, organisation: string, position: string, created: any | null | undefined, placeholder: boolean | null | undefined }, questionary: { isCompleted: boolean, questionaryId: number, templateId: number, created: any, steps: Array<{ isCompleted: boolean, topic: { title: string, id: number, templateId: number, sortOrder: number, isEnabled: boolean }, fields: Array<{ answerId: number | null | undefined, sortOrder: number, topicId: number, dependenciesOperator: DependenciesLogicOperator | null | undefined, value: any | null | undefined, question: { id: string, question: string, naturalKey: string, dataType: DataType, categoryId: TemplateCategoryId, config: { small_label: string, required: boolean, tooltip: string } | { small_label: string, required: boolean, tooltip: string, minDate: string | null | undefined, maxDate: string | null | undefined, defaultDate: string | null | undefined, includeTime: boolean } | { html: string, plain: string, omitFromPdf: boolean } | { small_label: string, required: boolean, tooltip: string } | { file_type: Array<string>, max_files: number, small_label: string, required: boolean, tooltip: string } | { titlePlaceholder: string, questionLabel: string } | { units: Array<string> | null | undefined, small_label: string, required: boolean, tooltip: string } | { units: Array<string> | null | undefined, numberValueConstraint: NumberValueConstraint | null | undefined, small_label: string, required: boolean, tooltip: string } | { tooltip: string } | { tooltip: string } | { small_label: string, required: boolean, tooltip: string, max: number | null | undefined } | { titlePlaceholder: string } | { addEntryButtonLabel: string, minEntries: number | null | undefined, maxEntries: number | null | undefined, templateId: number | null | undefined, esiTemplateId: number | null | undefined, templateCategory: string, required: boolean, small_label: string } | { tooltip: string } | { variant: string, options: Array<string>, isMultipleSelect: boolean, small_label: string, required: boolean, tooltip: string } | { small_label: string, required: boolean, tooltip: string } | { addEntryButtonLabel: string, minEntries: number | null | undefined, maxEntries: number | null | undefined, templateId: number | null | undefined, templateCategory: string, required: boolean, small_label: string } | { min: number | null | undefined, max: number | null | undefined, multiline: boolean, placeholder: string, small_label: string, required: boolean, tooltip: string, htmlQuestion: string | null | undefined, isHtmlQuestion: boolean, isCounterHidden: boolean } | { small_label: string, required: boolean, tooltip: string } }, config: { small_label: string, required: boolean, tooltip: string } | { small_label: string, required: boolean, tooltip: string, minDate: string | null | undefined, maxDate: string | null | undefined, defaultDate: string | null | undefined, includeTime: boolean } | { html: string, plain: string, omitFromPdf: boolean } | { small_label: string, required: boolean, tooltip: string } | { file_type: Array<string>, max_files: number, small_label: string, required: boolean, tooltip: string } | { titlePlaceholder: string, questionLabel: string } | { units: Array<string> | null | undefined, small_label: string, required: boolean, tooltip: string } | { units: Array<string> | null | undefined, numberValueConstraint: NumberValueConstraint | null | undefined, small_label: string, required: boolean, tooltip: string } | { tooltip: string } | { tooltip: string } | { small_label: string, required: boolean, tooltip: string, max: number | null | undefined } | { titlePlaceholder: string } | { addEntryButtonLabel: string, minEntries: number | null | undefined, maxEntries: number | null | undefined, templateId: number | null | undefined, esiTemplateId: number | null | undefined, templateCategory: string, required: boolean, small_label: string } | { tooltip: string } | { variant: string, options: Array<string>, isMultipleSelect: boolean, small_label: string, required: boolean, tooltip: string } | { small_label: string, required: boolean, tooltip: string } | { addEntryButtonLabel: string, minEntries: number | null | undefined, maxEntries: number | null | undefined, templateId: number | null | undefined, templateCategory: string, required: boolean, small_label: string } | { min: number | null | undefined, max: number | null | undefined, multiline: boolean, placeholder: string, small_label: string, required: boolean, tooltip: string, htmlQuestion: string | null | undefined, isHtmlQuestion: boolean, isCounterHidden: boolean } | { small_label: string, required: boolean, tooltip: string }, dependencies: Array<{ questionId: string, dependencyId: string, dependencyNaturalKey: string, condition: { condition: EvaluatorOperator, params: any } }> }> }> } } | null | undefined };
...
export type UpdateVisitRegistrationMutation = { updateVisitRegistration: { registration: { userId: number, visitId: number, registrationQuestionaryId: number | null | undefined, isRegistrationSubmitted: boolean, trainingExpiryDate: any | null | undefined } | null | undefined, rejection: { reason: string, context: string | null | undefined, exception: string | null | undefined } | null | undefined } };
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    ...
    createVisitRegistrationQuestionary(variables: CreateVisitRegistrationQuestionaryMutationVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<CreateVisitRegistrationQuestionaryMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<CreateVisitRegistrationQuestionaryMutation>(CreateVisitRegistrationQuestionaryDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'createVisitRegistrationQuestionary');
    },

...
export type TemplateImportWithValidation = {
  ...
  subTemplatesWithValidation: Array<TemplateImportWithValidationWithoutSubTemplates>;
  version: Scalars['String'];
};

export type TemplateImportWithValidationWithoutSubTemplates = {
  errors: Array<Scalars['String']>;
  exportDate: Scalars['DateTime'];
  isValid: Scalars['Boolean'];
  json: Scalars['String'];

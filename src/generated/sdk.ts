...
export type AddClientLogMutation = { __typename?: 'Mutation' } & {
  addClientLog: { __typename?: 'SuccessResponseWrap' } & Pick<
    SuccessResponseWrap,
    'isSuccess' | 'error'
  >;
};
...
export type GetPageContentQuery = { __typename?: 'Query' } & Pick<
  Query,
  'getPageContent'
>;
...
export type SetPageContentMutation = { __typename?: 'Mutation' } & {
  setPageContent: { __typename?: 'PageResponseWrap' } & Pick<
    PageResponseWrap,
    'error'
  > & { page: Maybe<{ __typename?: 'Page' } & Pick<Page, 'id' | 'content'>> };
};
...
export type CreateCallMutation = { __typename?: 'Mutation' } & {
  createCall: { __typename?: 'CallResponseWrap' } & Pick<
    CallResponseWrap,
    'error'
  > & { call: Maybe<{ __typename?: 'Call' } & Pick<Call, 'id'>> };
};

export type GetCallsQueryVariables = {};

export type GetCallsQuery = { __typename?: 'Query' } & {
  calls: Maybe<
    Array<
      { __typename?: 'Call' } & Pick<
        Call,
        'id' | 'shortCode' | 'startCall' | 'endCall'
      >
    >
  >;
};
...
export type GetEventLogsQuery = { __typename?: 'Query' } & {
  eventLogs: Maybe<
    Array<
      { __typename?: 'EventLog' } & Pick<
        EventLog,
        'id' | 'eventType' | 'eventTStamp' | 'rowData' | 'changedObjectId'
      > & {
          changedBy: { __typename?: 'User' } & Pick<
            User,
...
export type CreateProposalMutation = { __typename?: 'Mutation' } & {
  createProposal: { __typename?: 'ProposalResponseWrap' } & Pick<
...
export type CreateTemplateFieldMutation = { __typename?: 'Mutation' } & {
  createTemplateField: { __typename?: 'TemplateFieldResponseWrap' } & Pick<
    TemplateFieldResponseWrap,
    'error'
  > & {
      field: Maybe<
        { __typename?: 'ProposalTemplateField' } & ProposalTemplateFieldFragment
      >;
    };
};
...
export type CreateTopicMutation = { __typename?: 'Mutation' } & {
  createTopic: { __typename?: 'ProposalTemplateResponseWrap' } & Pick<
...
export type DeleteProposalMutation = { __typename?: 'Mutation' } & {
  deleteProposal: { __typename?: 'ProposalResponseWrap' } & {
    proposal: Maybe<{ __typename?: 'Proposal' } & Pick<Proposal, 'id'>>;
  };
};
...
export type DeleteTemplateFieldMutation = { __typename?: 'Mutation' } & {
  deleteTemplateField: { __typename?: 'ProposalTemplateResponseWrap' } & Pick<
    ProposalTemplateResponseWrap,
    'error'
  > & {
      template: Maybe<
...
export type DeleteTopicMutation = { __typename?: 'Mutation' } & {
  deleteTopic: { __typename?: 'ProposalTemplateResponseWrap' } & Pick<
    ProposalTemplateResponseWrap,
    'error'
  >;
};

export type FieldConditionFragment = { __typename?: 'FieldCondition' } & Pick<
  FieldCondition,
  'condition' | 'params'
>;

type FieldConfigBooleanConfigFragment = { __typename?: 'BooleanConfig' } & Pick<
  BooleanConfig,
  'small_label' | 'required' | 'tooltip'
>;

type FieldConfigDateConfigFragment = { __typename?: 'DateConfig' } & Pick<
  DateConfig,
  'small_label' | 'required' | 'tooltip'
>;
...
type FieldConfigEmbellishmentConfigFragment = {
  ...
  EmbellishmentConfig,
  'html' | 'plain' | 'small_label' | 'required' | 'tooltip' | 'omitFromPdf'
>;
...
type FieldConfigFileUploadConfigFragment = {
  ...
  FileUploadConfig,
  'file_type' | 'max_files' | 'small_label' | 'required' | 'tooltip'
>;
...
type FieldConfigSelectionFromOptionsConfigFragment = {
  ...
  SelectionFromOptionsConfig,
  'variant' | 'options' | 'small_label' | 'required' | 'tooltip'
>;
...
> & {
    config:
      | ({ __typename?: 'BooleanConfig' } & FieldConfigBooleanConfigFragment)
      | ({ __typename?: 'DateConfig' } & FieldConfigDateConfigFragment)
      | ({
          __typename?: 'EmbellishmentConfig';
        } & FieldConfigEmbellishmentConfigFragment)
      | ({
    ...
    dependencies: Maybe<
      Array<
        { __typename?: 'FieldDependency' } & Pick<
          FieldDependency,
          'question_id' | 'dependency_id' | 'dependency_natural_key'
        > & {
            condition: {
              __typename?: 'FieldCondition';
...
export type QuestionaryFragment = { __typename?: 'Questionary' } & {
  steps: Array<
    { __typename?: 'QuestionaryStep' } & Pick<
      QuestionaryStep,
      'isCompleted'
    > & {
        topic: { __typename?: 'Topic' } & Pick<
          Topic,
          'topic_title' | 'topic_id' | 'sort_order' | 'is_enabled'
        >;
        fields: Array<
          { __typename?: 'QuestionaryField' } & Pick<
            QuestionaryField,
            | 'proposal_question_id'
            | 'natural_key'
            | 'data_type'
...
export type GetBlankProposalQuery = { __typename?: 'Query' } & {
  blankProposal: Maybe<
    { __typename?: 'Proposal' } & Pick<
      Proposal,
      | 'id'
    ...
    > & {
        ...
        questionary: { __typename?: 'Questionary' } & QuestionaryFragment;
        users: Array<
          { __typename?: 'BasicUserDetails' } & BasicUserDetailsFragment
        >;
        reviews: Array<
          { __typename?: 'Review' } & Pick<
            Review,
            'id' | 'grade' | 'comment' | 'status' | 'userID'
          > & {
              reviewer: Maybe<
...
export type GetFileMetadataQuery = { __typename?: 'Query' } & {
  fileMetadata: Maybe<
    Array<
      { __typename?: 'FileMetadata' } & Pick<
        FileMetadata,
        | 'fileId'
        | 'originalFileName'
        | 'mimeType'
...
export type GetIsNaturalKeyPresentQuery = { __typename?: 'Query' } & Pick<
  Query,
  'isNaturalKeyPresent'
>;
  ...
  proposal: Maybe<
    ...
    > & {
        ...
        technicalReview: Maybe<
          { __typename?: 'TechnicalReview' } & Pick<
            TechnicalReview,
            'id' | 'comment' | 'timeAllocation' | 'status' | 'proposalID'
          >
        >;
        reviews: Array<
          { __typename?: 'Review' } & Pick<
...
export type GetProposalTemplateQuery = { __typename?: 'Query' } & {
...
export type GetProposalsQuery = { __typename?: 'Query' } & {
  proposals: Maybe<
    { __typename?: 'ProposalsQueryResult' } & Pick<
...
export type SubmitProposalMutation = { __typename?: 'Mutation' } & {
  submitProposal: { __typename?: 'ProposalResponseWrap' } & Pick<
    ProposalResponseWrap,
    'error'
  > & { proposal: Maybe<{ __typename?: 'Proposal' } & Pick<Proposal, 'id'>> };
};
...
export type UpdateFieldTopicRelMutation = { __typename?: 'Mutation' } & {
  updateFieldTopicRel: {
    __typename?: 'UpdateFieldTopicRelResponseWrap';
...
export type UpdateProposalMutation = { __typename?: 'Mutation' } & {
  updateProposal: { __typename?: 'ProposalResponseWrap' } & Pick<
    ProposalResponseWrap,
    'error'
  > & { proposal: Maybe<{ __typename?: 'Proposal' } & Pick<Proposal, 'id'>> };
};
...
export type UpdateProposalFilesMutation = { __typename?: 'Mutation' } & {
  updateProposalFiles: {
    __typename?: 'UpdateProposalFilesResponseWrap';
...
export type UpdateTopicMutation = { __typename?: 'Mutation' } & {
  updateTopic: { __typename?: 'TopicResponseWrap' } & Pick<
    TopicResponseWrap,
    'error'
  > & { topic: Maybe<{ __typename?: 'Topic' } & TopicFragment> };
};
...
export type UpdateTopicOrderMutation = { __typename?: 'Mutation' } & {
  updateTopicOrder: { __typename?: 'UpdateTopicOrderResponseWrap' } & Pick<
...
export type AddReviewMutation = { __typename?: 'Mutation' } & {
  addReview: { __typename?: 'ReviewResponseWrap' } & Pick<
    ReviewResponseWrap,
    'error'
  > & { review: Maybe<{ __typename?: 'Review' } & CoreReviewFragment> };
};
...
export type AddTechnicalReviewMutation = { __typename?: 'Mutation' } & {
  addTechnicalReview: { __typename?: 'TechnicalReviewResponseWrap' } & Pick<
    TechnicalReviewResponseWrap,
    'error'
  > & {
      technicalReview: Maybe<
        { __typename?: 'TechnicalReview' } & Pick<TechnicalReview, 'id'>
      >;
    };
};
...
export type AddUserForReviewMutation = { __typename?: 'Mutation' } & {
  addUserForReview: { __typename?: 'ReviewResponseWrap' } & Pick<
    ReviewResponseWrap,
    'error'
  >;
};

export type CoreReviewFragment = { __typename?: 'Review' } & Pick<
  Review,
  'id' | 'userID' | 'status' | 'comment' | 'grade'
>;
    ...
    { __typename?: 'Review' } & {
      proposal: Maybe<
        { __typename?: 'Proposal' } & Pick<
          ...
          'id' | 'title' | 'abstract'
        > & {
            proposer: { __typename?: 'BasicUserDetails' } & Pick<
              BasicUserDetails,
              'id'
            >;
          }
...
export type RemoveUserForReviewMutation = { __typename?: 'Mutation' } & {
  removeUserForReview: { __typename?: 'ReviewResponseWrap' } & Pick<
    ReviewResponseWrap,
    'error'
  >;
};
...
export type UserWithReviewsQuery = { __typename?: 'Query' } & {
  user: Maybe<
    { __typename?: 'User' } & Pick<
      User,
...
export type CreateUserMutation = { __typename?: 'Mutation' } & {
  createUser: { __typename?: 'UserResponseWrap' } & Pick<
    UserResponseWrap,
    'error'
...
export type CreateUserByEmailInviteMutation = { __typename?: 'Mutation' } & {
...
export type BasicUserDetailsFragment = {
  ...
  BasicUserDetails,
  'id' | 'firstname' | 'lastname' | 'organisation' | 'position'
>;
...
export type GetBasicUserDetailsQuery = { __typename?: 'Query' } & {
...
export type GetFieldsQuery = { __typename?: 'Query' } & {
  getFields: Maybe<
    { __typename?: 'Fields' } & {
      institutions: Array<
        { __typename?: 'Entry' } & Pick<Entry, 'id' | 'value'>
      >;
      nationalities: Array<
        { __typename?: 'Entry' } & Pick<Entry, 'id' | 'value'>
      >;
...
export type GetOrcIdInformationQuery = { __typename?: 'Query' } & {
  getOrcIDInformation: Maybe<
    { __typename?: 'OrcIDInformation' } & Pick<
      OrcIdInformation,
      | 'firstname'
      | 'lastname'
      | 'orcid'
...
export type GetRolesQuery = { __typename?: 'Query' } & {
  roles: Maybe<
    Array<{ __typename?: 'Role' } & Pick<Role, 'id' | 'shortCode' | 'title'>>
  >;
};
...
export type GetTokenMutation = { __typename?: 'Mutation' } & {
  token: { __typename?: 'TokenResponseWrap' } & Pick<
    TokenResponseWrap,
    'token' | 'error'
  >;
};
...
export type GetTokenForUserMutation = { __typename?: 'Mutation' } & {
  getTokenForUser: { __typename?: 'TokenResponseWrap' } & Pick<
    TokenResponseWrap,
    'token' | 'error'
  >;
};
...
export type GetUserProposalsQuery = { __typename?: 'Query' } & {
  user: Maybe<
    { __typename?: 'User' } & {
      proposals: Array<
        { __typename?: 'Proposal' } & Pick<
          Proposal,
          'id' | 'shortCode' | 'title' | 'status' | 'created'
        >
      >;
    }
  >;
...
export type GetUserWithRolesQuery = { __typename?: 'Query' } & {
  user: Maybe<
    { __typename?: 'User' } & Pick<User, 'firstname' | 'lastname'> & {
        roles: Array<
          { __typename?: 'Role' } & Pick<Role, 'id' | 'shortCode' | 'title'>
        >;
      }
  >;
};
...
export type GetUsersQuery = { __typename?: 'Query' } & {
  users: Maybe<
    { __typename?: 'UserQueryResult' } & Pick<UserQueryResult, 'totalCount'> & {
        users: Array<
          { __typename?: 'BasicUserDetails' } & BasicUserDetailsFragment
        >;
      }
...
export type LoginMutation = { __typename?: 'Mutation' } & {
  login: { __typename?: 'TokenResponseWrap' } & Pick<
    TokenResponseWrap,
    'token' | 'error'
  >;
};
...
export type ResetPasswordMutation = { __typename?: 'Mutation' } & {
  resetPassword: { __typename?: 'BasicUserDetailsResponseWrap' } & Pick<
...
export type ResetPasswordEmailMutation = { __typename?: 'Mutation' } & {
  resetPasswordEmail: { __typename?: 'ResetPasswordEmailResponseWrap' } & Pick<
...
export type UpdatePasswordMutation = { __typename?: 'Mutation' } & {
  updatePassword: { __typename?: 'BasicUserDetailsResponseWrap' } & Pick<
    BasicUserDetailsResponseWrap,
    'error'
  >;
};
...
export type UpdateUserMutation = { __typename?: 'Mutation' } & {
  updateUser: { __typename?: 'UserResponseWrap' } & Pick<
    UserResponseWrap,
    'error'
  > & { user: Maybe<{ __typename?: 'User' } & Pick<User, 'id'>> };
};
...
export type UpdateUserRolesMutation = { __typename?: 'Mutation' } & {
  updateUser: { __typename?: 'UserResponseWrap' } & Pick<
    UserResponseWrap,
    'error'
  > & { user: Maybe<{ __typename?: 'User' } & Pick<User, 'id'>> };
...
export type VerifyEmailMutation = { __typename?: 'Mutation' } & {
  emailVerification: { __typename?: 'EmailVerificationResponseWrap' } & Pick<
...
export const UpdateProposalTemplateFieldDocument = gql`
  mutation updateProposalTemplateField(
    $id: String!
    $naturalKey: String
    $question: String
    $config: String
...
export function getSdk(client: GraphQLClient) {
  return {
    addClientLog(
      ...
      return client.request<AddClientLogMutation>(
        print(AddClientLogDocument),
        variables
      );
    },
    getPageContent(
      ...
      return client.request<GetPageContentQuery>(
        print(GetPageContentDocument),
        variables
      );
    },
    setPageContent(
      ...
      return client.request<SetPageContentMutation>(
        print(SetPageContentDocument),
        variables
      );
    },
    createCall(
      ...
      return client.request<CreateCallMutation>(
        print(CreateCallDocument),
        variables
      );
    },
    ...
    getEventLogs(
      ...
      return client.request<GetEventLogsQuery>(
        print(GetEventLogsDocument),
        variables
      );
    },
    createProposal(
      ...
      return client.request<CreateProposalMutation>(
        print(CreateProposalDocument),
        variables
      );
    },
    createTemplateField(
      variables: CreateTemplateFieldMutationVariables
    ): Promise<CreateTemplateFieldMutation> {
      return client.request<CreateTemplateFieldMutation>(
        print(CreateTemplateFieldDocument),
        variables
      );
    },
    createTopic(
      ...
      return client.request<CreateTopicMutation>(
        print(CreateTopicDocument),
        variables
      );
    },
    deleteProposal(
      ...
      return client.request<DeleteProposalMutation>(
        print(DeleteProposalDocument),
        variables
      );
    },
    deleteTemplateField(
      variables: DeleteTemplateFieldMutationVariables
    ): Promise<DeleteTemplateFieldMutation> {
      return client.request<DeleteTemplateFieldMutation>(
        print(DeleteTemplateFieldDocument),
        variables
      );
    },
    deleteTopic(
      ...
      return client.request<DeleteTopicMutation>(
        print(DeleteTopicDocument),
        variables
      );
    },
    getBlankProposal(
      variables?: GetBlankProposalQueryVariables
    ): Promise<GetBlankProposalQuery> {
      return client.request<GetBlankProposalQuery>(
        print(GetBlankProposalDocument),
        variables
      );
    },
    getFileMetadata(
      ...
      return client.request<GetFileMetadataQuery>(
        print(GetFileMetadataDocument),
        variables
      );
    },
    getIsNaturalKeyPresent(
      ...
      return client.request<GetIsNaturalKeyPresentQuery>(
        print(GetIsNaturalKeyPresentDocument),
        variables
      );
    },
    getProposal(
      ...
      return client.request<GetProposalQuery>(
        print(GetProposalDocument),
        variables
      );
    },
    getProposalTemplate(
      variables?: GetProposalTemplateQueryVariables
    ): Promise<GetProposalTemplateQuery> {
      return client.request<GetProposalTemplateQuery>(
        print(GetProposalTemplateDocument),
        variables
      );
    },
    getProposals(
      ...
      return client.request<GetProposalsQuery>(
        print(GetProposalsDocument),
        variables
      );
    },
    submitProposal(
      ...
      return client.request<SubmitProposalMutation>(
        print(SubmitProposalDocument),
        variables
      );
    },
    updateFieldTopicRel(
      variables: UpdateFieldTopicRelMutationVariables
    ): Promise<UpdateFieldTopicRelMutation> {
      return client.request<UpdateFieldTopicRelMutation>(
        print(UpdateFieldTopicRelDocument),
        variables
      );
    },
    updateProposal(
      ...
      return client.request<UpdateProposalMutation>(
        print(UpdateProposalDocument),
        variables
      );
    },
    updateProposalFiles(
      variables: UpdateProposalFilesMutationVariables
    ): Promise<UpdateProposalFilesMutation> {
      return client.request<UpdateProposalFilesMutation>(
        print(UpdateProposalFilesDocument),
        variables
      );
    },
    updateProposalTemplateField(
      variables: UpdateProposalTemplateFieldMutationVariables
    ): Promise<UpdateProposalTemplateFieldMutation> {
      return client.request<UpdateProposalTemplateFieldMutation>(
        print(UpdateProposalTemplateFieldDocument),
        variables
      );
    },
    updateTopic(
      ...
      return client.request<UpdateTopicMutation>(
        print(UpdateTopicDocument),
        variables
      );
    },
    updateTopicOrder(
      variables: UpdateTopicOrderMutationVariables
    ): Promise<UpdateTopicOrderMutation> {
      return client.request<UpdateTopicOrderMutation>(
        print(UpdateTopicOrderDocument),
        variables
      );
    },
    addReview(
      variables: AddReviewMutationVariables
    ): Promise<AddReviewMutation> {
      return client.request<AddReviewMutation>(
        print(AddReviewDocument),
        variables
      );
    },
    addTechnicalReview(
      ...
      return client.request<AddTechnicalReviewMutation>(
        print(AddTechnicalReviewDocument),
        variables
      );
    },
    addUserForReview(
      ...
      return client.request<AddUserForReviewMutation>(
        print(AddUserForReviewDocument),
        variables
      );
    },
    getReview(variables: GetReviewQueryVariables): Promise<GetReviewQuery> {
      return client.request<GetReviewQuery>(
        print(GetReviewDocument),
        variables
      );
    },
    removeUserForReview(
      ...
      return client.request<RemoveUserForReviewMutation>(
        print(RemoveUserForReviewDocument),
        variables
      );
    },
    userWithReviews(
      ...
      return client.request<UserWithReviewsQuery>(
        print(UserWithReviewsDocument),
        variables
      );
    },
    createUser(
    ...
    createUserByEmailInvite(
      ...
      return client.request<CreateUserByEmailInviteMutation>(
        print(CreateUserByEmailInviteDocument),
        variables
      );
    },
    getBasicUserDetails(
      ...
      return client.request<GetBasicUserDetailsQuery>(
        print(GetBasicUserDetailsDocument),
        variables
      );
    },
    getFields(variables?: GetFieldsQueryVariables): Promise<GetFieldsQuery> {
      return client.request<GetFieldsQuery>(
        print(GetFieldsDocument),
        variables
      );
    },
    getOrcIDInformation(
      variables: GetOrcIdInformationQueryVariables
    ): Promise<GetOrcIdInformationQuery> {
      return client.request<GetOrcIdInformationQuery>(
        print(GetOrcIdInformationDocument),
        variables
      );
    },
    ...
    getToken(variables: GetTokenMutationVariables): Promise<GetTokenMutation> {
      return client.request<GetTokenMutation>(
        print(GetTokenDocument),
        variables
      );
    },
    getTokenForUser(
      ...
      return client.request<GetTokenForUserMutation>(
        print(GetTokenForUserDocument),
        variables
      );
    },
    ...
    getUserProposals(
      ...
      return client.request<GetUserProposalsQuery>(
        print(GetUserProposalsDocument),
        variables
      );
    },
    getUserWithRoles(
      ...
      return client.request<GetUserWithRolesQuery>(
        print(GetUserWithRolesDocument),
        variables
      );
    },
    ...
    resetPasswordEmail(
      ...
      return client.request<ResetPasswordEmailMutation>(
        print(ResetPasswordEmailDocument),
        variables
      );
    },
    updatePassword(
      ...
      return client.request<UpdatePasswordMutation>(
    ...
    updateUser(
      ...
      return client.request<UpdateUserMutation>(
    ...
    updateUserRoles(
      ...
      return client.request<UpdateUserRolesMutation>(
        print(UpdateUserRolesDocument),
        variables
      );
    },
    verifyEmail(
      ...
      return client.request<VerifyEmailMutation>(

...
import PostgresProposalStatusDataSource from './postgres/ProposalStatusDataSource';
...
export const proposalStatusDataSource = new PostgresProposalStatusDataSource();

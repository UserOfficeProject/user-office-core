...
var intervalQuestionValidationSchema = function (field, NumberValueConstraint) {
    var _a;
    var config = field.config;
    var minSchema = Yup.number().transform(function (value) {
        return isNaN(value) ? undefined : value;
    });
    var maxSchema = Yup.number()
    ...
    var unitSchema = Yup.object().nullable();
